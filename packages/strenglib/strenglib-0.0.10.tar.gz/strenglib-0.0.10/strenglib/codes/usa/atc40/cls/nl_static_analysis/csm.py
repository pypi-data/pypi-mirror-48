...
from ......common.io.output_older import Output
...
class CapacitySpectrumMethod:
    ...
    def calc_performance_point(self):
        ...
        iter_num = 0
        error = 100.
        self.output.log_table.dict_list.append({'iteration': iter_num, 'Sd': x_i, 'error': None})
        while error > 0.0001:
            ...
            self.output.log_table.dict_list.append({'iteration': iter_num, 'Sd': x_i, 'error': error})
