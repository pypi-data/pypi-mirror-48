...
class AvroCodec(BaseAvroCodec):
    ...
    def iter_decode(
        ...
        typing.Optional[bytes], typing.Optional[bytes], typing.Any, typing.Any, typing.Tuple[typing.Any, ...]
    ], Exception]]:
    ...
    def iter_decode_with_schema_registry(
        ...
        typing.Optional[int], typing.Optional[int], typing.Tuple[typing.Any, ...]
    ], Exception]]:
