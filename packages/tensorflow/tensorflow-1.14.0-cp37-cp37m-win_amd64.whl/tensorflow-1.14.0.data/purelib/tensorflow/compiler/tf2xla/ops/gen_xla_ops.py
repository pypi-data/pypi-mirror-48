  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "XlaBroadcastHelper", name, _ctx._post_execution_callbacks, lhs, rhs,
        broadcast_dims)
...
def xla_conv(lhs, rhs, window_strides, padding, lhs_dilation, rhs_dilation, feature_group_count, dimension_numbers, precision_config, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, lhs, rhs, window_strides,
  ...
  _attrs = ("T", _op.get_attr("T"), "Tindices", _op.get_attr("Tindices"),
            ...
            "precision_config", _op.get_attr("precision_config"))
  _execute.record_gradient(
...
def xla_dequantize(input, min_range, max_range, mode, transpose_output, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaDequantize", name, _ctx._post_execution_callbacks, input,
...
def xla_dot(lhs, rhs, dimension_numbers, precision_config, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, lhs, rhs, "dimension_numbers",
        dimension_numbers, "precision_config", precision_config)
      return _result
    except _core._FallbackException:
      try:
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("T", _op.get_attr("T"), "dimension_numbers",
...
def xla_dynamic_slice(input, start_indices, size_indices, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaDynamicSlice", name, _ctx._post_execution_callbacks, input,
...
def xla_dynamic_update_slice(input, update, indices, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaDynamicUpdateSlice", name, _ctx._post_execution_callbacks, input,
        update, indices)
      return _result
    except _core._FallbackException:
      try:
...
def xla_einsum(a, b, equation, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaEinsum", name, _ctx._post_execution_callbacks, a, b, "equation",
        equation)
      return _result
    except _core._FallbackException:
      try:
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("equation", _op.get_attr("equation"), "T", _op.get_attr("T"))
  _execute.record_gradient(
...
def xla_if(cond, inputs, then_branch, else_branch, Tout, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, cond, inputs, "then_branch",
  ...
  if not _result:
    return _op
  _inputs_flat = _op.inputs
  _attrs = ("Tcond", _op.get_attr("Tcond"), "then_branch",
...
def xla_key_value_sort(keys, values, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaKeyValueSort", name, _ctx._post_execution_callbacks, keys, values)
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("K", _op.get_attr("K"), "V", _op.get_attr("V"))
  _execute.record_gradient(
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, padding_value,
...
def xla_recv(dtype, tensor_name, shape, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, "dtype", dtype, "tensor_name",
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("dtype", _op.get_attr("dtype"), "tensor_name",
...
def xla_reduce(input, init_value, dimensions_to_reduce, reducer, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaReduce", name, _ctx._post_execution_callbacks, input, init_value,
...
def xla_reduce_window(input, init_value, window_dimensions, window_strides, base_dilations, window_dilations, padding, computation, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaReduceWindow", name, _ctx._post_execution_callbacks, input,
  ...
  _inputs_flat = _op.inputs
  _attrs = ("T", _op.get_attr("T"), "Tindices", _op.get_attr("Tindices"),
            "computation", _op.get_attr("computation"))
  _execute.record_gradient(
...
def xla_replica_id(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaReplicaId", name, _ctx._post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
def xla_select_and_scatter(operand, window_dimensions, window_strides, padding, source, init_value, select, scatter, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaSelectAndScatter", name, _ctx._post_execution_callbacks, operand,
  ...
  _inputs_flat = _op.inputs
  _attrs = ("T", _op.get_attr("T"), "Tindices", _op.get_attr("Tindices"),
            "select", _op.get_attr("select"), "scatter",
            _op.get_attr("scatter"))
  _execute.record_gradient(
...
def xla_self_adjoint_eig(a, lower, max_iter, epsilon, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaSelfAdjointEig", name, _ctx._post_execution_callbacks, a, "lower",
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, tensor, "tensor_name",
        tensor_name)
      return _result
    except _core._FallbackException:
      try:
...
def xla_svd(a, max_iter, epsilon, precision_config, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, a, "max_iter", max_iter,
  ...
  _attrs = ("max_iter", _op.get_attr("max_iter"), "epsilon",
            ...
            _op.get_attr("precision_config"), "T", _op.get_attr("T"))
  _execute.record_gradient(
