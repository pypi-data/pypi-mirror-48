...
class Ui_UicCompilerOptionsDialog(object):
    def setupUi(self, UicCompilerOptionsDialog):
        ...
        UicCompilerOptionsDialog.resize(500, 280)
        ...
        UicCompilerOptionsDialog.setTabOrder(self.packageEdit, self.packageRootEdit)
        UicCompilerOptionsDialog.setTabOrder(self.packageRootEdit, self.suffixEdit)
