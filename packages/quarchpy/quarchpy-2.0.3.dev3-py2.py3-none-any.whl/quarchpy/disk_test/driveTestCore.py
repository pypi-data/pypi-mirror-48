...
from quarchpy.disk_test import lspci
...
def chooseQuarchModule(moduleName):
    ...
    for connection in scanDictionary:
        ...
        notifyChoiceOption(connection, "Quarch Module")
    ...
    sendMsgToGUI("QuarchDTS::end-of-data", None)

    while choiceResponse is None:
        time.sleep(0.25)

    choice = bytes.decode(choiceResponse)
