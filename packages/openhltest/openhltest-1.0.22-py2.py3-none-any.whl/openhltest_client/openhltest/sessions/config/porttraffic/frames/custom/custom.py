...
class Custom(Base):
	...
	def Payload(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.custom.payload.payload.Payload)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.custom.payload.payload import Payload
