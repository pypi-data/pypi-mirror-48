...
class Authentication(Base):
	...
	def AuthenticationType(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authenticationtype.authenticationtype.AuthenticationType)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authenticationtype.authenticationtype import AuthenticationType
	...
	def Password(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.password.password.Password)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.password.password import Password
