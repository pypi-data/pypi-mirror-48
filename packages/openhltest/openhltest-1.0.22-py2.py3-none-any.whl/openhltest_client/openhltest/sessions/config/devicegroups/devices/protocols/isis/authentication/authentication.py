...
class Authentication(Base):
	...
	def AuthenticationType(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.isis.authentication.authenticationtype.authenticationtype.AuthenticationType)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.isis.authentication.authenticationtype.authenticationtype import AuthenticationType
	...
	def Password(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.isis.authentication.password.password.Password)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.isis.authentication.password.password import Password
