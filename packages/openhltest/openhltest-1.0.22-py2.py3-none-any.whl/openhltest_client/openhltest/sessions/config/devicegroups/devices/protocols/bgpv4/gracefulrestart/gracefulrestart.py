...
class GracefulRestart(Base):
	...
	def LongLivedGracefulRestart(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.longlivedgracefulrestart.LongLivedGracefulRestart)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.longlivedgracefulrestart import LongLivedGracefulRestart
	...
	def RestartTime(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.restarttime.restarttime.RestartTime)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.restarttime.restarttime import RestartTime
	...
	def RestartDelay(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.restartdelay.restartdelay.RestartDelay)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.restartdelay.restartdelay import RestartDelay
	...
	def AdvertiseEor(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.advertiseeor.advertiseeor.AdvertiseEor)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.advertiseeor.advertiseeor import AdvertiseEor
