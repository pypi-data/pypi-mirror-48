...
_ADMINUICLIENTWARNINGRULE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\374\343\304\001:\0228List of client labels that a warning message applies to.'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\374\343\304\001.\022,Warning message text (may contain markdown).'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
