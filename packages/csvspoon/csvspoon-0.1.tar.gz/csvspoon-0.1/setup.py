...
with open(path.join(here, "csvspoon", "__init__.py"), encoding="utf-8") as f:
...
setup(
    ...
    description="A tool to manipulate csv files with headers.",  # Required
    ...
    # projects.
    extras_require={"test": ["pytest", "numpy"]},  # Optional
    ...
    entry_points={"console_scripts": ["csvspoon=csvspoon._cli:main"]},  # Optional
