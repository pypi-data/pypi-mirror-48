...
setup(
  ...
  download_url = 'https://github.com/rmusmanno/ofx2xlsmbr/archive/v0.74.tar.gz',    # I explain this later on
  ...
  dependency_links=[
        "https://github.com/rmusmanno/ofxtools/archive/0.0.2.zip#egg=ofxtools-0.0.2"
    ],
  classifiers=[
