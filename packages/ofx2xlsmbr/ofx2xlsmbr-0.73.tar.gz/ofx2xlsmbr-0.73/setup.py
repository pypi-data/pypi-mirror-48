...
setup(
  ...
  download_url = 'https://github.com/rmusmanno/ofx2xlsmbr/archive/v0.73.tar.gz',    # I explain this later on
  ...
  dependency_links=[
        "git+ssh://git@github.com/rmusmanno/ofxtools@0.0.1#egg=ofxtools-0.0.1"
    ],
  classifiers=[
