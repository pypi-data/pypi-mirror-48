...
def get_df():
    ...
    for w in data1.keys():
        tmp1 = data1[w]
        for w1 in tmp1:
            tmp = ["postgres", "since2015", "192.168.4.182", 'jianguan', 'bc__'+ w1]
            data.append(tmp)
...
def create_all_schemas():
    ...
    for w in data1.keys():
        tmp1=data1[w]
        for w1 in tmp1:
            sql = "create schema if not exists %s" % ('bc__'+ w1)
...
# add_conp(["postgres","since2015","192.168.4.182",'jianguan','public'])
