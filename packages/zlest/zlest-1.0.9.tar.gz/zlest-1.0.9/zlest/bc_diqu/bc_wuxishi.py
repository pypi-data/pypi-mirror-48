...
import json
import time
from zlest.util.etl import est_html, est_meta, add_info, est_meta_large
from zlest.util.fake_useragent import UserAgent
import datetime
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="无锡市", **args)
    est_html(conp, f=f3, **args)


if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "wuxishi"])
