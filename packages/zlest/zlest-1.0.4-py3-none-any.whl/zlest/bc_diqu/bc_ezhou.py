...
import time
import json
from zlest.util.etl import add_info,est_meta,est_html,est_tbs
...
def work(conp,**args):
    est_meta(conp,data=data,diqu="鄂州市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","zlest","ezhoushi"])
