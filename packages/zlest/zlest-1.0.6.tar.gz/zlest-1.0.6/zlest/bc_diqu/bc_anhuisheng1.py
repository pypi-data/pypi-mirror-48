...
from zlest.util.etl import est_meta, est_html, add_info,est_meta_large
...
def jump_method(driver):
    ...
    frame = driver.find_element_by_xpath('//iframe[@name="topFrame"]')
...
def work(conp, **arg):
    est_meta_large(conp, data=data, diqu="安徽省",pageloadtimeout=120, **arg)
...
if __name__ == '__main__':
    ...
    for d in data:
        ...
        print(f2(driver))
    # work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "anhuisheng1"])
    # driver = webdriver.Chrome()
