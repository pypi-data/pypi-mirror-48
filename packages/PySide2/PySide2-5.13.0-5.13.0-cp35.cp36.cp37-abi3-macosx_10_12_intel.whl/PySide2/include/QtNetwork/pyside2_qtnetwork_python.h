...
enum : int {
    ...
    SBK_QtNetworkQSSL_IDX                                    = 92,
    SBK_QSSL_KEYTYPE_IDX                                     = 96,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 94,
    SBK_QSSL_KEYALGORITHM_IDX                                = 95,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 93,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 98,
    SBK_QSSL_SSLOPTION_IDX                                   = 97,
    ...
    SBK_QSSLERROR_IDX                                        = 107,
    SBK_QSSLERROR_SSLERROR_IDX                               = 108,
    SBK_QSSLKEY_IDX                                          = 109,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 110,
    SBK_QSSLSOCKET_IDX                                       = 111,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 113,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 112,
    SBK_QTCPSERVER_IDX                                       = 114,
    SBK_QTCPSOCKET_IDX                                       = 115,
    SBK_QUDPSOCKET_IDX                                       = 116,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 86,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 88,
    SBK_QtNetwork_IDX_COUNT                                  = 117
};
