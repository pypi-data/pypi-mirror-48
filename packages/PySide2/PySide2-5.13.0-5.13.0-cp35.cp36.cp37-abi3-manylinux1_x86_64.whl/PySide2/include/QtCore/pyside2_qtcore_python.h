...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 404,
    ...
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 258,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 259,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 260,
    SBK_QTEMPORARYDIR_IDX                                    = 261,
    SBK_QTEMPORARYFILE_IDX                                   = 262,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 263,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 265,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 264,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 106,
    SBK_QTEXTCODEC_IDX                                       = 266,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 267,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 107,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 268,
    SBK_QTEXTDECODER_IDX                                     = 269,
    SBK_QTEXTENCODER_IDX                                     = 270,
    SBK_QTEXTSTREAM_IDX                                      = 271,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 274,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 272,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 275,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 273,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 108,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 276,
    SBK_QTHREAD_IDX                                          = 277,
    SBK_QTHREAD_PRIORITY_IDX                                 = 278,
    SBK_QTHREADPOOL_IDX                                      = 279,
    SBK_QTIME_IDX                                            = 280,
    SBK_QTIMELINE_IDX                                        = 281,
    SBK_QTIMELINE_STATE_IDX                                  = 284,
    SBK_QTIMELINE_DIRECTION_IDX                              = 283,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 282,
    SBK_QTIMEZONE_IDX                                        = 285,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 288,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 286,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 287,
    SBK_QTIMER_IDX                                           = 289,
    SBK_QTIMEREVENT_IDX                                      = 290,
    SBK_QTRANSLATOR_IDX                                      = 291,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 292,
    SBK_QURL_IDX                                             = 293,
    SBK_QURL_PARSINGMODE_IDX                                 = 295,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 296,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 294,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 109,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 297,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 111,
    SBK_QURLQUERY_IDX                                        = 298,
    SBK_QUUID_IDX                                            = 299,
    SBK_QUUID_VARIANT_IDX                                    = 301,
    SBK_QUUID_VERSION_IDX                                    = 302,
    SBK_QUUID_STRINGFORMAT_IDX                               = 300,
    SBK_QVARIANTANIMATION_IDX                                = 303,
    SBK_QVERSIONNUMBER_IDX                                   = 304,
    SBK_QWAITCONDITION_IDX                                   = 305,
    SBK_QWRITELOCKER_IDX                                     = 306,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 307,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 308,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 308,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 309,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 310,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 311,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 312,
    SBK_QXMLSTREAMREADER_IDX                                 = 313,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 316,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 315,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 314,
    SBK_QXMLSTREAMWRITER_IDX                                 = 317,
    SBK_QtCoreQT_IDX                                         = 318,
    SBK_QT_GLOBALCOLOR_IDX                                   = 352,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 362,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 123,
    SBK_QT_MODIFIER_IDX                                      = 366,
    SBK_QT_MOUSEBUTTON_IDX                                   = 367,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 125,
    SBK_QT_ORIENTATION_IDX                                   = 372,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 127,
    SBK_QT_FOCUSPOLICY_IDX                                   = 347,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 383,
    SBK_QT_SORTORDER_IDX                                     = 382,
    SBK_QT_TILERULE_IDX                                      = 388,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 319,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 112,
    SBK_QT_TEXTFLAG_IDX                                      = 385,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 384,
    SBK_QT_WHITESPACEMODE_IDX                                = 397,
    SBK_QT_HITTESTACCURACY_IDX                               = 353,
    SBK_QT_WINDOWTYPE_IDX                                    = 402,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 133,
    SBK_QT_WINDOWSTATE_IDX                                   = 401,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 132,
    SBK_QT_APPLICATIONSTATE_IDX                              = 322,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 113,
    SBK_QT_SCREENORIENTATION_IDX                             = 376,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 128,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 398,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 321,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 354,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 119,
    SBK_QT_BGMODE_IDX                                        = 326,
    SBK_QT_KEY_IDX                                           = 361,
    SBK_QT_ARROWTYPE_IDX                                     = 323,
    SBK_QT_PENSTYLE_IDX                                      = 375,
    SBK_QT_PENCAPSTYLE_IDX                                   = 373,
    SBK_QT_PENJOINSTYLE_IDX                                  = 374,
    SBK_QT_BRUSHSTYLE_IDX                                    = 327,
    SBK_QT_SIZEMODE_IDX                                      = 381,
    SBK_QT_UIEFFECT_IDX                                      = 396,
    SBK_QT_CURSORSHAPE_IDX                                   = 336,
    SBK_QT_TEXTFORMAT_IDX                                    = 386,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 324,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 339,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 114,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 340,
    SBK_QT_TOOLBARAREA_IDX                                   = 391,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 130,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 392,
    SBK_QT_DATEFORMAT_IDX                                    = 337,
    SBK_QT_TIMESPEC_IDX                                      = 389,
    SBK_QT_DAYOFWEEK_IDX                                     = 338,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 377,
    SBK_QT_CASESENSITIVITY_IDX                               = 328,
    SBK_QT_CORNER_IDX                                        = 335,
    SBK_QT_EDGE_IDX                                          = 342,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 116,
    SBK_QT_CONNECTIONTYPE_IDX                                = 332,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 379,
    SBK_QT_FILLRULE_IDX                                      = 345,
    SBK_QT_MASKMODE_IDX                                      = 364,
    SBK_QT_CLIPOPERATION_IDX                                 = 331,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 359,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 360,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 395,
    SBK_QT_AXIS_IDX                                          = 325,
    SBK_QT_FOCUSREASON_IDX                                   = 348,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 333,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 356,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 121,
    SBK_QT_INPUTMETHODHINT_IDX                               = 355,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 120,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 343,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 393,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 363,
    SBK_QT_ANCHORPOINT_IDX                                   = 320,
    SBK_QT_FINDCHILDOPTION_IDX                               = 346,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 117,
    SBK_QT_DROPACTION_IDX                                    = 341,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 115,
    SBK_QT_CHECKSTATE_IDX                                    = 329,
    SBK_QT_ITEMDATAROLE_IDX                                  = 357,
    SBK_QT_ITEMFLAG_IDX                                      = 358,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 122,
    SBK_QT_MATCHFLAG_IDX                                     = 365,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 124,
    SBK_QT_WINDOWMODALITY_IDX                                = 400,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 387,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 129,
    SBK_QT_EVENTPRIORITY_IDX                                 = 344,
    SBK_QT_SIZEHINT_IDX                                      = 380,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 399,
    SBK_QT_COORDINATESYSTEM_IDX                              = 334,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 394,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 131,
    SBK_QT_GESTURESTATE_IDX                                  = 350,
    SBK_QT_GESTURETYPE_IDX                                   = 351,
    SBK_QT_GESTUREFLAG_IDX                                   = 349,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 118,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 370,
    SBK_QT_NAVIGATIONMODE_IDX                                = 371,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 408,
    SBK_QT_TIMERTYPE_IDX                                     = 390,
    SBK_QT_SCROLLPHASE_IDX                                   = 378,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 369,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 368,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 126,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 330,
    SBK_QCBORKNOWNTAGS_IDX                                   = 27,
    SBK_QCBORSIMPLETYPE_IDX                                  = 30,
    SBK_QTMSGTYPE_IDX                                        = 403,
    SBK_QtCore_IDX_COUNT                                     = 409
};
