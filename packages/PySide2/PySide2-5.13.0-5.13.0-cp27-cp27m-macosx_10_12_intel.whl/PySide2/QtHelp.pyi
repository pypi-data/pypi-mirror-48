...
class QHelpFilterData(Shiboken.Object):
    ...
    def setComponents(self, components: List[str]): ...
    def setVersions(self, versions: List[PySide2.QtCore.QVersionNumber]): ...
...
class QHelpFilterEngine(PySide2.QtCore.QObject):
    ...
    def namespaceToComponent(self) -> Dict: ...
    def namespaceToVersion(self) -> Dict: ...
