...
enum : int {
    ...
    SBK_QT3DRENDER_QOBJECTPICKER_IDX                         = 87,
    SBK_QT3DRENDER_QPAINTEDTEXTUREIMAGE_IDX                  = 88,
    SBK_QT3DRENDER_QPARAMETER_IDX                            = 89,
    SBK_QT3DRENDER_QPICKEVENT_IDX                            = 90,
    SBK_QT3DRENDER_QPICKEVENT_BUTTONS_IDX                    = 91,
    SBK_QT3DRENDER_QPICKEVENT_MODIFIERS_IDX                  = 92,
    SBK_QT3DRENDER_QPICKLINEEVENT_IDX                        = 93,
    SBK_QT3DRENDER_QPICKPOINTEVENT_IDX                       = 94,
    SBK_QT3DRENDER_QPICKTRIANGLEEVENT_IDX                    = 95,
    SBK_QT3DRENDER_QPICKINGSETTINGS_IDX                      = 96,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKMETHOD_IDX           = 98,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKRESULTMODE_IDX       = 99,
    SBK_QT3DRENDER_QPICKINGSETTINGS_FACEORIENTATIONPICKINGMODE_IDX = 97,
    SBK_QT3DRENDER_QPOINTLIGHT_IDX                           = 100,
    SBK_QT3DRENDER_QPOINTSIZE_IDX                            = 101,
    SBK_QT3DRENDER_QPOINTSIZE_SIZEMODE_IDX                   = 102,
    SBK_QT3DRENDER_QPOLYGONOFFSET_IDX                        = 103,
    SBK_QT3DRENDER_QPROXIMITYFILTER_IDX                      = 104,
    SBK_QT3DRENDER_QRAYCASTER_IDX                            = 105,
    SBK_QT3DRENDER_QRAYCASTERHIT_IDX                         = 106,
    SBK_QT3DRENDER_QRAYCASTERHIT_HITTYPE_IDX                 = 107,
    SBK_QT3DRENDER_QRENDERASPECT_IDX                         = 108,
    SBK_QT3DRENDER_QRENDERASPECT_RENDERTYPE_IDX              = 109,
    ...
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 132,
    SBK_QT3DRENDER_QSHADERPROGRAM_SHADERTYPE_IDX             = 133,
    SBK_QT3DRENDER_QSHADERPROGRAM_STATUS_IDX                 = 134,
    SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX                 = 135,
    SBK_QT3DRENDER_QSHAREDGLTEXTURE_IDX                      = 136,
    SBK_QT3DRENDER_QSORTPOLICY_IDX                           = 137,
    SBK_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX                  = 138,
    SBK_QT3DRENDER_QSPOTLIGHT_IDX                            = 139,
    SBK_QT3DRENDER_QSTENCILMASK_IDX                          = 140,
    SBK_QT3DRENDER_QSTENCILOPERATION_IDX                     = 141,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX            = 142,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_FACEMODE_IDX   = 143,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_OPERATION_IDX  = 144,
    SBK_QT3DRENDER_QSTENCILTEST_IDX                          = 145,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX                 = 146,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFACEMODE_IDX = 147,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFUNCTION_IDX = 148,
    SBK_QT3DRENDER_QTECHNIQUE_IDX                            = 149,
    SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX                      = 150,
    SBK_QT3DRENDER_QTEXTURE1D_IDX                            = 151,
    SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX                       = 152,
    SBK_QT3DRENDER_QTEXTURE2D_IDX                            = 153,
    SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX                       = 154,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX                 = 155,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX            = 156,
    SBK_QT3DRENDER_QTEXTURE3D_IDX                            = 157,
    SBK_QT3DRENDER_QTEXTUREBUFFER_IDX                        = 158,
    SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX                       = 159,
    SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX                  = 160,
    SBK_QT3DRENDER_QTEXTUREDATA_IDX                          = 161,
    SBK_QT3DRENDER_QTEXTUREGENERATOR_IDX                     = 162,
    SBK_QT3DRENDER_QTEXTUREIMAGE_IDX                         = 163,
    SBK_QT3DRENDER_QTEXTUREIMAGE_STATUS_IDX                  = 164,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX                     = 165,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX            = 166,
    SBK_QT3DRENDER_QTEXTURELOADER_IDX                        = 167,
    SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX                     = 168,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX                      = 169,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_WRAPMODE_IDX             = 170,
    SBK_QT3DRENDER_QVIEWPORT_IDX                             = 171,
    SBK_QT3DRENDER_QWAITFENCE_IDX                            = 172,
    SBK_QT3DRENDER_QWAITFENCE_HANDLETYPE_IDX                 = 173,
    SBK_Qt3DRender_IDX_COUNT                                 = 174
};
