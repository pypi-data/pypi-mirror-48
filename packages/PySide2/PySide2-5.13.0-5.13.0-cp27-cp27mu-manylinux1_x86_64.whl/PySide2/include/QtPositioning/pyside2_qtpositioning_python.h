...
// Converter indices
enum : int {
    SBK_QTPOSITIONING_QLIST_QGEOAREAMONITORINFO_IDX          = 0, // QList<QGeoAreaMonitorInfo >
    SBK_QTPOSITIONING_QLIST_QOBJECTPTR_IDX                   = 1, // const QList<QObject* > &
    SBK_QTPOSITIONING_QLIST_QBYTEARRAY_IDX                   = 2, // QList<QByteArray >
    SBK_QTPOSITIONING_QLIST_QGEOCOORDINATE_IDX               = 3, // const QList<QGeoCoordinate > &
    SBK_QTPOSITIONING_QLIST_QVARIANT_IDX                     = 4, // const QList<QVariant > &
    SBK_QTPOSITIONING_QLIST_QGEOSATELLITEINFO_IDX            = 5, // const QList<QGeoSatelliteInfo > &
    SBK_QTPOSITIONING_QLIST_QSTRING_IDX                      = 6, // QList<QString >
    SBK_QTPOSITIONING_QMAP_QSTRING_QVARIANT_IDX              = 7, // QMap<QString,QVariant >
