...
enum : int {
    ...
    SBK_QT3DANIMATION_QANIMATIONCALLBACK_IDX                 = 9,
    SBK_QT3DANIMATION_QANIMATIONCALLBACK_FLAG_IDX            = 10,
    SBK_QT3DANIMATION_QANIMATIONCLIP_IDX                     = 11,
    SBK_QT3DANIMATION_QANIMATIONCLIPLOADER_IDX               = 12,
    SBK_QT3DANIMATION_QANIMATIONCLIPLOADER_STATUS_IDX        = 13,
    SBK_QT3DANIMATION_QANIMATIONCONTROLLER_IDX               = 14,
    SBK_QT3DANIMATION_QANIMATIONGROUP_IDX                    = 15,
    SBK_QT3DANIMATION_QBLENDEDCLIPANIMATOR_IDX               = 16,
    SBK_QT3DANIMATION_QCLIPANIMATOR_IDX                      = 17,
    SBK_QT3DANIMATION_QCLOCK_IDX                             = 18,
    SBK_QT3DANIMATION_QKEYFRAME_IDX                          = 19,
    SBK_QT3DANIMATION_QKEYFRAME_INTERPOLATIONTYPE_IDX        = 20,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_IDX                 = 21,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_REPEATMODE_IDX      = 22,
    SBK_QT3DANIMATION_QLERPCLIPBLEND_IDX                     = 23,
    SBK_QT3DANIMATION_QMORPHTARGET_IDX                       = 24,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_IDX                 = 25,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_METHOD_IDX          = 26,
    SBK_QT3DANIMATION_QSKELETONMAPPING_IDX                   = 27,
    SBK_QT3DANIMATION_QVERTEXBLENDANIMATION_IDX              = 28,
    SBK_Qt3DAnimation_IDX_COUNT                              = 29
};
