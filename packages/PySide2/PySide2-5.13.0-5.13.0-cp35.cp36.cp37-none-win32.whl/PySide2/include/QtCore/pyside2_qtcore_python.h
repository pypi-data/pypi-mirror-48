...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 88,
    ...
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 89,
    ...
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 91,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 38,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 90,
    ...
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 92,
    ...
    SBK_QCONCATENATETABLESPROXYMODEL_IDX                     = 49,
    SBK_QCOREAPPLICATION_IDX                                 = 50,
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 406,
    SBK_QCRYPTOGRAPHICHASH_IDX                               = 51,
    SBK_QCRYPTOGRAPHICHASH_ALGORITHM_IDX                     = 52,
    SBK_QDATASTREAM_IDX                                      = 53,
    SBK_QDATASTREAM_VERSION_IDX                              = 57,
    SBK_QDATASTREAM_BYTEORDER_IDX                            = 54,
    SBK_QDATASTREAM_STATUS_IDX                               = 56,
    SBK_QDATASTREAM_FLOATINGPOINTPRECISION_IDX               = 55,
    SBK_QDATE_IDX                                            = 58,
    SBK_QDATE_MONTHNAMETYPE_IDX                              = 59,
    SBK_QDATETIME_IDX                                        = 60,
    SBK_QDIR_IDX                                             = 61,
    SBK_QDIR_FILTER_IDX                                      = 62,
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 93,
    SBK_QDIR_SORTFLAG_IDX                                    = 63,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 94,
    SBK_QDIRITERATOR_IDX                                     = 64,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 65,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 95,
    SBK_QDYNAMICPROPERTYCHANGEEVENT_IDX                      = 66,
    SBK_QEASINGCURVE_IDX                                     = 67,
    SBK_QEASINGCURVE_TYPE_IDX                                = 68,
    SBK_QELAPSEDTIMER_IDX                                    = 69,
    SBK_QELAPSEDTIMER_CLOCKTYPE_IDX                          = 70,
    SBK_QEVENT_IDX                                           = 71,
    SBK_QEVENT_TYPE_IDX                                      = 72,
    SBK_QEVENTLOOP_IDX                                       = 73,
    SBK_QEVENTLOOP_PROCESSEVENTSFLAG_IDX                     = 74,
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 96,
    SBK_QEVENTTRANSITION_IDX                                 = 75,
    SBK_QFACTORYINTERFACE_IDX                                = 76,
    SBK_QFILE_IDX                                            = 77,
    SBK_QFILEDEVICE_IDX                                      = 78,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 79,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 81,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 83,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 98,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 80,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 97,
    SBK_QFILEDEVICE_MEMORYMAPFLAGS_IDX                       = 82,
    SBK_QFILEINFO_IDX                                        = 84,
    SBK_QFILESELECTOR_IDX                                    = 85,
    SBK_QFILESYSTEMWATCHER_IDX                               = 86,
    SBK_QFINALSTATE_IDX                                      = 87,
    SBK_QGENERICARGUMENT_IDX                                 = 134,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 135,
    SBK_QHISTORYSTATE_IDX                                    = 136,
    SBK_QHISTORYSTATE_HISTORYTYPE_IDX                        = 137,
    SBK_QIODEVICE_IDX                                        = 138,
    SBK_QIODEVICE_OPENMODEFLAG_IDX                           = 139,
    SBK_QFLAGS_QIODEVICE_OPENMODEFLAG_IDX                    = 99,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 140,
    SBK_QITEMSELECTION_IDX                                   = 141,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 141,
    SBK_QITEMSELECTIONMODEL_IDX                              = 142,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 143,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 100,
    SBK_QITEMSELECTIONRANGE_IDX                              = 144,
    SBK_QJSONARRAY_IDX                                       = 145,
    SBK_QJSONDOCUMENT_IDX                                    = 146,
    SBK_QJSONDOCUMENT_DATAVALIDATION_IDX                     = 147,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 148,
    SBK_QJSONPARSEERROR_IDX                                  = 149,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 150,
    SBK_QJSONVALUE_IDX                                       = 151,
    SBK_QJSONVALUE_TYPE_IDX                                  = 152,
    SBK_QLIBRARYINFO_IDX                                     = 153,
    SBK_QLIBRARYINFO_LIBRARYLOCATION_IDX                     = 154,
    SBK_QLINE_IDX                                            = 155,
    SBK_QLINEF_IDX                                           = 156,
    SBK_QLINEF_INTERSECTTYPE_IDX                             = 157,
    SBK_QLOCALE_IDX                                          = 158,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 163,
    SBK_QLOCALE_SCRIPT_IDX                                   = 409,
    SBK_QLOCALE_COUNTRY_IDX                                  = 159,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 164,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 162,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 165,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 102,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 161,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 407,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 160,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 101,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 408,
    SBK_QLOCKFILE_IDX                                        = 166,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 167,
    SBK_QMARGINS_IDX                                         = 168,
    SBK_QMARGINSF_IDX                                        = 169,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 170,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 171,
    SBK_QMETACLASSINFO_IDX                                   = 172,
    SBK_QMETAENUM_IDX                                        = 173,
    SBK_QMETAMETHOD_IDX                                      = 174,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 175,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 176,
    SBK_QMETAOBJECT_IDX                                      = 177,
    SBK_QMETAOBJECT_CALL_IDX                                 = 178,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 179,
    SBK_QMETAPROPERTY_IDX                                    = 180,
    SBK_QMIMEDATA_IDX                                        = 181,
    SBK_QMIMEDATABASE_IDX                                    = 182,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 183,
    SBK_QMIMETYPE_IDX                                        = 184,
    SBK_QMODELINDEX_IDX                                      = 185,
    SBK_QMUTEX_IDX                                           = 186,
    SBK_QMUTEX_RECURSIONMODE_IDX                             = 187,
    SBK_QMUTEXLOCKER_IDX                                     = 188,
    SBK_QOBJECT_IDX                                          = 189,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 190,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 191,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 192,
    SBK_QPAUSEANIMATION_IDX                                  = 193,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 194,
    SBK_QPLUGINLOADER_IDX                                    = 195,
    SBK_QPOINT_IDX                                           = 196,
    SBK_QPOINTF_IDX                                          = 197,
    SBK_QPROCESS_IDX                                         = 198,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 203,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 204,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 201,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 202,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 200,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 199,
    SBK_QPROCESSENVIRONMENT_IDX                              = 205,
    SBK_QPROPERTYANIMATION_IDX                               = 206,
    SBK_QRANDOMGENERATOR_IDX                                 = 207,
    SBK_QRANDOMGENERATOR64_IDX                               = 208,
    SBK_QREADLOCKER_IDX                                      = 209,
    SBK_QREADWRITELOCK_IDX                                   = 210,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 211,
    SBK_QRECT_IDX                                            = 212,
    SBK_QRECTF_IDX                                           = 213,
    SBK_QREGEXP_IDX                                          = 214,
    SBK_QREGEXP_PATTERNSYNTAX_IDX                            = 216,
    SBK_QREGEXP_CARETMODE_IDX                                = 215,
    SBK_QREGULAREXPRESSION_IDX                               = 217,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 220,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 104,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 219,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 218,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 103,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 221,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 222,
    SBK_QRESOURCE_IDX                                        = 223,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 224,
    SBK_QRUNNABLE_IDX                                        = 225,
    SBK_QSAVEFILE_IDX                                        = 226,
    SBK_QSEMAPHORE_IDX                                       = 227,
    SBK_QSEMAPHORERELEASER_IDX                               = 228,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 229,
    SBK_QSETTINGS_IDX                                        = 230,
    SBK_QSETTINGS_STATUS_IDX                                 = 233,
    SBK_QSETTINGS_FORMAT_IDX                                 = 231,
    SBK_QSETTINGS_SCOPE_IDX                                  = 232,
    SBK_QSIGNALBLOCKER_IDX                                   = 234,
    SBK_QSIGNALMAPPER_IDX                                    = 235,
    SBK_QSIGNALTRANSITION_IDX                                = 236,
    SBK_QSIZE_IDX                                            = 237,
    SBK_QSIZEF_IDX                                           = 238,
    SBK_QSOCKETNOTIFIER_IDX                                  = 239,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 240,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 241,
    SBK_QSTANDARDPATHS_IDX                                   = 242,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 244,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 243,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 105,
    SBK_QSTATE_IDX                                           = 245,
    SBK_QSTATE_CHILDMODE_IDX                                 = 246,
    SBK_QSTATE_RESTOREPOLICY_IDX                             = 247,
    SBK_QSTATEMACHINE_IDX                                    = 248,
    SBK_QSTATEMACHINE_EVENTPRIORITY_IDX                      = 250,
    SBK_QSTATEMACHINE_ERROR_IDX                              = 249,
    SBK_QSTATEMACHINE_SIGNALEVENT_IDX                        = 251,
    SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX                       = 252,
    SBK_QSTORAGEINFO_IDX                                     = 253,
    SBK_QSTRINGLISTMODEL_IDX                                 = 254,
    SBK_QSYSINFO_IDX                                         = 255,
    SBK_QSYSINFO_SIZES_IDX                                   = 257,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 256,
    SBK_QSYSINFO_WINVERSION_IDX                              = 258,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 259,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 260,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 261,
    SBK_QTEMPORARYDIR_IDX                                    = 262,
    SBK_QTEMPORARYFILE_IDX                                   = 263,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 264,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 266,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 265,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 106,
    SBK_QTEXTCODEC_IDX                                       = 267,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 268,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 107,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 269,
    SBK_QTEXTDECODER_IDX                                     = 270,
    SBK_QTEXTENCODER_IDX                                     = 271,
    SBK_QTEXTSTREAM_IDX                                      = 272,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 275,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 273,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 276,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 274,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 108,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 277,
    SBK_QTHREAD_IDX                                          = 278,
    SBK_QTHREAD_PRIORITY_IDX                                 = 279,
    SBK_QTHREADPOOL_IDX                                      = 280,
    SBK_QTIME_IDX                                            = 281,
    SBK_QTIMELINE_IDX                                        = 282,
    SBK_QTIMELINE_STATE_IDX                                  = 285,
    SBK_QTIMELINE_DIRECTION_IDX                              = 284,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 283,
    SBK_QTIMEZONE_IDX                                        = 286,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 289,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 287,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 288,
    SBK_QTIMER_IDX                                           = 290,
    SBK_QTIMEREVENT_IDX                                      = 291,
    SBK_QTRANSLATOR_IDX                                      = 292,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 293,
    SBK_QURL_IDX                                             = 294,
    SBK_QURL_PARSINGMODE_IDX                                 = 296,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 297,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 295,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 109,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 298,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 111,
    SBK_QURLQUERY_IDX                                        = 299,
    SBK_QUUID_IDX                                            = 300,
    SBK_QUUID_VARIANT_IDX                                    = 302,
    SBK_QUUID_VERSION_IDX                                    = 303,
    SBK_QUUID_STRINGFORMAT_IDX                               = 301,
    SBK_QVARIANTANIMATION_IDX                                = 304,
    SBK_QVERSIONNUMBER_IDX                                   = 305,
    SBK_QWAITCONDITION_IDX                                   = 306,
    SBK_QWINEVENTNOTIFIER_IDX                                = 307,
    SBK_QWRITELOCKER_IDX                                     = 308,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 309,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 310,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 310,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 311,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 312,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 313,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 314,
    SBK_QXMLSTREAMREADER_IDX                                 = 315,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 318,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 317,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 316,
    SBK_QXMLSTREAMWRITER_IDX                                 = 319,
    SBK_QtCoreQT_IDX                                         = 320,
    SBK_QT_GLOBALCOLOR_IDX                                   = 354,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 364,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 123,
    SBK_QT_MODIFIER_IDX                                      = 368,
    SBK_QT_MOUSEBUTTON_IDX                                   = 369,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 125,
    SBK_QT_ORIENTATION_IDX                                   = 374,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 127,
    SBK_QT_FOCUSPOLICY_IDX                                   = 349,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 385,
    SBK_QT_SORTORDER_IDX                                     = 384,
    SBK_QT_TILERULE_IDX                                      = 390,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 321,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 112,
    SBK_QT_TEXTFLAG_IDX                                      = 387,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 386,
    SBK_QT_WHITESPACEMODE_IDX                                = 399,
    SBK_QT_HITTESTACCURACY_IDX                               = 355,
    SBK_QT_WINDOWTYPE_IDX                                    = 404,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 133,
    SBK_QT_WINDOWSTATE_IDX                                   = 403,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 132,
    SBK_QT_APPLICATIONSTATE_IDX                              = 324,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 113,
    SBK_QT_SCREENORIENTATION_IDX                             = 378,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 128,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 400,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 323,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 356,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 119,
    SBK_QT_BGMODE_IDX                                        = 328,
    SBK_QT_KEY_IDX                                           = 363,
    SBK_QT_ARROWTYPE_IDX                                     = 325,
    SBK_QT_PENSTYLE_IDX                                      = 377,
    SBK_QT_PENCAPSTYLE_IDX                                   = 375,
    SBK_QT_PENJOINSTYLE_IDX                                  = 376,
    SBK_QT_BRUSHSTYLE_IDX                                    = 329,
    SBK_QT_SIZEMODE_IDX                                      = 383,
    SBK_QT_UIEFFECT_IDX                                      = 398,
    SBK_QT_CURSORSHAPE_IDX                                   = 338,
    SBK_QT_TEXTFORMAT_IDX                                    = 388,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 326,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 341,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 114,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 342,
    SBK_QT_TOOLBARAREA_IDX                                   = 393,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 130,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 394,
    SBK_QT_DATEFORMAT_IDX                                    = 339,
    SBK_QT_TIMESPEC_IDX                                      = 391,
    SBK_QT_DAYOFWEEK_IDX                                     = 340,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 379,
    SBK_QT_CASESENSITIVITY_IDX                               = 330,
    SBK_QT_CORNER_IDX                                        = 337,
    SBK_QT_EDGE_IDX                                          = 344,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 116,
    SBK_QT_CONNECTIONTYPE_IDX                                = 334,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 381,
    SBK_QT_FILLRULE_IDX                                      = 347,
    SBK_QT_MASKMODE_IDX                                      = 366,
    SBK_QT_CLIPOPERATION_IDX                                 = 333,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 361,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 362,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 397,
    SBK_QT_AXIS_IDX                                          = 327,
    SBK_QT_FOCUSREASON_IDX                                   = 350,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 335,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 358,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 121,
    SBK_QT_INPUTMETHODHINT_IDX                               = 357,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 120,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 345,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 395,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 365,
    SBK_QT_ANCHORPOINT_IDX                                   = 322,
    SBK_QT_FINDCHILDOPTION_IDX                               = 348,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 117,
    SBK_QT_DROPACTION_IDX                                    = 343,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 115,
    SBK_QT_CHECKSTATE_IDX                                    = 331,
    SBK_QT_ITEMDATAROLE_IDX                                  = 359,
    SBK_QT_ITEMFLAG_IDX                                      = 360,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 122,
    SBK_QT_MATCHFLAG_IDX                                     = 367,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 124,
    SBK_QT_WINDOWMODALITY_IDX                                = 402,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 389,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 129,
    SBK_QT_EVENTPRIORITY_IDX                                 = 346,
    SBK_QT_SIZEHINT_IDX                                      = 382,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 401,
    SBK_QT_COORDINATESYSTEM_IDX                              = 336,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 396,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 131,
    SBK_QT_GESTURESTATE_IDX                                  = 352,
    SBK_QT_GESTURETYPE_IDX                                   = 353,
    SBK_QT_GESTUREFLAG_IDX                                   = 351,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 118,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 372,
    SBK_QT_NAVIGATIONMODE_IDX                                = 373,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 410,
    SBK_QT_TIMERTYPE_IDX                                     = 392,
    SBK_QT_SCROLLPHASE_IDX                                   = 380,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 371,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 370,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 126,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 332,
    SBK_QCBORKNOWNTAGS_IDX                                   = 27,
    SBK_QCBORSIMPLETYPE_IDX                                  = 30,
    SBK_QTMSGTYPE_IDX                                        = 405,
    SBK_QtCore_IDX_COUNT                                     = 411
};
