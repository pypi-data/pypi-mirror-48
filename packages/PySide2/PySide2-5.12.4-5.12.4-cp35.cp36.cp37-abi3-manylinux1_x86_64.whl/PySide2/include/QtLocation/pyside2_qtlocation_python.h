...
enum : int {
    ...
    SBK_QTLOCATION_QLIST_QGEOCOORDINATE_IDX                  = 3, // QList<QGeoCoordinate >
    SBK_QTLOCATION_QLIST_QGEOROUTE_IDX                       = 4, // const QList<QGeoRoute > &
    SBK_QTLOCATION_QLIST_QGEORECTANGLE_IDX                   = 5, // QList<QGeoRectangle >
    SBK_QTLOCATION_QLIST_QGEOROUTEREQUEST_FEATURETYPE_IDX    = 6, // QList<QGeoRouteRequest::FeatureType >
    SBK_QTLOCATION_QLIST_QVARIANTMAP_IDX                     = 7, // const QList<QVariantMap > &
    SBK_QTLOCATION_QLIST_QPLACECATEGORY_IDX                  = 8, // QList<QPlaceCategory >
    SBK_QTLOCATION_QLIST_QPLACECONTACTDETAIL_IDX             = 9, // QList<QPlaceContactDetail >
    SBK_QTLOCATION_QMAP_INT_QPLACECONTENT_IDX                = 10, // QMap<int,QPlaceContent >
    SBK_QTLOCATION_QLIST_QLOCALE_IDX                         = 11, // QList<QLocale >
    SBK_QTLOCATION_QLIST_QPLACE_IDX                          = 12, // QList<QPlace >
    SBK_QTLOCATION_QLIST_QPLACESEARCHRESULT_IDX              = 13, // const QList<QPlaceSearchResult > &
    SBK_QTLOCATION_QLIST_QVARIANT_IDX                        = 14, // QList<QVariant >
    SBK_QTLOCATION_QLIST_QSTRING_IDX                         = 15, // QList<QString >
    SBK_QTLOCATION_QMAP_QSTRING_QVARIANT_IDX                 = 16, // QMap<QString,QVariant >
