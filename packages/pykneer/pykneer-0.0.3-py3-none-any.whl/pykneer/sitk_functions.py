...
# https://github.com/fedorov/lidc-idri-conversion/blob/master/seg/seg_converter.p\
    
#import itk
#ImageType = itk.Image[itk.SS, 3]
#reader = itk.ImageFileReader[ImageType].New()
#reader.SetFileName("/Users/sbonaretti/Dropbox/Work/projects/pykneer/code/python/pykneer/pip/pykneer/demo/for_testing/preprocessed/01_DESS_01_orig.mha")
#reader.Update()
...
#                                    + ( ITK_COORDINATE_Anterior << ITK_COORDINATE_SecondaryMinor ) \
#                                    + ( ITK_COORDINATE_Inferior << ITK_COORDINATE_TertiaryMinor )
#print("Input spacing: %.2f %.2f %.2f" % (image.GetSpacing()[0], image.GetSpacing()[1], image.GetSpacing()[2]))
#
#
#reorient = itk.OrientImageFilter[ImageType,ImageType].New()
#reorient.SetInput(image)
#reorient.SetDesiredCoordinateOrientation(ITK_COORDINATE_ORIENTATION_RAI)
#reorient.Update();
#reoriented = reorient.GetOutput()
#print("Input spacing: %.2f %.2f %.2f" % (reoriented.GetSpacing()[0], reoriented.GetSpacing()[1], reoriented.GetSpacing()[2]))
