...
import bppynndescent.sparse as sparse
import bppynndescent.sparse_nndescent as sparse_nnd
import bppynndescent.distances as dist
import bppynndescent.threaded as threaded
import bppynndescent.sparse_threaded as sparse_threaded

from bppynndescent.utils import (
    rejection_sample,
    seed,
    make_heap,
    heap_push,
...
from bppynndescent.rp_trees import make_forest, rptree_leaf_array, search_flat_tree
...
class NNDescent(object):
    ...
    def query(self, query_data, k=10, queue_size=5.0):
        ...
        return indices[0, 0:k], dists[0, 0:k]
...
class PyNNDescentTransformer(BaseEstimator, TransformerMixin):
    ...
    >>> from bppynndescent import PyNNDescentTransformer
