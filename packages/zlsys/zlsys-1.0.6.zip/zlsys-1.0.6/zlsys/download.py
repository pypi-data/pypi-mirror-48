...
def get_file_url(shi,jtype,date):
    ...
    address_url_dict={
        ...
        "宜宾市":"http://xjy.yibin.gov.cn/Common/Framework/FileDownLoad.aspx?PhysicalFilePath=%%2bHH6mFhYUeYKshNaq6wCFNtubwHNZgE9&OldFileName=&NewFileName=$$$$$.zip",
        "大理州":{"政府采购":"http://www.dlggzy.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.dlggzy.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "临沧市":{"政府采购":"https://www.lcggzy.gov.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"https://www.lcggzy.gov.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "怒江州":{"政府采购":"http://182.246.203.127:8001/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://182.246.203.127:8001/jsgc-file/downloadFile?fileId=$$$$$"},
        "曲靖市":{"政府采购":"http://jyxt.qjggzyxx.gov.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://jyxt.qjggzyxx.gov.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "文山州":{"政府采购":"http://wsggzy.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://wsggzy.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "玉溪市":{"政府采购":"http://60.160.190.130:8001/jsgc-file/downloadFile?fileId=$$$$$","工程建设":"http://60.160.190.130:8001/jsgc-file/downloadFile?fileId=$$$$$"},
        "红河州":{"政府采购":"http://www.hhzy.net/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.hhzy.net/jsgc-file/downloadFile?fileId=$$$$$"},
        "西双版纳州":{"政府采购":"http://www.xsbnggzyjyxx.com/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.xsbnggzyjyxx.com/jsgc-file/downloadFile?fileId=$$$$$"},
        "昭通市":{"政府采购":"http://ztggzyjy.zt.gov.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://ztggzyjy.zt.gov.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "楚雄州":{"政府采购":"http://www.cxggzy.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.cxggzy.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "德宏州":{"政府采购":"https://jyzx.dh.gov.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"https://jyzx.dh.gov.cn/jsgc-file/downloadFile?fileId=$$$$$"},
        "迪庆州":{"政府采购":"http://183.224.249.60:8001/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://183.224.249.60:8001/jsgc-file/downloadFile?fileId=$$$$$"},
        "普洱市":{"政府采购":"http://www.pesggzyjyxxw.com/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.pesggzyjyxxw.com/jsgc-file/downloadFile?fileId=$$$$$"},
        "保山市":{"政府采购":"http://www.bszwzx.gov.cn/zfcg-file/downloadFile?fileId=$$$$$","工程建设":"http://www.bszwzx.gov.cn/jsgc-file/downloadFile?fileId=$$$$$"},
...
# get_file_url('遂宁市',"zfcg",'2019-06-13')
...
def getfile(shi,jytype,date):
    address_dict={"昆明市":"kunming","深圳市":"shenzhen","腾冲市":"tengchong",
                  ...
                  "普洱市":"puer","保山市":"baoshan","遂宁市":"suining",
                  }
...
# update("宜宾市","gcjs",'2019-06-05',["postgres",'since2015','192.168.3.170','bid','zlsys'])
#update("文山州","zfcg",'2019-06-13',["postgres",'since2015','192.168.4.175','zlsys','yunnan_wenshan'])
