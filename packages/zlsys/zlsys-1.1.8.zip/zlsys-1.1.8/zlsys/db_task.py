...
conp_=['postgres','since2015','192.168.4.200','zlsys']
...
settings={
    ...
    "zlsys_yunnan_tengchongshi":[['腾冲市','zfcg','yunnan_tengchongshi','云南腾冲市','2019-07-03'],
            ['腾冲市','gcjs','yunnan_tengchongshi','云南腾冲市','2019-07-03']],

    "zlsys_sichuan_yaanshi":[['雅安市','zfcg','sichuan_yaanshi','四川雅安市','2019-07-03'],
            ['雅安市','gcjs','sichuan_yaanshi','四川雅安市','2019-07-03']],


    "zlsys_sichuan_suiningshi":[['遂宁市','zfcg','sichuan_suiningshi','四川遂宁市','2019-07-03'],
            ['遂宁市','gcjs','sichuan_suiningshi','四川遂宁市','2019-07-03']],


    "zlsys_sichuan_yibinshi":[['宜宾市','zfcg','sichuan_yibinshi','四川宜宾市','2019-07-03'],
            ['宜宾市','gcjs','sichuan_yibinshi','四川宜宾市','2019-07-03']],
...
def task_conp(quyu,conpx,tag=None):
