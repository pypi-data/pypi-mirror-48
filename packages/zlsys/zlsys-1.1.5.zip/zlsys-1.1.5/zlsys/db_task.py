...
settings={
    ...
    "zlsys_sichuan_yibinshi":[['宜宾市','zfcg','sichuan_yibinshi','四川宜宾市','2019-06-24'],
            ['宜宾市','gcjs','sichuan_yibinshi','四川宜宾市','2019-06-24']],


    "zlsys_yunnan_tengchongshi":[['腾冲市','zfcg','yunnan_tengchongshi','云南腾冲市','2019-06-24'],
            ['腾冲市','gcjs','yunnan_tengchongshi','云南腾冲市','2019-06-24']],

    "zlsys_sichuan_yaanshi":[['雅安市','zfcg','sichuan_yaanshi','四川雅安市','2019-06-26'],
            ['雅安市','gcjs','sichuan_yaanshi','四川雅安市','2019-06-26']],
