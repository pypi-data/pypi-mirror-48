...
```bash
$ docker pull doughgle/cryptocracy
...
```bash
(KA)root@6c1845908301:/app/cryptocracy/src/delivery/cli# ./cryptocracy setup
```
...
```commandline
(KA)root@c9ec3434d7e9:/app/cryptocracy/src/delivery/cli# ./cryptocracy upload $HOME/.cryptocracy/params 
...
```bash
(DO)src/delivery/cli$ echo "hello world" > $HOME/hello
```
