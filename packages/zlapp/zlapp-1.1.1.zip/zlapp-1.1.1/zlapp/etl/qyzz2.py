...
def ptb3():
    conp_hawq=["gpadmin","since2015","192.168.4.179","base_db","public"]
    conp_pg=["postgres","since2015","192.168.4.188",'bid','jianzhu']
    sql="select href,pageresult from jianzhu.gg_html_result"
    pg2pg(sql,'qyzz_tmp',conp_hawq,conp_pg,chunksize=10000,datadict={"href":TEXT(),"pageresult":ARRAY(TEXT)})