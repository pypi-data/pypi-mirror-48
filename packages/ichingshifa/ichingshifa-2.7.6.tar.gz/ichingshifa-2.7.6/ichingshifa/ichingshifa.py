...
sixtyfourgua = pickle.load( open( "data/sixtyfourgua.pkl", "rb", encoding="utf8" ))
sixtyfourgua_description = pickle.load( open( "data/sixtyfourgua_description.pkl", "rb", encoding="utf8"))
