...
class Tablet:
    ...
    def takePhoto(self, camera = "Top"):
        ...
        self.photoCaptureProxy.post.takePicture("/var/persistent/home/nao/.local/share/PackageManager/apps/images/html/", self.image_name)
