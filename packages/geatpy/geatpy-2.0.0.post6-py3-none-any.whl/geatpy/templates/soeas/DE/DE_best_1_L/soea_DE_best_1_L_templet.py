...
class soea_DE_best_1_L_templet(ea.Algorithm):
    
    """
soea_DE_best_1_L : class - DE/best/1/L差分进化算法模板

算法描述:
    本模板实现的是经典的DE/best/1/L单目标差分进化算法，算法流程略加修改，以适应矩阵化计算。
