...
* **Ensure the bug was not already reported** by searching on GitLab under [Issues](https://mindcloud.dev/oceanstack/deckhand/deckhand/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://mindcloud.dev/oceanstack/deckhand/deckhand/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **sample** or an **test case** demonstrating the expected behavior that is not occurring.
...
* Suggest your change via [email](staff@oceanstack.io) and feel free to start writing code.
...
reported by contacting the project team at [staff@oceanstack.io](staff@oceanstack.io).
