...
class Step (Model):
    name = models.CharField(max_length=128, verbose_name="Name", db_column="title", default='0000000')
...
class Format (Model):
    name = models.CharField(max_length=128, verbose_name="Title", db_column="title", default='0000000')
...
class Resource (Model):
    # Mandatory Fields
    name = models.CharField(max_length=32, verbose_name="Title", db_column="title", default='0000000')
