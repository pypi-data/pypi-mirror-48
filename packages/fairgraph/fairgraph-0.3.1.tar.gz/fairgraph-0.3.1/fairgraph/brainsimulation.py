...
class ModelProject(KGObject, HasAliasMixin):
    ...
    def from_kg_instance(cls, instance, client, use_cache=True):
        D = instance.data
        logger.info("!!!Creating ModelProject from instance with data: {}".format(D))
...
#         {
#             "this": "https://nexus-int.humanbrainproject.org/v0/schemas/neuralactivity/simulation/modelvalidation/v0.2.0/shapes/"
#         },
#         "https://nexus-int.humanbrainproject.org/v0/contexts/nexus/core/resource/v0.3.0"
#     ],
#     "@id": "https://nexus-int.humanbrainproject.org/v0/schemas/neuralactivity/simulation/modelvalidation/v0.2.0",
#     "@type": "nxv:Schema",
#     "imports": [
#         "https://nexus-int.humanbrainproject.org/v0/schemas/neurosciencegraph/commons/activity/v0.1.1"
#     ],
#     "shapes": [
#         {
...
#             "and": [
#                 {
#                     "node": "https://nexus-int.humanbrainproject.org/v0/schemas/neurosciencegraph/commons/activity/v0.1.1/ActivityShape"
#                 },
#                 {
#                     "property": [
#                         {
...
#                             "name": "Result",
#                             "path": "prov:generated",
#                             "seeAlso": "https://nexus-int.humanbrainproject.org/v0/schemas/neurosciencegraph/simulation/validationresult/v0.1.0/shapes/ValidationResultShape"
#                         }
#                     ]
#                 }
#             ],
