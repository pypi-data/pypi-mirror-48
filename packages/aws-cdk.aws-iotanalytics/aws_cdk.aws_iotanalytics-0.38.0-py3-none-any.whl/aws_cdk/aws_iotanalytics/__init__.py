...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iotanalytics", "0.38.0", __name__, "aws-iotanalytics@0.38.0.jsii.tgz")
class CfnChannel(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iotanalytics.CfnChannel"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, channel_name: typing.Optional[str]=None, retention_period: typing.Optional[typing.Union[typing.Optional["RetentionPeriodProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        """
        props = CfnChannelProps(channel_name=channel_name, retention_period=retention_period, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iotanalytics.CfnChannelProps", jsii_struct_bases=[], name_mapping={'channel_name': 'channelName', 'retention_period': 'retentionPeriod', 'tags': 'tags'})
class CfnChannelProps():
    def __init__(self, *, channel_name: typing.Optional[str]=None, retention_period: typing.Optional[typing.Union[typing.Optional["CfnChannel.RetentionPeriodProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
    ...
    @property
    def retention_period(self) -> typing.Optional[typing.Union[typing.Optional["CfnChannel.RetentionPeriodProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::IoTAnalytics::Channel.RetentionPeriod``.
...
class CfnDatastore(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iotanalytics.CfnDatastore"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, datastore_name: typing.Optional[str]=None, retention_period: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["RetentionPeriodProperty"]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
        ...
        """
        props = CfnDatastoreProps(datastore_name=datastore_name, retention_period=retention_period, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-iotanalytics.CfnDatastoreProps", jsii_struct_bases=[], name_mapping={'datastore_name': 'datastoreName', 'retention_period': 'retentionPeriod', 'tags': 'tags'})
class CfnDatastoreProps():
    def __init__(self, *, datastore_name: typing.Optional[str]=None, retention_period: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnDatastore.RetentionPeriodProperty"]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
