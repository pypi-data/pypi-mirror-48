...
# </div>
# """ 
    HEADING_TMPL = """<div class="container-fluid"> <div class="row"> <div class="col-lg-8">
<h4 style="font-family: Microsoft YaHei">%(title)s</h4>
%(parameters)s
<p class='description'>%(description)s</p>
</div>
...
class HTMLTestRunner(Template_mixin):
    ...
    def getReportAttributes(self, result):
        ...
        ],{"success":result.success_count,"fail":result.failure_count,"error":result.error_count}


    def generateReport(self, test, result):
        report_attrs, report_result = self.getReportAttributes(result)
        generator = 'HTMLTestRunner %s' % __version__
        stylesheet = self._generate_stylesheet()
        heading = self._generate_heading(report_attrs,report_result)
    ...
    #增加Tester显示 -Findyou
    def _generate_heading(self, report_attrs,report_result):
        a_lines = []
