...
class TestGoogleStorageInterface(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.assertRaises(Exceptions.FileNotFoundError, open_state.read)
    ...
    def test_listdir(self):
        ...
        self.assertRaises(Exceptions.NotADirectoryError, self.gs.listdir, self.binary_file)
        self.assertRaises(Exceptions.FileNotFoundError, self.gs.listdir, self.not_found_file)
