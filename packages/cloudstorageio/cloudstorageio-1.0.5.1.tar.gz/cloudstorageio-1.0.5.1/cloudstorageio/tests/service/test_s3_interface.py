...
class TestS3Interface(unittest.TestCase):
    ...
    def test_listdir(self):
        ...
        self.assertRaises(Exceptions.NotADirectoryError, self.s3.listdir, self.binary_file)
        self.assertRaises(Exceptions.FileNotFoundError, self.s3.listdir, self.not_found_file)
