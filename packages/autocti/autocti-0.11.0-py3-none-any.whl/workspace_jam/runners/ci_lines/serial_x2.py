...
shape, frame_geometry = tools.charge_line_shape_and_frame_geometry_from_direction(direction='serial')
...
pipeline_init = serial_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model])

from workspace_jam.pipelines.normal.from_initialize import serial_x2

pipeline_normal = serial_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model])
