...
pipeline_init = parallel_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model],
                                          mask_function=mask_function_for_bug)

from workspace_jam.pipelines.normal.from_initialize import parallel_x2

pipeline_normal = parallel_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model],
                                            mask_function=mask_function_for_bug)
