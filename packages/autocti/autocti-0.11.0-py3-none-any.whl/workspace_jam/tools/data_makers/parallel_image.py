...
data_type = 'parallel_image_horizontal_line'

# Setup the path to the data, where it will ultimately be output.
...
image_pre_cti.output_as_fits(file_path=data_path + '/image_pre_cti.fits', overwrite=True)
image_post_cti.output_as_fits(file_path=data_path + '/image_post_cti.fits', overwrite=True)