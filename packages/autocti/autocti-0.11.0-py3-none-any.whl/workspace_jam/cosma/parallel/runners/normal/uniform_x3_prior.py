...
from workspace_jam.pipelines.initialize import parallel_x3_prior

pipeline_init = parallel_x3_prior.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
