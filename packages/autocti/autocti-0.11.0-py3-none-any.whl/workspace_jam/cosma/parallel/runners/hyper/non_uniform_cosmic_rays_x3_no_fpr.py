...
shape = tools.parallel_shape_from_ci_data_resolution(ci_data_resolution=ci_data_resolution)
frame_geometry = tools.parallel_frame_geometry_from_ci_data_resolution(ci_data_resolution=ci_data_resolution)
...
ci_regions = tools.parallel_ci_regions_from_ci_data_resolution(ci_data_resolution=ci_data_resolution)
...
front_edge_rows = patterns[0].regions[0].total_rows
...
pipeline_init = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
                                     ...
                                     cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3,
                                          parallel_front_edge_mask_rows=(0, front_edge_rows))

from workspace_jam.pipelines.hyper.from_initialize import parallel_x3

pipeline_hyper = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
                                     mask_function=mask_function_for_bug, cosmic_ray_parallel_buffer=10,
                                     cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3,
                                           parallel_front_edge_mask_rows=(0, front_edge_rows))
