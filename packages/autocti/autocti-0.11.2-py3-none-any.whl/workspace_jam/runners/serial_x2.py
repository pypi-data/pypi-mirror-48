...
ci_data_model = 'serial_x2' # Shows the data was creating using a serial CTI model with one species.
...
pipeline_init = serial_x2.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution])
