...
from workspace_jam.pipelines.hyper.from_initialize import parallel_x2_serial_x3

pipeline_hyper = parallel_x2_serial_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
                                     mask_function=mask_function_for_bug, cosmic_ray_parallel_buffer=10,
                                     cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3)
