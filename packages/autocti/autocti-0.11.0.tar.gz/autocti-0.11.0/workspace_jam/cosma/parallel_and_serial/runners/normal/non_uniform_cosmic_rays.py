...
ci_data_model = 'parallel_x2_serial_x3_poisson'

ci_data_resolution = []
ci_data_resolution.append('')
ci_data_resolution.append('high_resolution') # Index 3
ci_data_resolution.append('x2_high_resolution') # Index 3
...
from workspace_jam.pipelines.initialize import parallel_x2_serial_x3

pipeline_init = parallel_x2_serial_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
...
from workspace_jam.pipelines.normal.from_initialize import parallel_x2_serial_x3

pipeline_normal = parallel_x2_serial_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model, ci_data_resolution],
                                     mask_function=mask_function_for_bug, cosmic_ray_parallel_buffer=10,
                                     cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3)
...
if ci_data_resolution is 'high_resolution':
    ...
    pipeline.run(ci_datas=ci_datas, cti_settings=cti_settings, pool=Pool(processes=16))
