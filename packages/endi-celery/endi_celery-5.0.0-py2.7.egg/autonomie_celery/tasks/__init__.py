...
from autonomie.models.third_party.customer import Customer
from autonomie.models.third_party.supplier import Supplier
...
def includeme(config):
    ...
    config.register_import_model(
        ...
        callbacks=[_import_third_party_set_label]
    )
    config.register_import_model(
        key='suppliers',
        model=Supplier,
