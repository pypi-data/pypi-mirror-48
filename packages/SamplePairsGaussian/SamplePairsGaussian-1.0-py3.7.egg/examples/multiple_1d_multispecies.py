...
if __name__ == "__main__":
    ...
    for i in range(0,no_samples):
        ...
        success = sampler.rejection_sample_pair(no_tries_max=no_tries_max,compute_species_probs=compute_species_probs,compute_probs_first_particle=compute_probs_first_particle)
        if not success:
            handle_fail()
