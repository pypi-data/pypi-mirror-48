...
from deploymanager.awsdeployer import AWSDeployer
from deploymanager.onpremdeployer import OnPremDeployer
...
def main():
    ...
    if args.env == "onprem":
        OnPremDeployer(args.configpath).build_and_deploy(args.deploy)
    elif args.env == "aws":
        AWSDeployer(args.configpath).build_and_deploy(args.deploy)
    else:
