...
class DatasetDownloader(Thread):
    ...
    def start_downloading_dataset(self, connection, download_to_path, account_uid, dataset_uid, dataset_version):
        ...
        CloudStorageUtility.sync_files(account_uid, 'datasets', dataset_uid, download_to_path, remote_dataset_path,
                                       master=FileSynchronizer.REMOTE, quiet=False, s3_full_path=cloud_storage_from_dir)
