...
```bash
TAG=2.17.0b25 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.17.0b24 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
