...
```bash
TAG=2.13.0 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.17.0b22 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
