...
class Optimizer(object):
    ...
    def end(self, experiment):
        ...
        experiment.log_other("optimizer_id", self.id)
        experiment.log_other("optimizer_pid", pid)
        experiment.log_other("optimizer_trial", trial)
    ...
    def _set(self, algorithm, parameters, name=None, trials=1, spec=None, verbose=1):
        """
