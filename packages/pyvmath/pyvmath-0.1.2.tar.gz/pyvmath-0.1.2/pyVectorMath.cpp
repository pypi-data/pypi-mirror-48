...
static PyObject* quat_rotation(PyObject * self, PyObject * args)
{
	...
	if (d2 == 1)
		vmath_quat_rotation(v2[0], v1, obj->v);
	else
...
static PyObject* quat_rotate(PyObject * self, PyObject * args) {
	...
	PyObject* a;
	PyObject* b;
	if (!PyArg_ParseTuple(args, "OO", &t, &a, &b)) return NULL;
	int d1, d2;
	float buff1[4];
	float buff2[4];
	float* v1 = pyObjToFloat((PyObject*)a, buff1, d1);
...
static PyObject* mat_rotation(PyObject * self, PyObject * args) {
	...
	float r;
	int d;
	if (!PyArg_ParseTuple(args, "if|O", &d, &r, &a)) return NULL;
...
static PyObject* mat_rotationX(PyObject * self, PyObject * args) {
	float r;
	int d;
	if (!PyArg_ParseTuple(args, "if", &d, &r)) return NULL;
...
static PyMethodDef vmath_methods[] = {
	...
	{ "sub", (PyCFunction)vec_mat_sub, METH_VARARGS },
	{ "mul", (PyCFunction)vec_mat_mul, METH_VARARGS },
	{ "div", (PyCFunction)vec_div2, METH_VARARGS },
	{ "recip", (PyCFunction)vec_recipPerElem, METH_VARARGS },
	{ "sqrt", (PyCFunction)vec_sqrtPerElem, METH_VARARGS },
	{ "rsqrt", (PyCFunction)vec_rsqrtPerElem, METH_VARARGS },
	{ "abs", (PyCFunction)vec_absPerElem, METH_VARARGS },
	{ "max", (PyCFunction)vec_maxPerElem, METH_VARARGS },
	{ "maxElem", (PyCFunction)vec_maxElem, METH_VARARGS },
	{ "min", (PyCFunction)vec_minPerElem, METH_VARARGS },
	{ "minElem", (PyCFunction)vec_minElem, METH_VARARGS },
	{ "sum", (PyCFunction)vec_sum, METH_VARARGS },
	{ "dot", (PyCFunction)vec_dot, METH_VARARGS },
	{ "lengthSqr", (PyCFunction)vec_lengthSqr, METH_VARARGS },
	{ "length", (PyCFunction)vec_length, METH_VARARGS },
	{ "normalize", (PyCFunction)vec_normalize, METH_VARARGS },
	{ "cross", (PyCFunction)vec_cross, METH_VARARGS },
	{ "lerp", (PyCFunction)vec_lerp, METH_VARARGS },
	{ "slerp", (PyCFunction)vec_slerp, METH_VARARGS },
	{"quat_rotation", (PyCFunction)quat_rotation, METH_VARARGS },
	{"quat_rotationX", (PyCFunction)quat_rotationX, METH_VARARGS },
	{"quat_rotationY", (PyCFunction)quat_rotationY, METH_VARARGS },
	{"quat_rotationZ", (PyCFunction)quat_rotationZ, METH_VARARGS },
	{"conj", (PyCFunction)quat_conj, METH_VARARGS },
	{"squad", (PyCFunction)quat_squad, METH_VARARGS },
	{"rotate", (PyCFunction)quat_rotate, METH_VARARGS },
	{"mat_rotation", (PyCFunction)mat_rotation, METH_VARARGS },
	{"mat_rotationX", (PyCFunction)mat_rotationX, METH_VARARGS },
	{"mat_rotationY", (PyCFunction)mat_rotationY, METH_VARARGS },
	{"mat_rotationZ", (PyCFunction)mat_rotationZ, METH_VARARGS },
	{"quat_rotationZYX", (PyCFunction)mat_rotationZYX, METH_VARARGS },
	{"mat_identity", (PyCFunction)mat_rotationZ, METH_VARARGS },
	{"transpose", (PyCFunction)mat_transpose, METH_VARARGS },
	{"inverse", (PyCFunction)mat_inverse, METH_VARARGS },
	{"orthoInverse", (PyCFunction)mat_orthoInverse, METH_VARARGS },
	{"determinant", (PyCFunction)mat_determinant, METH_VARARGS },
	{"scale", (PyCFunction)mat_scale, METH_VARARGS },
	{"appendScale", (PyCFunction)mat_appendScale, METH_VARARGS },
	{"prependScale", (PyCFunction)mat_prependScale, METH_VARARGS },
	{"translation", (PyCFunction)mat_translation, METH_VARARGS },
	{"lookAt", (PyCFunction)mat_lookAt, METH_VARARGS },
	{"perspective", (PyCFunction)mat_perspective, METH_VARARGS | METH_KEYWORDS },
	{"frustum", (PyCFunction)mat_frustum, METH_VARARGS },
	{"orthographic", (PyCFunction)mat_orthographic, METH_VARARGS },
