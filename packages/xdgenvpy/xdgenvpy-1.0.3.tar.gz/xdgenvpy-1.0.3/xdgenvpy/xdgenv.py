...
class XDG(object):
    ...
    def XDG_DATA_HOME(self):
        ...
        """
        return getenv('XDG_DATA_HOME', join(self._home, '.local', 'share'))
    ...
    def XDG_CONFIG_HOME(self):
        ...
        """
        return getenv('XDG_CONFIG_HOME', join(self._home, '.config'))
    ...
    def XDG_CACHE_HOME(self):
        ...
        """
        return getenv('XDG_CACHE_HOME', join(self._home, '.cache'))
    ...
    def XDG_RUNTIME_DIR(self):
        ...
        """
        default_value = join(sep, 'run', 'user', str(getuid()))
    ...
    def _get_dirs(var_name, default_value=None):
        ...
        if not default_value:
            default_value = ''
        return tuple(getenv(var_name, default_value).split(':'))
    ...
    def XDG_DATA_DIRS(self):
        ...
        dirs = XDG._get_dirs('XDG_DATA_DIRS', '/usr/local/share/:/usr/share/')
        if not dirs:
            dirs = (data_home,)
    ...
    def XDG_CONFIG_DIRS(self):
        ...
        dirs = XDG._get_dirs('XDG_CONFIG_DIRS', '/etc/xdg')
        if not dirs:
            dirs = (config_home,)
...
class XDGPackage(XDG):
    ...
    def XDG_DATA_HOME(self):
        ...
        return join(base, self._package_name)
