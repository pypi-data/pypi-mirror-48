...
class LegacyModelNames:
    ...
    class ClassificationLegacyModelNames:
        ...
        AveragedPerceptronClassifier = 'averaged perceptron classifier'
        FastLinearClassifier = 'fast linear classifier'
    ...
    class RegressionLegacyModelNames:
        ...
        FastLinearRegressor = 'fast linear regressor'
...
class SupportedModelNames:
    ...
    SupportedClassificationModelList = [
        ...
        ModelName(
            CustomerFacingSupportedModelNames.ClassificationModelNames.
            AveragedPerceptronClassifier,
            LegacyModelNames.ClassificationLegacyModelNames.AveragedPerceptronClassifier,
            ModelClassNames.ClassificationModelClassNames.AveragedPerceptronClassifier),
        ModelName(
            CustomerFacingSupportedModelNames.ClassificationModelNames.
            FastLinearClassifier,
            LegacyModelNames.ClassificationLegacyModelNames.FastLinearClassifier,
            ModelClassNames.ClassificationModelClassNames.FastLinearClassifier),
        ModelName(
            CustomerFacingSupportedModelNames.ClassificationModelNames.
            GradientBoosting,
    ...
    SupportedRegressionModelList = [
        ...
        ModelName(
            CustomerFacingSupportedModelNames.RegressionModelNames.
            FastLinearRegressor,
            LegacyModelNames.RegressionLegacyModelNames.FastLinearRegressor,
            ModelClassNames.RegressionModelClassNames.FastLinearRegressor),
        ModelName(
            CustomerFacingSupportedModelNames.RegressionModelNames.
            TensorFlowLinearRegressor,
            LegacyModelNames.RegressionLegacyModelNames.
...
class ModelParameters:
    ...
    CATEGORICAL_FEATURES = {
        ...
        # TODO: Use these when the CatBoost model wrapper is added
