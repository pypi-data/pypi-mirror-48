...
setup(
    ...
    license='MIT',
    keywords=
    'deal contracts pre post invariant decorators validation pythonic functional',
    classifiers=[
    ...
    extras_require={
        'dev': [
            'coverage', 'djburger', 'm2r', 'marshmallow', 'recommonmark',
            'sphinx', 'sphinx-rtd-theme', 'urllib3'
        ],
