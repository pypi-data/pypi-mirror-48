...
try:
    ...
    # for py2
    # lru_cache doesn't exist in Python2, so bellow is dummy implementation
    # of if that matches original lru_cache interface. Difference is, no
    # caching will be performed for Python2.
...
def check_environ_vars(server_type):
    ...
    Returns:
        decorated function
    """
    from typhoon.api import get_server_configuration
