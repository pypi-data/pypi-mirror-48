...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--version", "-v", action='version', version='%(prog)s 1.2.12',
    ...
    def load_config(self, path_to_config):
        try:
            ...
            raise methods.Svist4getError('Unable to parse the specified config file. Please check the config file') from error
    ...
    def load_palette(self):
        try:
            ...
            raise methods.Svist4getError('Unable to load palette. Please check the palette path in the config file') from error
    ...
    def load_triplet_code(self):
        try:
            ...
            raise methods.Svist4getError('Unable to load triplet code. Please check the triplet code path in the config file') from error
    ...
    def load_font(self):
        try:
            ...
            raise methods.Svist4getError('Unable to load font. Please check the font paths in the config file.') from error
    ...
    def create_pdf(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create the pdf file. There might be a problem with the \'reportlab\' python package.') from error
...
class Image:
    ...
    def highlighting_the_frame(self):
        try:
            ...
            raise methods.Svist4getError('Unable to highlight the requested frame. Please check the entered data (see the program manual).') from error
    ...
    def save(self):
        try:
            ...
            raise methods.Svist4getError('Unable to save the pdf file. There might be a problem with the \'reportlab\' python package.') from error
...
class Vgrid_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Vgrid track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Title_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Image label track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Axis_tics_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Axis tics track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Nt_seq_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Nucleotide sequence track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Transcript_struct_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Transcript structure track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Bedgraph_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Bedgraph track. Please check the entered data and the installation of the required modules (see the program manual).') from error
...
class Aa_seq_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError("Unable to create an Aminoacid sequence track. Please check the entered data and the installation of the required modules (see the program manual). It can be problem with generating or loading fasta sequence file. Please check if 'bedtools' software is installed.") from error
...
class Genomic_intervals_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            raise methods.Svist4getError('Unable to create a Genomic intervals track. Please check the entered data and the installation of the required modules (see the program manual).') from error
