...
setup(
    ...
    description='camara API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://gitlab.com/maribedran/tapioca-camara',
    packages=[
        'tapioca_camara',
    ],
    package_dir={'tapioca_camara': 'tapioca_camara'},
