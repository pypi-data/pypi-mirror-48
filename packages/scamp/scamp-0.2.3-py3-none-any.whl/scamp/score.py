...
class Voice(ScoreComponent, ScoreContainer):
    ...
    def _recombine_processed_contents(self, processed_contents, measure_quantization):
        """
        Recombine
        :param processed_contents: list of NoteLike objects
        :param measure_quantization: the MeasureQuantizationScheme used
