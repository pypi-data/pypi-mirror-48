...
class PaginationpageChangeDetection:
    ...
    def __init__(self):
        ...
        self.codetype = "Pagination page change detection"
        ...
        try:
            if type(prev_url) is str:
                if url_validator.url(prev_url):
                    ...
                    self.logger.info("Previous URL : " + str(self.prev_url))
                    return True
        ...
        try:
            if type(curr_url) is str:
                if url_validator.url(curr_url):
                    ...
                    self.logger.info("Current URL : " + self.curr_url)
                    return True
    ...
    def set_prev_screen_shot(self, prev_screen_shot):
        ...
        try:
            ...
            if type(prev_screen_shot) is str:
                ...
                self.logger.info("previous Screenshot path : " + self.prev_screen_shot_uri)
                return True
            self.logger.info("previous Screenshot path : " + self.prev_screen_shot_uri)
    ...
    def set_curr_screen_shot(self, curr_screen_shot):
        ...
        try:
            if type(curr_screen_shot) is str:
                ...
                self.logger.info("Current Screenshot path : " + self.curr_screen_shot_uri)
    ...
    def set_prev_content(self, prev_content):
        ...
        try:
            if type(prev_content) is str:
                ...
                self.logger.info("Previous page content is loaded")
                return True
            self.invalid_para_list.append("prev_content")
            self.logger.info("Previous page content is NOT FOUND ")
            return False
        except Exception as e:
            self.logger.debug(format_exc())
            self.invalid_para_list.append("prev_content")
    ...
    def set_curr_content(self, curr_content):
        ...
        try:
            if type(curr_content) is str:
                ...
                self.logger.info("Current page content is NOT FOUND ")
                return True
    ...
    def get_screen_shot_image(self, screen_shot_path):
        """
        load image
    ...
    def get_report(self, prev_url, curr_url, prev_screen_shot, curr_screen_shot, prev_content, curr_content):
        ...
        try:
            ...
            self.logger.info(
                " #Url result : " + str(url_result) + " #Content result : " + str(content_result) + " #Screen shot result : " + str(screen_shot_result))
    ...
    def get_percentage_change_in_url(self):
        ...
        try:
            ...
            self.logger.info(
                "percentage change in url : 1. using URL TOOLs method :" + str(method_url_tools) + " 2. using url difference method : " + str(method_url_difference))
        ...
        try:
            ...
            if percentage_change_in_content is not False:
                ...
                if percentage_change_in_content > (1.0 - self.threshold_content):
                    self.logger.info("text is not matched, threshold is : " + str(self.threshold_content))
                    return True
                self.logger.info("text is matched, threshold" + str(self.threshold_content))
            return False
        except Exception as e:
            self.logger.debug(format_exc())
            return False
    ...
    def get_percentage_change_in_screen_shot(self):
        ...
        try:
            ...
            self.logger.info(
                "cv2, manhattan norm and z-norm result :" + str(cv2_result) + str(m_norm_result) + str(z_norm_result))
    ...
    def compare_image_by_cv2(self, image_one, image_two):
        ...
        try:
            ...
            self.logger.info("len(contours) :" + str(len(contours)))
