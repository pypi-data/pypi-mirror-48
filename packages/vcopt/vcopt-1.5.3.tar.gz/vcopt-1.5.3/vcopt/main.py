...
class vcopt:
    ...
    #score pool
    def score_pool(self): #ndarray index to ndarray original
        for i in range(self.pool_num):
            
            bar = '\rScoring first gen {}/{}  (If too late, consider pool_num=100 option)       '.format(i + 1, self.pool_num)
            print(bar, end='')
    ...
    def score_pool_rc(self): #ndarray to ndarray original
        for i in range(self.pool_num):
    ...
    def tspGA(self, para_range, score_func, aim, show_pool_func=None, seed=None, pool_num=None, max_gen=None):
        ...
        for i in range(self.pool_num):
            ...
            bar = '\rMini 2-opting first gen {}/{}  (If too late, consider pool_num=100 option)'.format(i + 1, self.pool_num)
            print(bar, end='')
