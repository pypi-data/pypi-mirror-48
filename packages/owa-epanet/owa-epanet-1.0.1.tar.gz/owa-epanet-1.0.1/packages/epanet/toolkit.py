...
def runH(ph, currentTime):
    r"""
    runH(ph, currentTime) -> int
    ...
    """
    return _toolkit.runH(ph, currentTime)
...
def nextH(ph, tStep):
    ...
    """
    return _toolkit.nextH(ph, tStep)
...
def runQ(ph, currentTime):
    r"""
    runQ(ph, currentTime) -> int
    ...
    """
    return _toolkit.runQ(ph, currentTime)
...
def nextQ(ph, tStep):
    ...
    """
    return _toolkit.nextQ(ph, tStep)

def stepQ(ph, timeLeft):
    r"""
    stepQ(ph, timeLeft) -> int
    ...
    """
    return _toolkit.stepQ(ph, timeLeft)
