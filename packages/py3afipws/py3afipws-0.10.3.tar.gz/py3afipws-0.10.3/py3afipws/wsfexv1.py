...
"""M�dulo para obtener CAE, c�digo de autorizaci�n de impresi�n o electr�nico,
del web service WSFEXv1 de AFIP (Factura Electr�nica Exportaci�n Versi�n 1)
seg�n RG2758/2010 (Registros Especiales Aduaneros) y RG3689/14 (servicios)
...
class WSFEXv1(BaseWS):
    ...
    def GetParamTipoCbte(self, sep="|"):
        "Recuperador de valores referenciales de c�digos de Tipo de comprobantes"
...
if __name__ == "__main__":
    ...
    #    win32com.server.localserver.serve([WSFEXv1._reg_clsid_])
        ...
        # Conectar al Servicio Web de Facturaci�n (producci�n u homologaci�n)
        if "--prod" in sys.argv:
        ...
        if "--prueba" in sys.argv:
            try:
                ...
                domicilio_cliente = u"R�a Ѱ76 km 34.5 Alagoas"
