...
class TrazaMed(BaseWS):
    ...
    def SendMedicamentosDHSerie(
        ...
        "Envía un lote de medicamentos informando el desde-hasta número de \
            serie"
        # creo los parámetros para esta llamada
        params = {
            'f_evento': f_evento,
    ...
    def SendAlertaTransacc(self, usuario, password, p_ids_transac_ws):
        "Alerta un medicamento, acción contraria a “confirmar la \
            transacción”."
    ...
    if '--cancela' in sys.argv:
        ...
        if not medicamentos:
            ...
            try:
                ...
                print(
                    "ADVERTENCIA: no se indico parámetros usuario y passoword"
                )
                print(e)
...
# busco el directorio de instalación (global para que no cambie si
# usan otra dll)
