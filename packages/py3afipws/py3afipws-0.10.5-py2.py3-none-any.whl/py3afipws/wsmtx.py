...
class WSMTXCA(BaseWS):
    "Interfaz para el WebService de Factura Electrónica Mercado Interno \
        WSMTXCA"
    _public_methods_ = [
        ...
        'ConsultarCotizacionMoneda', 'ConsultarPuntosVentaCAE',
        'ConsultarPuntosVentaCAEA', 'AnalizarXml', 'ObtenerTagXml',
        'LoadTestXML', 'SetParametros', 'SetTicketAcceso', 'GetParametro',
    ...
    def AutorizarAjusteIVA(self):
        """Envía la información del comprobante de ajuste de IVA que desea
        autorizar"""
        f = self.factura
        # contruyo la estructura a convertir en XML:
        fact = {
    ...
    def InformarComprobanteCAEA(self):
        ...
        # fecha de vencimiento opcional (igual al último día de vigencia
        # del CAEA)
    ...
    def ConsultarTiposComprobante(self):
        """Este método permite consultar los tipos de comprobantes habilitados
        en este WS"""
    ...
    def ConsultarPuntosVentaCAE(
        ...
        """Este método permite consultar los puntos de venta habilitados para
        CAE en este WS"""
    ...
    def ConsultarPtosVtaCAEANoInformados(self, caea):
        """Este método permite  consultar que puntos de venta aún no fueron
