...
class PyI25:
    ...
    def DigitoVerificadorModulo10(self, codigo):
        ...
        # que están ubicados en las posiciones pares.
        etapa3 = sum([int(c) for i, c in enumerate(codigo) if i % 2])
        # Etapa 4: sumar los resultados obtenidos en las etapas 2 y 3.
        etapa4 = etapa2 + etapa3
        # Etapa 5: buscar el menor número que sumado al resultado obtenido
        # en la etapa 4 dé un número múltiplo de 10. Este será el valor del
        # dígito verificador del módulo 10.
