...
class WSBFE:
    ...
    def GetParamTipoCbte(self):
        "Recuperar lista de valores referenciales de códigos de Tipos de \
        comprobante"
    ...
    def GetParamNCM(self):
        "Recuperar lista de valores referenciales de códigos del Nomenclador \
        Común del Mercosur"
...
class WSFEX:
    ...
    def GetParamTipoExpo(self):
        "Recuperar lista de valores referenciales de códigos de Tipo de \
        exportación"
