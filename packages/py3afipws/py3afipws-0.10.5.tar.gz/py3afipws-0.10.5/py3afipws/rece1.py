...
LICENCIA = """
rece1.py: Interfaz de texto para generar Facturas Electrónica Mercado Interno
V1
...
if __name__ == "__main__":
    if '/ayuda' in sys.argv:
        ...
        print(
            ...
            previamente (verificación)")
        print(
            " /xml: almacena los requerimientos y respuestas XML (depuración)")
        print(" /dbf: lee y almacena la información en tablas DBF")
        print(
            "Ver rece.ini para parámetros de configuración (URL, \
            certificados, etc.)")
        sys.exit(0)
                ...
                if '/dbf' not in sys.argv:
                    ...
                    for fmt in formato:
                        ...
                        dec = len(fmt) > 3 and fmt[3] or (
                            tipo == 'I' and '2' or '')
                        print(" * Campo: %-20s Posición: %3d Longitud: %4d \
                            Tipo: %s Decimales: %s" % (
