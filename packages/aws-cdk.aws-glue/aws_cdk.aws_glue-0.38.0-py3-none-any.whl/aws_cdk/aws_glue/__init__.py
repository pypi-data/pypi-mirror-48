...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-glue", "0.38.0", __name__, "aws-glue@0.38.0.jsii.tgz")
...
class CfnJob(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.CfnJob"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-glue.CfnJob.JobCommandProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'script_location': 'scriptLocation'})
    class JobCommandProperty():
        def __init__(self, *, name: typing.Optional[str]=None, script_location: typing.Optional[str]=None):
            """
