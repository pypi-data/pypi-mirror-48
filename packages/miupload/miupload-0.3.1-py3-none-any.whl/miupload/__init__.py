...
def submit_notebook(assignment = None):
    ...
    if (str(r.content)[0] == "Y"):
        print("Upload successful!")
        print("You can view your submitted notebook on https://nbviewer.jupyter.org/urls/".base_url.replace("https://","").replace("http://","")+"uploads/"+str(r.content)[1:])
        return True
    else:
        print("Upload failed! Error:", str(r.content))
        return False
