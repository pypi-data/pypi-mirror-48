...
import api-tester-upload-test.models.redirect_settings
import api-tester-upload-test.models.signature_type
import api-tester-upload-test.models.ui
...
class Signer(object):
    ...
    def from_dictionary(cls,
        ...
        redirect_settings = api-tester-upload-test.models.redirect_settings.RedirectSettings.from_dictionary(dictionary.get('redirectSettings')) if dictionary.get('redirectSettings') else None
        required = dictionary.get('required')
        signature_type = api-tester-upload-test.models.signature_type.SignatureType.from_dictionary(dictionary.get('signatureType')) if dictionary.get('signatureType') else None
        tags = dictionary.get('tags')
        ui = api-tester-upload-test.models.ui.Ui.from_dictionary(dictionary.get('ui')) if dictionary.get('ui') else None
