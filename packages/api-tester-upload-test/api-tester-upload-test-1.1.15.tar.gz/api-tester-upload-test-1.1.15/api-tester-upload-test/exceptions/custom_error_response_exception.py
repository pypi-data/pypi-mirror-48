...
class CustomErrorResponseException(api-tester-upload-test.exceptions.api_exception.APIException):
    def __init__(self, reason, context):
        ...
        """
        super(CustomErrorResponseException, self).__init__(reason, context)
