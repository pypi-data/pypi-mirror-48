...
import api-tester-upload-test.models.response_data
...
class Complex5(object):
    ...
    def from_dictionary(cls,
        ...
        response_data = api-tester-upload-test.models.response_data.ResponseData.from_dictionary(dictionary.get('responseData')) if dictionary.get('responseData') else None
