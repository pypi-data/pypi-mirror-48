...
import api-tester-upload-test.models.gloss_div
...
class Glossary(object):
    ...
    def from_dictionary(cls,
        ...
        gloss_div = api-tester-upload-test.models.gloss_div.GlossDiv.from_dictionary(dictionary.get('GlossDiv')) if dictionary.get('GlossDiv') else None
