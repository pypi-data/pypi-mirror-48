...
import tester.models.add_rfc_3339_datetime_in_global_exception
...
class SendRfc3339InModelAsException(tester.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        """
        self.body = tester.models.add_rfc_3339_datetime_in_global_exception.AddRfc3339DatetimeInGlobalException.from_dictionary(dictionary.get('body')) if dictionary.get('body') else None
