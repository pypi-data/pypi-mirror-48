...
import tester.models.validate


class NestedModelException(tester.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        self.model = tester.models.validate.Validate.from_dictionary(dictionary.get('model')) if dictionary.get('model') else None
