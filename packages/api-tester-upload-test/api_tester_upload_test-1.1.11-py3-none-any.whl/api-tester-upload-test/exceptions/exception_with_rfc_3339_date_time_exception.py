...
class ExceptionWithRfc3339DateTimeException(api-tester-upload-test.exceptions.api_exception.APIException):
    def __init__(self, reason, context):
        ...
        """
        super(ExceptionWithRfc3339DateTimeException, self).__init__(reason, context)
