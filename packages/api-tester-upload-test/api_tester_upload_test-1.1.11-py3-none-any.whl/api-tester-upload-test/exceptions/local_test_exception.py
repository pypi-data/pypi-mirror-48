...
import api-tester-upload-test.exceptions.global_test_exception

class LocalTestException(api-tester-upload-test.exceptions.global_test_exception.GlobalTestException):
