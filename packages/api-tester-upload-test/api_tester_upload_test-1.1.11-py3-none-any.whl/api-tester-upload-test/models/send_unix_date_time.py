...
import api-tester-upload-test.models.unix_date_time
...
class SendUnixDateTime(object):
    ...
    def from_dictionary(cls,
        ...
        date_time = api-tester-upload-test.models.unix_date_time.UnixDateTime.from_dictionary(dictionary.get('dateTime')) if dictionary.get('dateTime') else None
