...
import api-tester-upload-test.models.time_to_live
...
class Advanced(object):
    ...
    def from_dictionary(cls,
        ...
        time_to_live = api-tester-upload-test.models.time_to_live.TimeToLive.from_dictionary(dictionary.get('timeToLive')) if dictionary.get('timeToLive') else None
