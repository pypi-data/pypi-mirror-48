...
import api-tester-upload-test.models.gloss_entry
...
class GlossList(object):
    ...
    def from_dictionary(cls,
        ...
        gloss_entry = api-tester-upload-test.models.gloss_entry.GlossEntry.from_dictionary(dictionary.get('GlossEntry')) if dictionary.get('GlossEntry') else None
