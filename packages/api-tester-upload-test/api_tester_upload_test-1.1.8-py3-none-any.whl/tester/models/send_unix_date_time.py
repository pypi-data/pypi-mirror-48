...
This file was automatically generated for Stamplay by APIMATIC v2.0 (
 https://apimatic.io ).
"""
import tester.models.unix_date_time
...
class SendUnixDateTime(object):
    ...
    def from_dictionary(cls,
        ...
        date_time = tester.models.unix_date_time.UnixDateTime.from_dictionary(dictionary.get('dateTime')) if dictionary.get('dateTime') else None
