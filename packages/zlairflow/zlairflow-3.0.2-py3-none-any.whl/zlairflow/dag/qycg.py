import sys
import os 
from zlairflow.dag.data_qycg import para
...
# write_dag('qycg_guandong_dongguan',r'C:\Users\jacky\Desktop\zhulongall\zlairflow\zlairflow\data',start_date='(2019,6,17)',tiemout='minutes=120')