import sys
import os 
from zlairflow.dag.data_gcjs import para
...
# write_dag("gcjs_anhui_anqing",r"C:\Users\jacky\Desktop\zhulongall\zlairflow\zlairflow\data",start_date='(2019,5,20)',cron='0 0 1/2 * *')