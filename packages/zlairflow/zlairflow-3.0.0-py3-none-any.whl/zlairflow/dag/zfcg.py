import sys
import os 
from zlairflow.dag.data_zfcg import para
...
def write_dag(quyu,dirname,**krg):
    ...
    filename="v2_%s.py"%quyu
    path1=os.path.join(os.path.dirname(__file__),'template','zfcg.txt')
    ...
    d = DAG('##abc_anhui_anqing##'
            ...
            ,max_active_runs=1) 
    """
    content=content.replace("##v2_zfcg_anhui_anqing##","v2_%s"%quyu)
...
# write_dag('zfcg_guandong_dongguan',r'C:\Users\jacky\Desktop\zhulongall\zlairflow\data',start_date='(2019,6,17)',tiemout='minutes=120')