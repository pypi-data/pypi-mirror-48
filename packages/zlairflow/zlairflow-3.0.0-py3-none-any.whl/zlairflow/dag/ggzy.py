import sys
import os 
from zlairflow.dag.data_ggzy import para
...
# write_dag('guandong_dongguan',r'C:\Users\jacky\Desktop\zhulongall\zlairflow\data',start_date='(2019,6,17)',tiemout='minutes=120')