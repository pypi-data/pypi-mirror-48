...
class FeatureImportanceExplanation(BaseExplanation):
    """Defines the common feature importance explanation returned by explainers."""
...
class GlobalExplanation(FeatureImportanceExplanation):
    ...
    def get_raw_feature_importances(self, raw_feat_indices, weights=None):
        ...
        return _get_raw_feature_importances(
            np.array(self.global_importance_values), raw_feat_indices, weights).tolist()
