...
If you want to use rbql module as python library for your project read the integration [docs](https://github.com/mechatroner/rbql-py/blob/master/LIBRARY.md).
