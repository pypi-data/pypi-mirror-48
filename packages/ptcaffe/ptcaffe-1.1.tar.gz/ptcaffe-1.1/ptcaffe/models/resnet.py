...
class ResNet18(ResNet):
    ...
    def __init__(self, layer, input_shape):
        ...
        source = kwargs.pop('source') if 'source' in kwargs else 'torchvision'
        ...
        if pretrained:
            if source == 'torchvision':
                ...
                gcv_model = gcv.models.resnet18(pretrained=True)
                self.load_state_dict(gcv_model.state_dict())
    ...
    def __init__(self, layer, input_shape):
        ...
        if pretrained:
            if source == 'torchvision':
                ...
                import gluoncvth as gcv
                gcv_model = gcv.models.resnet34(pretrained=True)
                self.load_state_dict(gcv_model.state_dict())
    ...
    def __init__(self, layer, input_shape):
        ...
        if pretrained:
            if source == 'torchvision':
                ...
                import gluoncvth as gcv
                gcv_model = gcv.models.resnet50(pretrained=True)
                self.load_state_dict(gcv_model.state_dict())
    ...
    def __init__(self, layer, input_shape):
        ...
        if pretrained:
            if source == 'torchvision':
                ...
                import gluoncvth as gcv
                gcv_model = gcv.models.resnet101(pretrained=True)
                self.load_state_dict(gcv_model.state_dict())
    ...
    def __init__(self, layer, input_shape):
        ...
        if pretrained:
            if source == 'torchvision':
                ...
                import gluoncvth as gcv
                gcv_model = gcv.models.resnet152(pretrained=True)
                self.load_state_dict(gcv_model.state_dict())
