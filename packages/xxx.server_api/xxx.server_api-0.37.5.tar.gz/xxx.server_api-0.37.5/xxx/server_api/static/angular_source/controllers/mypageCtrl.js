module.exports = function(myModule) {
    myModule.controller('mypageCtrl',[
      '$scope', '$rootScope', '$http', '$routeParams', '$cookies', 'CouchdbService', 'WebappService',
      function ($scope, $rootScope, $http, $routeParams, $cookies, CouchdbService, WebappService) {
           // check if user is logged in
           if($cookies.get('contactNumber')){$rootScope.contactNumber = $cookies.get('contactNumber')};
           console.log('mypageCtrl started');
           ...
           $scope.add_post = function(){
            ...
            if(!$scope.title || !$scope.description){
              $scope.errorMessage = "title and description are required ";
            }

            if(!$scope.errorMessage){
                WebappService.add_post($scope.contactNumber, $scope.title, $scope.description,
