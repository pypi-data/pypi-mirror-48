...
class ProductRunner:
    ...
    def __init__(self, productDir, productName, params, ioHandler=None, ui=None,
                 loaderSuite=None, unloaderSuite=None):
        ...
        self.loadStart = Signals.Signal()
        self.loadStepStart = Signals.Signal()
        self.loadStepComplete = Signals.Signal()
        self.loadComplete = Signals.Signal()
    ...
    def getStartStepExecutor(self):
        return self._startStepsExec
    ...
    def load(self, startTrigger=True, startMonitor=True):
        if self._state == ProductRunner.RunnerState.INIT:
            ...
            self.params.setReadOnly(False)
            self.params["startTrigger"] = startTrigger
            self.params["startMonitor"] = startMonitor
