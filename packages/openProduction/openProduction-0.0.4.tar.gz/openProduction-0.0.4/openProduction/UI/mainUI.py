...
@author: Markus
"""
from openProduction.suite import TestSuiteIO, TestSuite
from concurrent.futures import ThreadPoolExecutor, Future
from PyQt5 import QtCore, QtQml, QtWidgets, QtMultimedia
...
class TestRunnerQML(QtCore.QObject):
    ...
    sequenceComplete = QtCore.pyqtSignal(TestSuite.SuiteState, bool, float, name='sequenceComplete')
...
#        cli = TestRunnerCli.TestSuiteCliRunner(testSuiteRunner=self.testSuiteRunner)
    ...
    def _onSequenceCompleteAsync(self, state, suiteResult):
        if state == self.suiteState:
            ...
            self.sequenceComplete.emit(state, success, suiteResult.executionTime)
