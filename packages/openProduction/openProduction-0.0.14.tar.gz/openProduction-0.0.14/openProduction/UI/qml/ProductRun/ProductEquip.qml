...
Item {
    ...
    function onProductStationLoadCompleted () {
        ...
        else
        {
            ...
            /*
            var component = Qt.createComponent("TestRunnerSimple.qml");
            win = component.createObject(root);



            win.testRunnerFinished.connect(onProductLoadComplete)
            component.runnerType = "load"
            component.runner = station.getLoadedProduct()
            component.primaryColor = root.primaryColor;
            component.secondaryColor = root.secondaryColor;
            component.backgroundColor = root.backgroundColor;
