...
Item {
    ...
    function onNewImageData() {
        ...
        num = num + 1
        //plotResultsLoader.sourceComponent = myImgComponent;
    ...
    function onStepStart(caseNameidxnumCases) {
        var myIdx = idx + 1
        curResult.text = curResult.text + caseName + "(" + myIdx + " von " + numCases + "): ... "
    }

    function onStepComplete(stateresultmsgfullNameidxnumCases) {
        var resStr
        if (result === 2)
            resStr = "Exception"
        else if (result === 1)
    ...
    function onSequenceComplete(suiteStatesuccessdurationvalues) {
        ...
        curResult.text = curResult.text
                + "----------------------------------------------------------------------\n"
        curResult.text = curResult.text + resultStr + "\n"
            ...
            RowLayout {
                ...
                Pane {
                    ...
                    Loader {
                        ...
                        anchors.fill: parent
                        sourceComponent: myImgComponent
                    }
                }
