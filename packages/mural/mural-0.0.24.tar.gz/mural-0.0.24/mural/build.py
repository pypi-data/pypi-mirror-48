...
try:
    ...
    from mural.Commodity import Commodity
    from mural.Business import Business #cluster0-7aeh1.azure.mongodb.net
...
def buildMarkets():
    ...
    nike.stock['Red'].quantity+=10
    nike.stock['Blue'].quantity+=10
    adidas.stock['Red'].quantity+=10
    adidas.stock['Green'].quantity+=10
    sc.save()
    sf.save()
    rwc.save()
