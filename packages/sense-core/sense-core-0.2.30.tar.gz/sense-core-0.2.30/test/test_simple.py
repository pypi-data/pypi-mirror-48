...
def test_rabbit_produce():
    ...
    producer = sd.RabbitProducer(config_info={'user': 'admin', 'password': 'sense_mq@2018', 'host': '52.82.30.135', 'port': 5672})
    for i in range(1, 10):
...
def test_kafka_consumer():
    sd.log_init_config('core', '/tmp/logs')
    consumer = sd.RabbitConsumer(topic='test3', config_info={'user': 'admin', 'password': 'sense_mq@2018', 'host': '52.82.30.135', 'port': 5672})
