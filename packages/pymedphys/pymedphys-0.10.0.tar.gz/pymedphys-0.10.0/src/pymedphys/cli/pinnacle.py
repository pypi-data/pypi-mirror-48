...
def pinnacle_cli(subparsers):
    pinnacle_parser = subparsers.add_parser(
        'pinnacle',
        help='A toolbox to export raw Pinnacle data to DICOM.')
...
def export_pinnacle(pinnacle_subparsers):
    parser = pinnacle_subparsers.add_parser(
        'export',
        help='Export a raw file to DICOM')
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help=("Modalities to export (CT exports the plans primary "
              "planning CT)."))

    parser.add_argument(
        '-p', '--plan',
        help=("The name of the plan to export (first plan will be "
              "exported by default)."))

    parser.add_argument(
        '-t', '--trial',
        help=("The name of the trial to export (first trial will be "
              "exported by default)."))

    parser.add_argument(
        '-i', '--image',
        help=("The UID of an image series you would like to export "
