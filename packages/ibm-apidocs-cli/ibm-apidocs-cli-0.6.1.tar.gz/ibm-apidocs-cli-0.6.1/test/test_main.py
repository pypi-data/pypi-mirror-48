...
def test_get_sdk_generator_cli():
  cli = get_sdk_generator_cli(sdk_generator='./test/resources/sdk-generator/run.jar', temp_dir=None)
  assert cli is not None
  assert cli.endswith('/test/resources/sdk-generator/run.jar')

  cli = get_sdk_generator_cli(sdk_generator=None, temp_dir='./test/target')
  assert cli is not None
