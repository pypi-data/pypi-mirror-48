...
def main():
    ...
    sdk_generator_cli = get_sdk_generator_cli(args.sdk_generator, temp_dir)
...
def get_sdk_generator_cli(sdk_generator=None, temp_dir=None):
    ...
    if not sdk_generator:
        ...
        r = requests.get('https://api.github.ibm.com/repos/CloudEngineering/openapi-sdkgen/releases/latest',
