data_manager = [
    "edc_data_manager.add_crfqueryrule",
    "edc_data_manager.add_dataquery",
    "edc_data_manager.add_requisitionqueryrule",
    "edc_data_manager.change_crfqueryrule",
    "edc_data_manager.change_dataquery",
    "edc_data_manager.change_requisitionqueryrule",
    "edc_data_manager.delete_crfqueryrule",
    "edc_data_manager.delete_dataquery",
    "edc_data_manager.delete_requisitionqueryrule",
