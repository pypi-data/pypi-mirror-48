...
class PSCF:
    ...
    def run(self):
        """Run the PSCF model and add 4 attribute to the PSCF object:

        self.ngrid_ : the number of end-point of back-trajectories in each gric
            cell
        self.mgrid_ : the number of en-point of back-trajectories in each
            grid cell accociated with concentration > self.concCrit
        self.PSCF_ : mgrid/ngrid, the PSCF data.
        self.trajdensity_ : log_10(ngrid)
        """
