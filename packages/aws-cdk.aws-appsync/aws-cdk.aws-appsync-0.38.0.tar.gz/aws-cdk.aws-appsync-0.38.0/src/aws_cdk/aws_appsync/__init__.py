...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appsync", "0.38.0", __name__, "aws-appsync@0.38.0.jsii.tgz")
...
class CfnGraphQLApi(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appsync.CfnGraphQLApi"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appsync.CfnGraphQLApi.LogConfigProperty", jsii_struct_bases=[], name_mapping={'cloud_watch_logs_role_arn': 'cloudWatchLogsRoleArn', 'field_log_level': 'fieldLogLevel'})
    class LogConfigProperty():
        def __init__(self, *, cloud_watch_logs_role_arn: typing.Optional[str]=None, field_log_level: typing.Optional[str]=None):
            """
