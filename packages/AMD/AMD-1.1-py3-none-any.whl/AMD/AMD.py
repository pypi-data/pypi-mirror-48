...
y = [48, 88, 36, 59, 84, 74, 30, 89, 48, 70, 48, 23, 67, 32, 13, 75, 24, 63, 88, 33]

hyb = hybridize(y)

filteredHyb = filter(hyb,farFrom='avg',minDeviation=10,maxDeviation=20,frequentAverage=True)

compGraph(hyb,filteredHyb)
