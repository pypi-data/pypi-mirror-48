...
class pdict(_compatible_metaclass(_SyntaxSugar, dict)):
  ...
  **Conversion:**
  ...
  def update_with(self, map_or_fn=None, inplace=True, **kw):
    # TODO(iansf): value equivalent of rekey.
    qj(s='pdict.update_with does nothing!')
    return self
