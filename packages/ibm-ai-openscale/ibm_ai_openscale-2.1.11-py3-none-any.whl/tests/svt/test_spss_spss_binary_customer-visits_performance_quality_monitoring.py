...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_06_subscribe_spss_asset(self):
        TestAIOpenScaleClient.feature_cols = ['customer_id', 'campaign', 'age', 'age_youngest_child',
        ...
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(
            SPSSMachineLearningAsset(source_uid=TestAIOpenScaleClient.source_uid,
                                     ...
                                     feature_columns=TestAIOpenScaleClient.feature_cols,
    ...
    def test_21_setup_explainability(self):
        req_cols = TestAIOpenScaleClient.feature_cols + ["product_id"]
        TestAIOpenScaleClient.data_df = pd.read_csv("datasets/customer-visits/customer_train.csv")[req_cols]
