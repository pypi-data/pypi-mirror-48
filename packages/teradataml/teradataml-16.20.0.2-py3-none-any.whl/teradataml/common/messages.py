...
class Messages():
    ...
    __messages = [
            ...
            [ErrorInfoCodes.NO_MODEL_OWNED_BY_USER_FOUND, MessageCodes.NO_MODEL_OWNED_BY_USER_FOUND],
            [ErrorInfoCodes.MODEL_MANAGEMENT_TABLE_DOES_EXIST, MessageCodes.MODEL_MANAGEMENT_TABLE_DOES_EXIST],
            ...
            [ErrorInfoCodes.SERIES_INVALID_AXIS, MessageCodes.SERIES_INVALID_AXIS],
            ...
            [ErrorInfoCodes.CONCAT_COL_TYPE_MISMATCH, MessageCodes.CONCAT_COL_TYPE_MISMATCH],
            [ErrorInfoCodes.CONCAT_FAILED, MessageCodes.CONCAT_FAILED],
