...
class ErrorInfoCodes(Enum):
    ...
    CONCAT_COL_TYPE_MISMATCH = 'TDML_2073'
    CONCAT_FAILED = 'TDML_2074'
    ...
    SERIES_INVALID_AXIS = 'TDML_2092'
    SERIES_CREATE_FAIL = 'TDML_2093'

    # MODEL ADMINISTRATION ERROR CODES starting from 2200 - Reserved till 2220
    MODEL_ALREADY_EXISTS = 'TDML_2200'
    MODEL_NOT_FOUND = 'TDML_2201'
    MODEL_WITH_SEARCH_CRITERION_NOT_FOUND = 'TDML_2202'
    NO_MODEL_OWNED_BY_USER_FOUND = 'TDML_2203'
    MODEL_MANAGEMENT_TABLE_DOES_EXIST = 'TDML_2204'
...
class MessageCodes(Enum):
    ...
    NO_MODEL_OWNED_BY_USER_FOUND    = "No models saved or owned by the user were found."
    MODEL_MANAGEMENT_TABLE_DOES_EXIST = "Model Manager could not find any models. Try saving the model's first using 'save_model' function."
    ...
    SERIES_INVALID_AXIS                = "Invalid value for argument axis: {}. Expected one of the following: {}"
    ...
    CONCAT_COL_TYPE_MISMATCH        = "concat() operation failed possibly due to datatype incompatibility."
    CONCAT_FAILED                   = "Failed to concatenate the DataFrames."
