...
class NGramSplitter:
    ...
    def __init__(self,
        ...
        DESCRIPTION:
            ...
            Note: This function is only available when teradataml is connected to Vantage 1.1 
            or later versions (Machine Learning Engine 8.10.00.00 or above).
        ...
        PARAMETERS:
            ...
            text_column:
                ...
                must contain string of a valid SQL object names.
                Types: str
            ...
            grams:
                ...
                words, of each ngram (that is, the value of n). A range of values has 
            ...
            reset:
                ...
                A n-gram cannot span two sentences.
                Default Value: ".,?!"
                Types: str
            
            total_gram_count:
                Optional Argument.
                Specifies whether the function returns the total number of ngrams in the 
