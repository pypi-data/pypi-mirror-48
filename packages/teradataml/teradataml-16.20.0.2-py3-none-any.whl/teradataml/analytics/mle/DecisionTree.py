...
class DecisionTree:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            output_response_probdist:
                ...
                'output_response_probdist' argument can accept input value True
    ...
    def __validate(self):
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.weight_column, "weight_column", self.response_table, "response_table", False)
