...
class NPath:
    ...
    def __init__(self,
        ...
        DESCRIPTION:
            ...
            Note: This function is available only when teradataml is connected to
                  Vantage 1.1 or later versions (Machine Learning Engine 8.10.00.00
                  or later versions).
    ...
    def __validate(self):
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.data1_partition_column, "data1_partition_column", self.data1, "data1", False)
        
        self.__awu._validate_input_columns_not_empty(self.data2_partition_column, "data2_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.data2_partition_column, "data2_partition_column", self.data2, "data2", False)
        
        self.__awu._validate_input_columns_not_empty(self.data3_partition_column, "data3_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.data3_partition_column, "data3_partition_column", self.data3, "data3", False)
