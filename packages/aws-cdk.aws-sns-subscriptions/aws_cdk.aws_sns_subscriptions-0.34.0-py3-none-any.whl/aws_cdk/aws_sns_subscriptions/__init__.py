...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sns-subscriptions", "0.34.0", __name__, "aws-sns-subscriptions@0.34.0.jsii.tgz")
...
class EmailSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.EmailSubscription"):
    ...
    def email_address(self) -> str:
        ...
        Stability:
            experimental
        """
        return jsii.get(self, "emailAddress")

    @property
    @jsii.member(jsii_name="props")
    def props(self) -> "EmailSubscriptionProps":
        """
        Stability:
            experimental
        """
...
class SqsSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.SqsSubscription"):
    ...
    @property
    @jsii.member(jsii_name="props")
    def props(self) -> "SqsSubscriptionProps":
        """
        Stability:
            experimental
        """
...
class UrlSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.UrlSubscription"):
    ...
    @property
    @jsii.member(jsii_name="props")
    def props(self) -> "UrlSubscriptionProps":
        """
        Stability:
            experimental
        """
