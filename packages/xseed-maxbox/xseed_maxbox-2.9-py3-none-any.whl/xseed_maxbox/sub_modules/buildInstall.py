...
def getUserInput(miniCampus, dbusername, dbpassword,buildEnv):
    ...
    os.system('export NODE_ENV=%s' %buildEnv)
    os.system('export MINICAMPUS_CODE=%s' %miniCampus)
    os.system('export MONGO_INITDB_ROOT_USERNAME=%s' %dbusername)
    os.system('export MONGO_INITDB_ROOT_PASSWORD=%s' %dbpassword)
    ...
    try:
        ...
        os.system('unset NODE_ENV')
        os.system('unset MINICAMPUS_CODE')
        os.system('unset MONGO_INITDB_ROOT_USERNAME')
        os.system('unset MONGO_INITDB_ROOT_PASSWORD')
