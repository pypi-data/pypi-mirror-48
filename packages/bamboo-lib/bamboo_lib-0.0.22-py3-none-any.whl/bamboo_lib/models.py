...
class ParallelizedStep(PipelineStep):
    ...
    def parallel_param_list(self, params):
        ...
        :returns: A list of dicts `dict` containing the list of parameters that should be passed to each step.
        These parameters will overwrite any global pipeline parameters with the same name.
        """
    ...
    def run_pipeline(self):
        ...
        while pointer < len(self.execution_plan):
            ...
            if instruction == "standard":
                ...
                prev_result = None
                with ProcessPool(nodes=n) as pool:
