...
class BaseCallback(BaseCallbackImages):
    ...
    def get_data_generator(
            ...
            volume_id=None, cache_directory=None, batch_size=32, use_threads=None, processes=-1, shuffle=True, cache_limit=None, drop_last=False, disable_caching=False):
        ...
        ml_data_generator = MLDataGeneratorFactory(query=query, data_callback=data_callback, volume_id=volume_id,
                                                   ...
                                                   cache_limit=cache_limit, drop_last=drop_last, disable_caching=disable_caching).create()
    ...
    def bind_data_generator(
            ...
            cache_directory=None, batch_size=32, use_threads=None, processes=-1, shuffle=True, cache_limit=None, drop_last=False, disable_caching=False):
