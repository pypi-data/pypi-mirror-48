...
def main(projects, name, repo_specs):
    #environ['BITBUCKET_REST_URL'] = ''
    environ.clear()
    environ['BITBUCKET_USERNAME'] = 'ei4577'
    environ['BITBUCKET_PASSWORD'] = 'Ei20my19'
    print(environ.get('BITBUCKET_USERNAME'))
