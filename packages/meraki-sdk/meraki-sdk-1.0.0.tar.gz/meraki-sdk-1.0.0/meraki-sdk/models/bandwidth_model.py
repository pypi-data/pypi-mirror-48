...
import meraki-sdk.models.bandwidth_limits_model
...
class BandwidthModel(object):
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki-sdk.models.bandwidth_limits_model.BandwidthLimitsModel.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
