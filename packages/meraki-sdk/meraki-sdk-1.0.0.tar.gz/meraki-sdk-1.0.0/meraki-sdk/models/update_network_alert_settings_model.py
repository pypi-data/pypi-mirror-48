...
import meraki-sdk.models.default_destinations_model
import meraki-sdk.models.alert_model
...
class UpdateNetworkAlertSettingsModel(object):
    ...
    def from_dictionary(cls,
        ...
        default_destinations = meraki-sdk.models.default_destinations_model.DefaultDestinationsModel.from_dictionary(dictionary.get('defaultDestinations')) if dictionary.get('defaultDestinations') else None
        alerts = None
        if dictionary.get('alerts') != None:
            alerts = list()
            for structure in dictionary.get('alerts'):
                alerts.append(meraki-sdk.models.alert_model.AlertModel.from_dictionary(structure))
