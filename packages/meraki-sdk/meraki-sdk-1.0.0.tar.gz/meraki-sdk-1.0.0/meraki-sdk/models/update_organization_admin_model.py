...
import meraki-sdk.models.tag_model
import meraki-sdk.models.network_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tags') != None:
            ...
            for structure in dictionary.get('tags'):
                tags.append(meraki-sdk.models.tag_model.TagModel.from_dictionary(structure))
        networks = None
        if dictionary.get('networks') != None:
            networks = list()
            for structure in dictionary.get('networks'):
                networks.append(meraki-sdk.models.network_model.NetworkModel.from_dictionary(structure))
