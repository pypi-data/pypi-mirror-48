...
import meraki-sdk.models.device_fields_model
...
class UpdateNetworkSmDeviceFieldsModel(object):
    ...
    def from_dictionary(cls,
        ...
        device_fields = meraki-sdk.models.device_fields_model.DeviceFieldsModel.from_dictionary(dictionary.get('deviceFields')) if dictionary.get('deviceFields') else None
