...
import meraki-sdk.models.ssids_model
...
class UpdateNetworkClientSplashAuthorizationStatusModel(object):
    ...
    def from_dictionary(cls,
        ...
        ssids = meraki-sdk.models.ssids_model.SsidsModel.from_dictionary(dictionary.get('ssids')) if dictionary.get('ssids') else None
