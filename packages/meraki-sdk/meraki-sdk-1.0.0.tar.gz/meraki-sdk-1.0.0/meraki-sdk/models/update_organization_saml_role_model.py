...
import meraki-sdk.models.tag2_model
import meraki-sdk.models.network2_model

class UpdateOrganizationSamlRoleModel(object):

    """Implementation of the 'updateOrganizationSamlRole' model.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tags') != None:
            ...
            for structure in dictionary.get('tags'):
                tags.append(meraki-sdk.models.tag2_model.Tag2Model.from_dictionary(structure))
        networks = None
        if dictionary.get('networks') != None:
            networks = list()
            for structure in dictionary.get('networks'):
                networks.append(meraki-sdk.models.network2_model.Network2Model.from_dictionary(structure))
