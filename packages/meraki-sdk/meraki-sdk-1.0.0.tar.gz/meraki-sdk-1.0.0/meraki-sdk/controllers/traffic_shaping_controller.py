...
class TrafficShapingController(BaseController):
    ...
    def update_network_traffic_shaping(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_traffic_shaping --
                        UpdateNetworkTrafficShapingModel -- TODO: type
                        description here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_traffic_shaping')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
