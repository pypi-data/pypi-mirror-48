...
class NamedTagScopeController(BaseController):
    ...
    def create_network_sm_target_group(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    create_network_sm_target_group --
                        CreateNetworkSmTargetGroupModel -- TODO: type
                        description here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('create_network_sm_target_group')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
