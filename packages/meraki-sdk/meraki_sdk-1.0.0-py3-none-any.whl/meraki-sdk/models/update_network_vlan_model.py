...
import meraki-sdk.models.reserved_ip_range_model
import meraki-sdk.models.dhcp_option_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('reservedIpRanges') != None:
            ...
            for structure in dictionary.get('reservedIpRanges'):
                reserved_ip_ranges.append(meraki-sdk.models.reserved_ip_range_model.ReservedIpRangeModel.from_dictionary(structure))
        ...
        if dictionary.get('dhcpOptions') != None:
            ...
            for structure in dictionary.get('dhcpOptions'):
                dhcp_options.append(meraki-sdk.models.dhcp_option_model.DhcpOptionModel.from_dictionary(structure))
