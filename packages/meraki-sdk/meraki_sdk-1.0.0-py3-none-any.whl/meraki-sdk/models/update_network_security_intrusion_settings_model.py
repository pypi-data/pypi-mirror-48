...
import meraki-sdk.models.protected_networks_model
...
class UpdateNetworkSecurityIntrusionSettingsModel(object):
    ...
    def from_dictionary(cls,
        ...
        protected_networks = meraki-sdk.models.protected_networks_model.ProtectedNetworksModel.from_dictionary(dictionary.get('protectedNetworks')) if dictionary.get('protectedNetworks') else None
