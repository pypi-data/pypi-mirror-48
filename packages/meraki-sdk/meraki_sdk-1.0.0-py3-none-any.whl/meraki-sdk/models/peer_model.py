...
import meraki-sdk.models.ipsec_policies_model
...
class PeerModel(object):
    ...
    def from_dictionary(cls,
        ...
        ipsec_policies = meraki-sdk.models.ipsec_policies_model.IpsecPoliciesModel.from_dictionary(dictionary.get('ipsecPolicies')) if dictionary.get('ipsecPolicies') else None
