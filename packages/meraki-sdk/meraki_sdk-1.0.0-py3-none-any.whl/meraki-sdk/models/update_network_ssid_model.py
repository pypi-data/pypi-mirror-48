...
import meraki-sdk.models.radius_server_model
import meraki-sdk.models.radius_accounting_server_model
import meraki-sdk.models.ap_tags_and_vlan_id_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('radiusServers') != None:
            ...
            for structure in dictionary.get('radiusServers'):
                radius_servers.append(meraki-sdk.models.radius_server_model.RadiusServerModel.from_dictionary(structure))
        ...
        if dictionary.get('radiusAccountingServers') != None:
            ...
            for structure in dictionary.get('radiusAccountingServers'):
                radius_accounting_servers.append(meraki-sdk.models.radius_accounting_server_model.RadiusAccountingServerModel.from_dictionary(structure))
        ...
        if dictionary.get('apTagsAndVlanIds') != None:
            ...
            for structure in dictionary.get('apTagsAndVlanIds'):
                ap_tags_and_vlan_ids.append(meraki-sdk.models.ap_tags_and_vlan_id_model.ApTagsAndVlanIdModel.from_dictionary(structure))
