...
import meraki-sdk.models.power_exception_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('powerExceptions') != None:
            ...
            for structure in dictionary.get('powerExceptions'):
                power_exceptions.append(meraki-sdk.models.power_exception_model.PowerExceptionModel.from_dictionary(structure))
