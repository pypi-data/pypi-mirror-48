...
import meraki-sdk.models.definition_model
import meraki-sdk.models.per_client_bandwidth_limits_model
...
class Rule8Model(object):
    ...
    def __init__(self,
                 ...
                 dscp_tag_value=None,
                 pcp_tag_value=None):
        """Constructor for the Rule8Model class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('definitions') != None:
            ...
            for structure in dictionary.get('definitions'):
                definitions.append(meraki-sdk.models.definition_model.DefinitionModel.from_dictionary(structure))
        per_client_bandwidth_limits = meraki-sdk.models.per_client_bandwidth_limits_model.PerClientBandwidthLimitsModel.from_dictionary(dictionary.get('perClientBandwidthLimits')) if dictionary.get('perClientBandwidthLimits') else None
