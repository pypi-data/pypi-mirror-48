...
import meraki-sdk.models.hub_model
import meraki-sdk.models.subnet_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('hubs') != None:
            ...
            for structure in dictionary.get('hubs'):
                hubs.append(meraki-sdk.models.hub_model.HubModel.from_dictionary(structure))
        subnets = None
        if dictionary.get('subnets') != None:
            subnets = list()
            for structure in dictionary.get('subnets'):
                subnets.append(meraki-sdk.models.subnet_model.SubnetModel.from_dictionary(structure))
