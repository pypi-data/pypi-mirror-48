...
import meraki-sdk.models.scheduling_model
import meraki-sdk.models.bandwidth_model
import meraki-sdk.models.firewall_and_traffic_shaping_model
import meraki-sdk.models.vlan_tagging_model
import meraki-sdk.models.bonjour_forwarding_model
...
class UpdateNetworkGroupPolicyModel(object):
    ...
    def from_dictionary(cls,
        ...
        scheduling = meraki-sdk.models.scheduling_model.SchedulingModel.from_dictionary(dictionary.get('scheduling')) if dictionary.get('scheduling') else None
        bandwidth = meraki-sdk.models.bandwidth_model.BandwidthModel.from_dictionary(dictionary.get('bandwidth')) if dictionary.get('bandwidth') else None
        firewall_and_traffic_shaping = meraki-sdk.models.firewall_and_traffic_shaping_model.FirewallAndTrafficShapingModel.from_dictionary(dictionary.get('firewallAndTrafficShaping')) if dictionary.get('firewallAndTrafficShaping') else None
        splash_auth_settings = dictionary.get('splashAuthSettings')
        vlan_tagging = meraki-sdk.models.vlan_tagging_model.VlanTaggingModel.from_dictionary(dictionary.get('vlanTagging')) if dictionary.get('vlanTagging') else None
        bonjour_forwarding = meraki-sdk.models.bonjour_forwarding_model.BonjourForwardingModel.from_dictionary(dictionary.get('bonjourForwarding')) if dictionary.get('bonjourForwarding') else None
