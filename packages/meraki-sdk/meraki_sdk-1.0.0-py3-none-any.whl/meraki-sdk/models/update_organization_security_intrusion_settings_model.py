...
import meraki-sdk.models.whitelisted_rule_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('whitelistedRules') != None:
            ...
            for structure in dictionary.get('whitelistedRules'):
                whitelisted_rules.append(meraki-sdk.models.whitelisted_rule_model.WhitelistedRuleModel.from_dictionary(structure))
