...
class SNMPSettingsController(BaseController):
    ...
    def update_organization_snmp(self,
                                 options=dict()):
        """Does a PUT request to /organizations/{organizationId}/snmp.
        ...
        # Prepare query URL
        _url_path = '/organizations/{organizationId}/snmp'
    ...
    def get_organization_snmp(self,
                              organization_id):
        """Does a GET request to /organizations/{organizationId}/snmp.
    ...
    def update_network_snmp_settings(self,
                                     options=dict()):
        """Does a PUT request to /networks/{networkId}/snmpSettings.
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    update_network_snmp_settings --
                        UpdateNetworkSnmpSettingsModel -- TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_snmp_settings')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def get_network_snmp_settings(self,
                                  network_id):
        """Does a GET request to /networks/{networkId}/snmpSettings.
