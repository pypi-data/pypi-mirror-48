...
class IntrusionSettingsController(BaseController):
    ...
    def update_organization_security_intrusion_settings(self,
                                                        options=dict()):
        """Does a PUT request to /organizations/{organizationId}/security/intrusionSettings.
        ...
        self.validate_parameters(organization_id=options.get("organization_id"),
                                 update_organization_security_intrusion_settings=options.get("update_organization_security_intrusion_settings"))
        ...
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_organization_security_intrusion_settings')))
    ...
    def update_network_security_intrusion_settings(self,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('update_network_security_intrusion_settings')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def get_network_security_intrusion_settings(self,
                                                network_id):
        """Does a GET request to /networks/{networkId}/security/intrusionSettings.
