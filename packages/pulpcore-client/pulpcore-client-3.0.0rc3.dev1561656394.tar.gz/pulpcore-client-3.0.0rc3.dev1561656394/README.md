...
- API version: v3
- Package version: 3.0.0rc3.dev01561656394
...
try:
    # Create an artifact
    api_response = api_instance.create(file=file, size=size, md5=md5, sha1=sha1, sha224=sha224, sha256=sha256, sha384=sha384, sha512=sha512, upload=upload)
    pprint(api_response)
...
*UploadsApi* | [**commit_upload**](docs/UploadsApi.md#commit_upload) | **PUT** {upload_href}commit/ | Finish an Upload
*UploadsApi* | [**create_upload**](docs/UploadsApi.md#create_upload) | **POST** /pulp/api/v3/uploads/ | Create an upload
...
*UploadsApi* | [**update_upload**](docs/UploadsApi.md#update_upload) | **PUT** {upload_href} | Upload a file chunk
