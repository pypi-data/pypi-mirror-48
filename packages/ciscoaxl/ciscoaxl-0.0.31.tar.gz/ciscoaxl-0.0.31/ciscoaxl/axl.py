...
class axl(object):
    ...
    def execute_sql_update(self, query):
        ...
        :return: result dictionary
        """
        resp = self.client.executeSQLUpdate(query)
    ...
    def do_ldap_sync(self, uuid):
        ...
        :return: result dictionary
        """
        resp = self.client.doLdapSync(uuid=uuid, sync=True)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def do_change_dnd_status(self, userID, status):
        ...
        :return: result dictionary
        """
        resp = self.client.doChangeDNDStatus(userID=userID, status=status)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def do_device_login(self, device, userId):
        ...
        :return: result dictionary
        """
        resp = self.client.doDeviceLogin(deviceName=device, userId=userId)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def do_device_logout(self, device, userId):
        ...
        :return: result dictionary
        """
        resp = self.client.doDeviceLogout(deviceName=device, userId=userId)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def do_device_reset(self, name='', uuid=''):
        ...
        """
        if name != '' and uuid == '':
            resp = self.client.doDeviceReset(deviceName=name, isHardReset=True)
        elif name == '' and uuid != '':
            resp = self.client.doDeviceReset(uuid=uuid, isHardReset=True)
    ...
    def reset_sip_trunk(self, name='', uuid=''):
        ...
        """
        if name != '' and uuid == '':
            resp = self.client.resetSipTrunk(name=name)
        elif name == '' and uuid != '':
            resp = self.client.resetSipTrunk(uuid=uuid)
    ...
    def delete_location(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeLocation(**args)
    ...
    def get_regions(self, mini=False):
        ...
        resp = self.client.listRegion(
                {'name': '%'}, returnedTags={'_uuid': '', 'name': ''})['return']['region']
        if mini:
    ...
    def update_region(self, name='', uuid='', moh_region=''):
        ...
        if name != '' and uuid == '':
            resp = self.client.updateRegion(name=name,
                                                    relatedRegions={'relatedRegion': region_list})
        elif name == '' and uuid != '':
            resp = self.client.updateRegion(uuid=uuid,
                                                    relatedRegions={'relatedRegion': region_list})            
    ...
    def delete_region(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeRegion(**args)
    ...
    def get_srsts(self, mini=False):
        ...
        resp = self.client.listSrst(
                {'name': '%'}, returnedTags={'_uuid': ''})['return']['srst']
        if mini:
            return [(i['_uuid'][1:-1]) for i in resp]
        else:
            return resp
    ...
    def get_srst(self, srst):
        ...
        :return: result dictionary
        """
        resp = self.client.getSrst(name=srst)
    ...
    def delete_srst(self, srst):
        ...
        :return: result dictionary
        """
        resp = self.client.removeSrst(name=srst)
    ...
    def add_device_pool(self,
        ...
        :return: result dictionary
        """
        resp = self.client.addDevicePool({
            'name': device_pool,
    ...
    def delete_device_pool(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeDevicePool(**args)
    ...
    def get_conference_bridge(self, conference_bridge):
        ...
        :return: result dictionary
        """
        resp = self.client.getConferenceBridge(name=conference_bridge)
    ...
    def add_conference_bridge(self,
        ...
        :return: result dictionary
        """
        resp = self.client.addConferenceBridge({
    ...
    def delete_conference_bridge(self, conference_bridge):
        ...
        :return: result dictionary
        """
        resp = self.client.removeConferenceBridge(name=conference_bridge)
    ...
    def get_transcoder(self, transcoder):
        ...
        :return: result dictionary
        """
        resp = self.client.getTranscoder(name=transcoder)
    ...
    def add_transcoder(self,
        ...
        :return: result dictionary
        """
        resp = self.client.addTranscoder({
            'name': transcoder,
            'description': description,
            'devicePoolName': device_pool,
            'product': product,
    ...
    def delete_transcoder(self, transcoder):
        ...
        :return: result dictionary
        """
        resp = self.client.removeTranscoder(name=transcoder)
    ...
    def get_h323_gateway(self, h323_gateway):
        ...
        :return: result dictionary
        """
        resp = self.client.getH323Gateway(name=h323_gateway)
    ...
    def add_h323_gateway(self,
        ...
        :return:
        """
        resp = self.client.addH323Gateway({
            'name': h323_gateway,
            'description': description,
            'product': product,
            'protocol': protocol,
    ...
    def update_h323_gateway_mrgl(self, h323_gateway, media_resource_group_list):
        ...
        :return:
        """
        resp = self.client.updateH323Gateway(
                name=h323_gateway,
                mediaResourceListName=media_resource_group_list,
        )
    ...
    def delete_h323_gateway(self, h323_gateway):
        ...
        :return: result dictionary
        """
        resp = self.client.removeH323Gateway(name=h323_gateway)
    ...
    def add_route_group(self,
        ...
        resp = self.client.addRouteGroup(req)
    ...
    def delete_route_group(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeRouteGroup(**args)
    ...
    def add_route_list(self,
        ...
        resp = self.client.addRouteList(req)
    ...
    def delete_route_list(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeRouteList(**args)
    ...
    def add_partition(self,
        ...
        :return: result dictionary
        """
        resp = self.client.addRoutePartition({
            'name': name,
            'description': description,
    ...
    def delete_partition(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeRoutePartition(**args)
    ...
    def delete_calling_search_space(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeCss(**args)
    ...
    def get_route_patterns(self, mini=False):
        ...
        resp = self.client.listRoutePattern(
                {'pattern': '%'}, returnedTags={
                    'pattern': '', 'description': '', '_uuid': ''})['return']['routePattern']
        if mini:
    ...
    def get_route_pattern(self, pattern='', uuid=''):
        ...
        # Cant get pattern directly so get UUID first
            uuid = self.client.listRoutePattern({'pattern': pattern}, returnedTags={'_uuid': ''})

            if uuid[0] == 200 and uuid['return'] == '':
                result['response'] = 'Route pattern: {0} not found'.format(pattern)
                result['error'] = 'Route pattern: {0} not found'.format(pattern)
                return result

            else:
                resp = self.client.getRoutePattern(uuid=uuid['return']['routePattern'][0]['_uuid'][1:-1])
                ...
                resp = self.client.getRoutePattern(uuid=uuid)
    ...
    def add_route_pattern(self,
        ...
        resp = self.client.addRoutePattern(req)
    ...
    def get_media_resource_groups(self, mini=False):
        ...
        resp = self.client.listMediaResourceGroup(
                {'name': '%'}, returnedTags={
                    'name': '', 'description': ''})['return']['mediaResourceGroup']
        if mini:
            return [(i['name'], i['description']) for i in resp]
        else:
            return resp
    ...
    def get_media_resource_group(self, media_resource_group):
        ...
        :return: result dictionary
        """
        resp = self.client.getMediaResourceGroup(name=media_resource_group)
    ...
    def add_media_resource_group(self,
        ...
        resp = self.client.addMediaResourceGroup(req)
    ...
    def delete_media_resource_group(self, media_resource_group):
        ...
        :return: result dictionary
        """
        resp = self.client.removeMediaResourceGroup(name=media_resource_group)
    ...
    def get_media_resource_group_list(self, media_resource_group_list):
        ...
        :return: result dictionary
        """
        resp = self.client.getMediaResourceList(name=media_resource_group_list)
    ...
    def add_media_resource_group_list(self, media_resource_group_list, members=[]):
        ...
        resp = self.client.addMediaResourceList(req)
    ...
    def delete_media_resource_group_list(self, media_resource_group_list):
        ...
        :return: result dictionary
        """
        resp = self.client.removeMediaResourceList(name=media_resource_group_list)
    ...
    def get_directory_numbers(self, mini=False):
        ...
        resp = self.client.listLine(
                {'pattern': '%'}, returnedTags={
                    'pattern': '', 'description': '', 'routePartitionName': ''})['return']['line']
        if mini:
    ...
    def delete_directory_number(self, uuid):
        ...
        :return: result dictionary
        """
        resp = self.client.removeLine(uuid=uuid)
    ...
    def get_cti_route_points(self, mini=False):
        ...
        resp = self.client.listCtiRoutePoint(
                {'name': '%'}, returnedTags={
                    'name': '', 'description': ''})['return']['ctiRoutePoint']
        if mini:
            return [(i['name'], i['description']) for i in resp]
        else:
            return resp
    ...
    def add_cti_route_point(self,
        ...
        resp = self.client.addCtiRoutePoint(req)
    ...
    def delete_cti_route_point(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeCtiRoutePoint(**args)
    ...
    def delete_phone(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removePhone(**args)
    ...
    def add_device_profile(self,
        ...
        resp = self.client.addDeviceProfile(req)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def delete_device_profile(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeDeviceProfile(**args)
    ...
    def get_user(self, user_id):
        ...
        :return: result dictionary
        """
        resp = self.client.getUser(userid=user_id)
        result = {
            'success': False,
            'response': '',
            'error': '',
    ...
    def update_user_em(self,
        ...
        if resp[0] == 500 and '{0} was not found'.format(device_profile) in resp[1].faultstring:
            ...
            uuid = resp['return']['deviceProfile']['_uuid'][1:-1]

        resp = self.client.updateUser(
                userid=user_id,
    ...
    def delete_user(self, **args):
        ...
        :return: result dictionary
        """
        resp = self.client.removeUser(**args)
    ...
    def get_translation(self, pattern='', partition='', uuid=''):
        ...
        if pattern != '' and partition != '' and uuid == '':
            resp = self.client.getTransPattern(
                pattern=pattern, 
                routePartitionName=partition,
                returnedTags={
                'pattern': '', 
    ...
    def add_translation(self,
        ...
        :return: result dictionary
        """
        resp = self.client.addTransPattern({
            'pattern': pattern, 
            'description': description,
            'routePartitionName': partition,
            'usage': usage,
    ...
    def delete_translation(self, pattern='', partition='', uuid=''):
        ...
        if pattern != '' and partition != '' and uuid == '':
            resp = self.client.removeTransPattern(pattern=pattern, routePartitionName=partition)
        elif uuid != '' and pattern == '' and partition == '':
            resp = self.client.removeTransPattern(uuid=uuid)
        else: 
            return "must specify either uuid OR pattern and partition"
    ...
    def list_route_plan_specific(self, pattern='', mini=False):
        ...
        if resp[0] == 200 and 'routePlan' in resp['return']:
            result['success'] = True
            result['response'] = resp['return']['routePlan']
            return result
        else:
    ...
    def get_called_party_xforms(self, mini=False):
        ...
        resp = self.client.listCalledPartyTransformationPattern(
                {'pattern': '%'}, returnedTags={
                    'pattern': '', 'description': '', '_uuid': ''})['return']['calledPartyTransformationPattern']
        if mini:
            return [(i['pattern'], i['description'], i['_uuid'][1:-1]) for i in resp]
        else:
            return resp
    ...
    def get_calling_party_xforms(self, mini=False):
        ...
        resp = self.client.listCallingPartyTransformationPattern(
                {'pattern': '%'}, returnedTags={
                    'pattern': '', 'description': '', '_uuid': ''})['return']['callingPartyTransformationPattern']
        if mini:
            return [(i['pattern'], i['description'], i['_uuid'][1:-1]) for i in resp]
        else:
            return resp
    ...
    def add_sip_trunk(self, **kwargs):
        ...
        resp = self.client.addSipTrunk(kwargs)
    ...
    def update_dhcp_subnet(self, **kwargs):
        ...
        resp = self.client.updateDhcpSubnet(**kwargs)
    ...
    def listProcessNodes(self):
        resp = self.client.listProcessNode({'name': '%', 'processNodeRole': 'CUCM Voice/Video'}, returnedTags={'name': ''})
        result = {
            'success': False,
            'response': '',
            'error': '',
