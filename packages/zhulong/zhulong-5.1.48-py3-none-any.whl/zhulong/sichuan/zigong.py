...
def f1(driver, num):
    ...
    for tr in trs:
        ...
        try:
            ...
            title = a.text.strip()
        link = "http://www.zgggzy.cn" + a['href'].strip()
...
def f3(driver, url):
    ...
    if ("您请求的文件不存在" in html) or ("找不到文件" in html):
        return 404
    locator = (By.XPATH, "//div[@id='content'][string-length()>30] | //div[@class='ewb-info-main ewb-mt10 clearfix'][string-length()>30]")
...
if __name__=='__main__':
    ...
    # url = 'http://www.zgggzy.cn/jyfwdt/003002/003002002/about2.html'
    # driver.get(url)
    # df = f2(driver)
    # print(df)
    # driver = webdriver.Chrome()
    # url = 'http://www.zgggzy.cn/jyfwdt/003002/003002001/about2.html'
    # driver.get(url)
    # for i in range(1, 3):
    #     df = f1(driver, i)
    #     print(df.values)
