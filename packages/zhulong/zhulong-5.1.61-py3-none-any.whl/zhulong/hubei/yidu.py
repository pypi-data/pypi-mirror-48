...
def get_data():
    ...
    ggtype1 = OrderedDict([("zhaobiao", "001"),("gqita_bian_cheng", "002"), ("zhongbiaohx", "003"), ("zhongbiao", "004"),("liubiao", "005")])
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "hubei", "yidu"],headless=False,num=2)
