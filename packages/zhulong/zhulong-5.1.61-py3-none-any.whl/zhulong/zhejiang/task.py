...
def task_cixi(**args):
    ...
    cixi.work(conp,pageloadtimeout=60,**args)
#2
def task_dongyang(**args):
    conp=get_conp(dongyang._name_)
    dongyang.work(conp,pageloadtimeout=120,**args)
#3
...
def task_linhai(**args):
    ...
    linhai.work(conp,pageloadtimeout=120,**args)
#8
def task_lishui(**args):
    conp=get_conp(lishui._name_)
    lishui.work(conp,pageloadtimeout=120,**args)
