...
data=[
    ["gcjs_gqita_gg","http://61.143.150.176/jsgc/1.html",["name","ggstart_time","href","info"],f1,f2],

    ["zfcg_gqita_gg","http://61.143.150.176/zfcg/1.html",["name","ggstart_time","href","info"],f1,f2],
    ]
...
if __name__=='__main__':
    work(conp=["postgres","since2015","127.0.0.1","guangdong","heyuan"])
