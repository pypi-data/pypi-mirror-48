...
def f3(driver, url):
    ...
    if iframe:
        ...
        locator = (By.XPATH, '//div[@class="Section1"]')
        WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))
        page2 = driver.page_source
        soup2 = BeautifulSoup(page2, 'html.parser')
        div2 = soup2.find('div', class_='Section1')
...
if __name__ == '__main__':
    # work(conp=["postgres", "since2015", "192.168.3.171", "hubei", "huanggang"])
    driver = webdriver.Chrome()
    # driver.get('http://ggzy.hg.gov.cn/ceinwz/WebInfo_List.aspx?&newsid=700&jsgc=0100000&zbdl=1&FromUrl=jygg')
    # f1(driver,2)
    print(f3(driver, 'http://ggzy.hg.gov.cn/ceinwz/Hyzq/hyzbggzfcgDetail.aspx?sgzbbm=HGJY(2016)G008&zgys=0'))
