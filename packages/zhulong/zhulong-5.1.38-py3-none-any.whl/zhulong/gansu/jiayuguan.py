...
# url="http://www.jygzyjy.cn/f/newtrade/tenderannquainqueryanns/list?selectedProjectType=2"
...
if __name__=="__main__":
    work(conp=["postgres","since2015",'192.168.3.171',"gansu","jiayuguan"],headless=False,num=1,total=3)