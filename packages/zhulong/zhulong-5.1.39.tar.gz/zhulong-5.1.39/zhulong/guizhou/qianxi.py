...
data = [
    ["gcjs_zhaobiao_gg", "http://ggzyjy.qxn.gov.cn/qxnztb/jyxx/018001/018001001/?Paging=1",
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guizhou", "qianxi"], pageloadstrategy='none',num=1,total=2)