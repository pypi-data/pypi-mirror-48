...
# url="""http://ggzy.yzcity.gov.cn/yzweb/infodetail/?infoid=54f9755b-eb92-4f28-a454-cfcec6dce0d5&categoryNum=004001001001"""

# driver.get(url)
#2019-04-26 
#域名变更 http://tlzbcg.tl.gov.cn 变更成 http://tlzbcg.tl.gov.cn 
...
def f1(driver,num):
    ...
    for tr in trs:
        ...
        if 'http' in href:
            ...
            href = 'http://tlzbcg.tl.gov.cn' + href
...
data = [
    #
    ["gcjs_zhaobiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006001001&Paging=1",['name', 'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["gcjs_zhongbiaohx_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006001003&Paging=1", ['name', 'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["gcjs_zhongbiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006001004&Paging=1",  ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["gcjs_liubiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006001006&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    #######补充公告实为变更
    ["gcjs_biangeng_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006001002&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],

    ["gcjs_dingdianchouqian_zhaobiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006002001&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"定点抽签"}),f2],
    ["gcjs_dingdianchouqian_zhongbiao_gg","http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006002004&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"定点抽签"}),f2],
    ["gcjs_dingdianchouqian_biangeng_gg","http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=006002002&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"定点抽签"}),f2],

    ["zfcg_zhaobiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007001001&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],


    ["zfcg_biangeng_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007001002&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["zfcg_zhongbiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007001004&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["zfcg_liubiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007001006&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级"}),f2],
    ["zfcg_zhaobiao_danyilaiyuan_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007004001&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"单一来源"}),f2],
    #
    ["zfcg_feigong_zhaobiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007002001&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"非公开招标"}),f2],
    ["zfcg_feigong_biangeng_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007002002&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"非公开招标"}),f2],
    ["zfcg_feigong_zhongbiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007002004&Paging=1", ['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"非公开招标"}),f2],
    ["zfcg_feigong_liubiao_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/ZtbInfo/zhaobiao.aspx?categorynum=007002006&Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f1,{"diqu":"市级","zbfs":"非公开招标"}),f2],


    ["gcjs_yucai_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/gcjs/006003/?Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f4,{"diqu":"市级"}),f2],
    ["zfcg_yucai_gg", "http://tlzbcg.tl.gov.cn/tlsggzy/zfcg/007003/?Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f4,{"diqu":"市级"}),f2],
    ...
    # ["zfcg_zhaobiao_danyilaiyuan_zyx_gg", "http://zyx.tlzbcg.com/zyxztb/jyxx/008002/008002004/?Paging=1",['name',  'ggstart_time', 'href',"info"],add_info(f5,{"diqu":"枞阳县","zbfs":"单一来源"}),f2],
...
if __name__=='__main__':
    ...
    work(conp=["postgres","since2015","192.168.4.175","anhui","tongling"])
