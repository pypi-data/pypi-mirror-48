...
def work(conp, **args):
    est_meta(conp, data=data, diqu="湖南省", **args)
    est_html(conp, f=f3, **args)


if __name__ == '__main__':
    work(conp=["postgres","since2015","192.168.3.171","hunan","hunan"],pageloadstrategy='none',pageloadtimeout=50)
    ...
    # print(f3(driver, 'http://hnsbenji.hnsggzy.com/jygksz/660617.jhtml'))
