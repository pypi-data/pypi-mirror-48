...
def task_nanping(**args):
    ...
    nanping.work(conp, pageloadtimeout=180, pageLoadStrategy="none", **args)
...
def task_wuyishan(**args):
    ...
    wuyishan.work(conp, pageloadtimeout=180, pageLoadStrategy="none", **args)
...
def task_zhangzhou(**args):
    ...
    zhangzhou.work(conp, pageloadtimeout=180, pageLoadStrategy="none",**args)
