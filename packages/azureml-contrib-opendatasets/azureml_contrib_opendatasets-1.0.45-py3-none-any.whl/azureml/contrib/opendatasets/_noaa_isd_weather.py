...
from ._noaa_isd_weather_blob_info import NoaaIsdWeatherBlobInfo
...
class NoaaIsdWeather(LocationTimePublicData):
    ...
    __blobInfo = NoaaIsdWeatherBlobInfo()
    ...
    def __prepare_cols(self):
        ...
        self.usaf_column_name = 'usaf'
        self.wban_column_name = 'wban'
        self.id = 'ID'
    ...
    def _get_mandatory_columns(self):
        ...
        :rtype: list
        """
        return [self.time_column_name, self.latitude_column_name,
                self.longitude_column_name, self.usaf_column_name,
                self.wban_column_name]
