...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appmesh", "0.38.0", __name__, "aws-appmesh@0.38.0.jsii.tgz")
class CfnMesh(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnMesh"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnMesh.TagRefProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagRefProperty():
        def __init__(self, *, key: str, value: typing.Optional[str]=None):
            """
            :param key: ``CfnMesh.TagRefProperty.Key``.
            :param value: ``CfnMesh.TagRefProperty.Value``.
        ...
        def __repr__(self) -> str:
            return 'TagRefProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class CfnMeshProps():
    def __init__(self, *, mesh_name: str, spec: typing.Optional[typing.Union[typing.Optional["CfnMesh.MeshSpecProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, tags: typing.Optional[typing.List["CfnMesh.TagRefProperty"]]=None):
    ...
    @property
    def tags(self) -> typing.Optional[typing.List["CfnMesh.TagRefProperty"]]:
        """``AWS::AppMesh::Mesh.Tags``.
...
class CfnRoute(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnRoute"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnRoute.TagRefProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagRefProperty():
        def __init__(self, *, key: str, value: typing.Optional[str]=None):
            """
            :param key: ``CfnRoute.TagRefProperty.Key``.
            :param value: ``CfnRoute.TagRefProperty.Value``.
...
class CfnRouteProps():
    def __init__(self, *, mesh_name: str, route_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnRoute.RouteSpecProperty"], virtual_router_name: str, tags: typing.Optional[typing.List["CfnRoute.TagRefProperty"]]=None):
    ...
    @property
    def tags(self) -> typing.Optional[typing.List["CfnRoute.TagRefProperty"]]:
        """``AWS::AppMesh::Route.Tags``.
...
class CfnVirtualNode(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnVirtualNode"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnVirtualNode.ServiceDiscoveryProperty", jsii_struct_bases=[], name_mapping={'dns': 'dns'})
    class ServiceDiscoveryProperty():
        def __init__(self, *, dns: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnVirtualNode.DnsServiceDiscoveryProperty"]]]=None):
            """
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnVirtualNode.TagRefProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagRefProperty():
        def __init__(self, *, key: str, value: typing.Optional[str]=None):
            """
            :param key: ``CfnVirtualNode.TagRefProperty.Key``.
            :param value: ``CfnVirtualNode.TagRefProperty.Value``.
...
class CfnVirtualNodeProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualNode.VirtualNodeSpecProperty"], virtual_node_name: str, tags: typing.Optional[typing.List["CfnVirtualNode.TagRefProperty"]]=None):
    ...
    @property
    def tags(self) -> typing.Optional[typing.List["CfnVirtualNode.TagRefProperty"]]:
        """``AWS::AppMesh::VirtualNode.Tags``.
...
class CfnVirtualRouter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnVirtualRouter"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnVirtualRouter.TagRefProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagRefProperty():
        def __init__(self, *, key: str, value: typing.Optional[str]=None):
            """
            :param key: ``CfnVirtualRouter.TagRefProperty.Key``.
            :param value: ``CfnVirtualRouter.TagRefProperty.Value``.
...
class CfnVirtualRouterProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualRouter.VirtualRouterSpecProperty"], virtual_router_name: str, tags: typing.Optional[typing.List["CfnVirtualRouter.TagRefProperty"]]=None):
    ...
    @property
    def tags(self) -> typing.Optional[typing.List["CfnVirtualRouter.TagRefProperty"]]:
        """``AWS::AppMesh::VirtualRouter.Tags``.
...
class CfnVirtualService(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnVirtualService"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-appmesh.CfnVirtualService.TagRefProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagRefProperty():
        def __init__(self, *, key: str, value: typing.Optional[str]=None):
            """
            :param key: ``CfnVirtualService.TagRefProperty.Key``.
            :param value: ``CfnVirtualService.TagRefProperty.Value``.
...
class CfnVirtualServiceProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualService.VirtualServiceSpecProperty"], virtual_service_name: str, tags: typing.Optional[typing.List["CfnVirtualService.TagRefProperty"]]=None):
    ...
    @property
    def tags(self) -> typing.Optional[typing.List["CfnVirtualService.TagRefProperty"]]:
        """``AWS::AppMesh::VirtualService.Tags``.
