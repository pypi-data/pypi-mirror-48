...
from .views import utviews

urlpatterns = [
    url(r'^test_functional/', utviews.FunctionalTestView.as_view()),
    url(r'^test_mixin/', utviews.FunctionViewWithMixin.as_view()),
    url(r'^test_other/',
        include('django_auto_webassets.tests.sub_urls_for_test')),
    url(r'^test_namespace/',
        include('django_auto_webassets.tests.sub_urls_for_test',
