...
def get_point_value(raster_ref: Union[str, gdal.Dataset], latitude: float, 
    ...
    # TODO: implement convertion of points coordinates
    ...
    print("gt: {0}, rb: {1}".format(type(gt), type(rb)))
