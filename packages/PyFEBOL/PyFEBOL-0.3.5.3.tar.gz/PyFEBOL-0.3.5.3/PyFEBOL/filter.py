...
class ParticleFilter(Filter):
    ...
    def _predictParticles(self):
        self.x_particles += self.dx_particles + np.random.randn(self.nb_particles) * 0.1 # noisy prediction
        self.y_particles += self.dy_particles + np.random.randn(self.nb_particles) * 0.1
