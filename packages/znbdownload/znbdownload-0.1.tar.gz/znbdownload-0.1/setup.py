...
# with io.open(path.join(here, 'znbdownload/__init__.py'), 'rt', encoding='utf8') as f:
#     version = re.search(r'__version__ = \'(.*?)\'', f.read()).group(1)

setup(
    name='znbdownload',
    version=znbdownload.__version__,
    python_requires='>=3',
    install_requires=[
        'Django>=2.0',
        'boto3>=1.9.70,<2',
    ...
    url="https://github.com/alexisbellido/znbdownload",
    classifiers=[
    ...
    packages=find_packages(),
    package_dir={'znbdownload': 'znbdownload'},
