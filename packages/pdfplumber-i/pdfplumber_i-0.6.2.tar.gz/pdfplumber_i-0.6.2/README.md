# Slight Edit of PDFPlumber `v0.5.11`
This version sets backgrounds to white as default and greyscales PDFs to make overlaid colors easier to comprehend.
It ~~also~~ no longer ignores non-alphanumeric character when extracting words (the original PDFPlumber does not do this either).
