...
from tensorflow_estimator.python.estimator.estimator_lib import Head
from tensorflow_estimator.python.estimator.estimator_lib import LatestExporter
from tensorflow_estimator.python.estimator.estimator_lib import LogisticRegressionHead
from tensorflow_estimator.python.estimator.estimator_lib import MultiClassHead
from tensorflow_estimator.python.estimator.estimator_lib import MultiHead
from tensorflow_estimator.python.estimator.estimator_lib import MultiLabelHead
from tensorflow_estimator.python.estimator.estimator_lib import PoissonRegressionHead
from tensorflow_estimator.python.estimator.estimator_lib import RegressionHead
...
if not isinstance(_sys.modules[__name__], _deprecation_wrapper.DeprecationWrapper):
  _sys.modules[__name__] = _deprecation_wrapper.DeprecationWrapper(
      _sys.modules[__name__], "estimator")
