...
from dashboards_app.cms_appconfig import Dashboards_appConfig
...
class AdminTest(Dashboards_appTestsMixin, TransactionTestCase):
    ...
    def test_admin_owner_default(self):
        ...
        admin_inst = admin.site._registry[Dashboard]
