...
from mycorrhiza.analysis import CrossValidate, Supervised
...
def supervised():
	...
	cv.run(n_partitions=args.partitions, n_loci=args.loci, n_estimators=args.estimators, n_cores=args.cores)
