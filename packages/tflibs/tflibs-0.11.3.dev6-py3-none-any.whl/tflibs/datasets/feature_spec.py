...
class FeatureSpec:
    ...
    def feature_proto(self, value_dict):
        ...
        return {k: make_feature(feature_proto_spec, value_dict[k])
                for k, feature_proto_spec in self.feature_proto_specs if k in value_dict}
    ...
    def parse(self, parent_key, record):
        ...
        def make_feature(feature_proto):
            if 'default' in feature_proto:
                ...
                size = array.count(feature_proto['shape'])
        ...
        features = {
            ...
            for k, feature_spec in self.feature_proto_specs
        }
