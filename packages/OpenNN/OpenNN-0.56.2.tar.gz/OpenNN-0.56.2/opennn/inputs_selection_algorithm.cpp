...
Vector<double> InputsSelectionAlgorithm::get_final_losses(const OptimizationAlgorithm::Results& results) const
{
...
string InputsSelectionAlgorithm::write_stopping_condition(const OptimizationAlgorithm::Results& results) const
{
