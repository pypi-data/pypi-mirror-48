...
Vector< Tensor<double> > MultilayerPerceptron::calculate_layers_activations_derivatives(const Matrix<double>& inputs) const
{
    // Control sentence(if debug)
    ...
    Vector< Matrix<double> > layers_combination(layers_number);
    Vector< Matrix<double> > layers_activation(layers_number);
    Vector< Tensor<double> > layers_activation_derivatives(layers_number);
...
MultilayerPerceptron::FirstOrderForwardPropagation MultilayerPerceptron::calculate_first_order_forward_propagation(const Matrix<double>& inputs) const
{
    ...
    first_order_forward_propagation.layers_activation_derivatives[0] = layers[0].calculate_activations_derivatives_matrix(layer_combinations);
    ...
    for(size_t i = 1; i < layers_number; i++)
    {
        ...
        first_order_forward_propagation.layers_activation_derivatives[i] = layers[i].calculate_activations_derivatives_matrix(layer_combinations);
    }
