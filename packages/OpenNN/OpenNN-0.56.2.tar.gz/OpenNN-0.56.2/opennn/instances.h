...
public:  
   ...
   inline void set_batch_size(const size_t& new_batch_size)
   {
   ...
   Vector< Vector<size_t> > get_training_batches() const;
   Vector< Vector<size_t> > get_selection_batches() const;
   Vector< Vector<size_t> > get_testing_batches() const;
