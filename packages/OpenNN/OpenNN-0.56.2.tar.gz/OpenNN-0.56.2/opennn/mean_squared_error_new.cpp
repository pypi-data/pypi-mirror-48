...
check();
    ...
    for(int i = 0; i < static_cast<int>(batches_number); i++)
    {
        ...
        const Vector< Matrix<double> > layers_delta
                = calculate_layers_delta(first_order_forward_propagation.layers_activations, first_order_forward_propagation.layers_activation_derivatives, output_gradient);
        // cout << "Layers Delta" << endl << layers_delta << endl;
...
/*
    ...
    for(int i = 0; i < static_cast<int>(batches_number); i++)
    {
        ...
        Matrix<double> output_gradient = (first_order_forward_propagation.layers_activations[layers_number-1] - targets);
