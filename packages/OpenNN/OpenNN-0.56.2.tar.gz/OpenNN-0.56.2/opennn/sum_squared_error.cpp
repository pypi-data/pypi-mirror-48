...
double SumSquaredError::calculate_training_error_cpu() const
{
#ifdef __OPENNN_DEBUG__
...
double SumSquaredError::calculate_training_error_cuda() const
{
    double training_error = 0.0;
...
double SumSquaredError::calculate_selection_error_cpu() const
{
#ifdef __OPENNN_DEBUG__
...
double SumSquaredError::calculate_selection_error_cuda() const
{
    double selection_error = 0.0;
...
double SumSquaredError::calculate_training_error_cpu(const Vector<double>& parameters) const
{
#ifdef __OPENNN_DEBUG__
...
double SumSquaredError::calculate_training_error_cuda(const Vector<double>& parameters) const
{
    double training_error = 0.0;
#ifdef __OPENNN_CUDA__
    const Vector<size_t> architecture = neural_network_pointer->get_multilayer_perceptron_pointer()->get_architecture();
...
Vector<double> SumSquaredError::calculate_training_error_gradient_cpu() const
{
#ifdef __OPENNN_DEBUG__
...
Vector<double> SumSquaredError::calculate_training_error_gradient_cuda() const
{
