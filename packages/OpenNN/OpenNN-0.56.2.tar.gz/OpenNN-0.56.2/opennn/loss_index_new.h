...
//       }
   ...
   Vector< Matrix<double> > calculate_layers_delta(const Vector< Tensor<double> >&, const Matrix<double>&) const;
   Vector< Matrix<double> > calculate_layers_delta(const Vector<Matrix<double>>&, const Vector< Tensor<double> >&, const Matrix<double>&) const;

   Vector<double> calculate_perceptron_layer_error_gradient(const Matrix<double>&, const Matrix<double>&) const;
   Vector<double> calculate_pooling_layer_error_gradient(const PoolingLayer*, const Matrix<double>&, const Matrix<double>&) const;
   Vector<double> calculate_convolutional_layer_error_gradient(const ConvolutionalLayer*, const Matrix<double>&, const Matrix<double>&) const;
   Vector<double> calculate_layer_error_gradient(const Matrix<double>&, const Matrix<double>&, const Layer*) const;
