...
public:
   ...
   struct CudaLayersParameters
   {
       /// Default constructor.

       CudaLayersParameters(const Vector<size_t> architecture, const Vector<double>& parameters)
       {
       ...
       CudaLayersParameters(const size_t& layers_number)
       {
           biases.set(layers_number);
           synaptic_weights.set(layers_number);
       }

       virtual ~CudaLayersParameters()
       {
       }
   ...
   void set_new(const size_t&, const size_t&, const size_t&);
   ...
   void set_layers_pointer(Vector<Layer*>&);
   ...
   void initialize_parameters_new(const double&);

   void randomize_parameters_uniform();
   void randomize_parameters_uniform_new();
...
//   Matrix<double> calculate_outputs(const Matrix<double>&, const Vector<double>&) const;
   ...
   Matrix<double> calculate_outputs_new(const Matrix<double>&) const;
   Matrix<double> calculate_outputs_new(const Matrix<double>&, const Vector<double>&) const;
   ...
   struct ForwardPropagation
   {
       ...
       void print() const
       {
           ...
           cout << layers_activations_derivatives << endl;
       }
   ...
   ForwardPropagation calculate_first_order_forward_propagation_new(const Matrix<double>&);
