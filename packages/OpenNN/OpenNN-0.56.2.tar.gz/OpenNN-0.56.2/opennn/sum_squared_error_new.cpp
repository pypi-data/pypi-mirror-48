...
check();
    ...
    for(int i = 0; i < static_cast<int>(batches_number); i++)
    {
        ...
        const Matrix<double> outputs = neural_network_pointer -> calculate_outputs(inputs, parameters);
        const double batch_error = outputs.calculate_sum_squared_error(targets);
...
check();
    ...
    for(int i = 0; i < static_cast<int>(batches_number); i++)
    {
        ...
        const NeuralNetwork::FirstOrderForwardPropagation first_order_forward_propagation = neural_network_pointer -> calculate_first_order_forward_propagation(inputs);
        ...
        const Vector<double> batch_gradient = calculate_error_gradient(inputs, first_order_forward_propagation.layers_activations, layers_delta);
...
check();
    ...
    for(int i = 0; i < static_cast<int>(batches_number); i++)
    {
        ...
        const NeuralNetwork::FirstOrderForwardPropagation first_order_forward_propagation
                = neural_network_pointer -> calculate_first_order_forward_propagation(inputs);
...
check();
    ...
    first_order_loss.loss += loss;
    first_order_loss.gradient += gradient*2.0;
