...
Vector< Vector<size_t> > Instances::get_training_batches() const
{
...
Vector< Vector<size_t> > Instances::get_selection_batches() const
{
...
Vector< Vector<size_t> > Instances::get_testing_batches() const
{
