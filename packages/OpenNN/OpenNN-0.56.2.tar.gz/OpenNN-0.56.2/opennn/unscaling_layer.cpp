...
UnscalingLayer::UnscalingLayer(const size_t& new_unscaling_neurons_number) : Layer()
{
...
UnscalingLayer::UnscalingLayer(const Vector< Statistics<double> > & new_statistics) : Layer()
{
    set(new_statistics);
}
...
{
    return get_unscaling_neurons_number();
}
