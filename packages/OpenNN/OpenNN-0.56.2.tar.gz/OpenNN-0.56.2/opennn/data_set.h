...
public:
   ...
   Matrix<float> get_inputs_float(const Vector<size_t>&) const;
   Matrix<float> get_targets_float(const Vector<size_t>&) const;
...
//   Matrix<double> calculate_multiple_logistic_correlations(const Vector<size_t>&) const;
  ...
  struct CudaBatch
  {
      ...
      CudaBatch(DataSet* new_data_set_pointer)
      {
      ...
      void copy_inputs_host(const Matrix<double>&, const Vector<size_t>&, const Vector<size_t>&);
      void copy_targets_host(const Matrix<double>&, const Vector<size_t>&, const Vector<size_t>&);

      void copy(const Matrix<float>&, const Matrix<float>&);
