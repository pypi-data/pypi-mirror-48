...
InputsTrendingLayer::InputsTrendingLayer() : Layer()
{
   set();
}
...
InputsTrendingLayer::InputsTrendingLayer(const size_t& inputs_trending_neurons_number) : Layer()
{
...
InputsTrendingLayer::InputsTrendingLayer(const tinyxml2::XMLDocument& inputs_trending_layer_document) : Layer()
{
...
InputsTrendingLayer::InputsTrendingLayer(const InputsTrendingLayer& other_inputs_trending_layer) : Layer()
{
