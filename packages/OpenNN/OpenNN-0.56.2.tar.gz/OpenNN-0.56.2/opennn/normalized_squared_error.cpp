...
double NormalizedSquaredError::calculate_training_error_cpu() const
{
#ifdef __OPENNN_DEBUG__
...
double NormalizedSquaredError::calculate_selection_error_cpu() const
{
#ifdef __OPENNN_DEBUG__
...
double NormalizedSquaredError::calculate_training_error_cpu(const Vector<double>& parameters) const
{
#ifdef __OPENNN_DEBUG__
...
Vector<double> NormalizedSquaredError::calculate_training_error_gradient_cpu() const
{
#ifdef __OPENNN_DEBUG__
