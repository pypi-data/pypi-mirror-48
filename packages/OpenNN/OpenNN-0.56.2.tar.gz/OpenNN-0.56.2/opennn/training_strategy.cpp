...
OptimizationAlgorithm* TrainingStrategy::get_training_method_pointer() const
{
    if(training_method == GRADIENT_DESCENT && gradient_descent_pointer != nullptr) return gradient_descent_pointer;
    else if(training_method == CONJUGATE_GRADIENT && conjugate_gradient_pointer != nullptr) return conjugate_gradient_pointer;
    else if(training_method == QUASI_NEWTON_METHOD && quasi_Newton_method_pointer != nullptr) return quasi_Newton_method_pointer;
    else if(training_method == LEVENBERG_MARQUARDT_ALGORITHM && Levenberg_Marquardt_algorithm_pointer != nullptr) return Levenberg_Marquardt_algorithm_pointer;
    else if(training_method == STOCHASTIC_GRADIENT_DESCENT && stochastic_gradient_descent_pointer != nullptr) return stochastic_gradient_descent_pointer;
    else if(training_method == ADAPTIVE_MOMENT_ESTIMATION && adaptive_moment_estimation_pointer != nullptr) return adaptive_moment_estimation_pointer;
    else return nullptr;
}
...
//    check_optimization_algorithms();
   ...
   switch(training_method)
   {
      ...
      case STOCHASTIC_GRADIENT_DESCENT:
      {
           ...
           {
               results = stochastic_gradient_descent_pointer->perform_training_cuda();
           }
           else
           {
      ...
      case ADAPTIVE_MOMENT_ESTIMATION:
      {
           ...
           if(stochastic_gradient_descent_pointer->check_cuda())
           {
               results = adaptive_moment_estimation_pointer->perform_training_cuda();
           }
           else
           {
...
/*
void OptimizationAlgorithm::Results::save(const string& file_name) const
{
...
void TrainingStrategy::set_MPI(LossIndex* new_loss_index, const TrainingStrategy* training_strategy)
{
    ...
    if(rank == 0)
    {
        ...
        switch(original_training_method)
        {
            case(int)TrainingStrategy::GRADIENT_DESCENT:
                ...
                reserve_training_loss_history = training_strategy->get_gradient_descent_pointer()->get_reserve_training_error_history();
            ...
            case(int)TrainingStrategy::CONJUGATE_GRADIENT:
                ...
                reserve_training_loss_history = training_strategy->get_conjugate_gradient_pointer()->get_reserve_training_error_history();
            ...
            case(int)TrainingStrategy::QUASI_NEWTON_METHOD:
                ...
                reserve_training_loss_history = training_strategy->get_quasi_Newton_method_pointer()->get_reserve_training_error_history();
            ...
            case(int)TrainingStrategy::LEVENBERG_MARQUARDT_ALGORITHM:
                ...
                reserve_training_loss_history = training_strategy->get_Levenberg_Marquardt_algorithm_pointer()->get_reserve_training_error_history();
           ...
           case(int)TrainingStrategy::STOCHASTIC_GRADIENT_DESCENT:
               ...
               reserve_training_loss_history = training_strategy->get_stochastic_gradient_descent_pointer()->get_reserve_training_error_history();
           ...
           case(int)TrainingStrategy::ADAPTIVE_MOMENT_ESTIMATION:
               ...
               reserve_training_loss_history = training_strategy->get_adaptive_moment_estimation_pointer()->get_reserve_training_error_history();
    ...
    switch(original_training_method)
    {
        case(int)TrainingStrategy::GRADIENT_DESCENT:
            ...
            gradient_descent_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
        ...
        case(int)TrainingStrategy::CONJUGATE_GRADIENT:
            ...
            conjugate_gradient_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
        ...
        case(int)TrainingStrategy::QUASI_NEWTON_METHOD:
            ...
            quasi_Newton_method_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
        ...
        case(int)TrainingStrategy::LEVENBERG_MARQUARDT_ALGORITHM:
            ...
            Levenberg_Marquardt_algorithm_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
       ...
       case(int)TrainingStrategy::STOCHASTIC_GRADIENT_DESCENT:
           ...
           stochastic_gradient_descent_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
       ...
       case(int)TrainingStrategy::ADAPTIVE_MOMENT_ESTIMATION:
           ...
           adaptive_moment_estimation_pointer->get_reserve_training_error_history(reserve_training_loss_history == 1);
