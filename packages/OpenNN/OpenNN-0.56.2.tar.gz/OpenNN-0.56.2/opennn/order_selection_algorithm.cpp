...
Vector<double> OrderSelectionAlgorithm::perform_minimum_model_evaluation(const size_t& order_number)
{
    ...
    final = get_final_losses(results);
...
Vector<double> OrderSelectionAlgorithm::perform_mean_model_evaluation(const size_t& order_number)
{
    ...
    final_parameters.set(neural_network->get_parameters());
    mean_final = get_final_losses(results);
...
Vector<double> OrderSelectionAlgorithm::get_final_losses(const OptimizationAlgorithm::Results& results) const
{
...
string OrderSelectionAlgorithm::write_stopping_condition(const OptimizationAlgorithm::Results& results) const
{
