...
#include "perceptron_layer_new.h"
...
inline Vector<size_t> PerceptronLayer::get_ouput_shape() const
{
    return  Vector<size_t>(1.0, get_perceptrons_number());
}


inline Vector<size_t> PerceptronLayer::get_input_shape() const
{
    return Vector<size_t>(1 , get_inputs_number());
}
...
Matrix<double> PerceptronLayer::parameters_to_synaptic_weights(const Vector<double>& parameters) const
{
...
Vector<double> PerceptronLayer::parameters_to_biases(const Vector<double>& parameters) const
{
