...
def try_convert(x, fun, coerce_errors=True):
# Doctype
    '''
    Tries to apply a function to an object and returns the result.
    Useful to convert data with pandas.apply
    ...
    coerce_errors : bool, default True
        If True, returns None upon error. Else it raises the error. 
        
    **kwargs : keyword arguments, default None
        Additional variables to pass to fun if needed
        
    --------------

    Examples :
    
    >>> convert_if_not_na(343.0, int)
    343    
    '''
