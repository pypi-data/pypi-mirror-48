...
from ervin import BadConfigFormatException, IncompleteArgsException
from ervin import CONFIG_FILEPATH, NEWLINE, TEMP_BLASTN_OUTPUT, TEMP_FASTA_FILE, LTR_LOWER, \
    LTR_UPPER, LTR_OUTFILE, ENV_UPPER
from ervin import ScafRecord
import argparse
import json
import os
