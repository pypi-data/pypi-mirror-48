...
def build_dependency_manager(app_config_dict=None, resolution_config_dict=None, conf_file=None):
    ...
    tool_dependency_dir = app_config_dict.get("tool_dependency_dir", "database/dependencies")
    ...
    if use_tool_dependencies is None:
        use_tool_dependencies = app_config_dict.get("tool_dependency_dir") is not None or \
    ...
    if use_tool_dependencies:
        dependency_manager_kwds = {
            "default_base_path": app_config_dict.get("tool_dependency_dir"),
            "conf_file": conf_file,
