...
class LSDDEM(object):
	...
	"""
	def __init__(self, path = "./", file_name = "test.tif", already_preprocessed = False, verbose = True, prefix_supp = ""):
		"""
		Description:
	...
	def CommonFlowRoutines(self, ingest_precipitation_raster = None, precipitation_raster_multiplier = 1):
		"""
		Description:
		...
		if(ingest_precipitation_raster is not None):
