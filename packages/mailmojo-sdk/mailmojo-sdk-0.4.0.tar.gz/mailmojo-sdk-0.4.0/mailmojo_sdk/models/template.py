...
from mailmojo_sdk.models.template_categories import TemplateCategories  # noqa: F401,E501
...
class Template(object):
    ...
    swagger_types = {
        ...
        'categories': 'list[TemplateCategories]',
        'current_price': 'float',
        'data': 'object',
        'description': 'str',
        'id': 'int',
    ...
    def __init__(self, campaign_expires_at=None, campaign_price=None, categories=None, current_price=None, data=None, description=None, id=None, is_buyable=None, is_editable=None, is_on_sale=None, name=None, preview_url=None, price=None, screenshot_url=None, total_price=None, vat_amount=None):  # noqa: E501
