...
#twine upload dist/pycecream-1.2.1.tar.gz
...
setup(name='pycecream',
      ...
      ,
      long_description= 'bug fix preventing noise model parameters from being turned on and extras control over vertical offset'
