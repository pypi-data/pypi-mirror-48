...
def analysis (project, genome, contexts, simContext, input_path, output_type='all', analysis='all', interdistance='96'):
	...
	if analysis == 'hotspot' or analysis == 'all':
		...
		hotspot.hotSpotAnalysis(project, genome, contexts, simContext, ref_dir, original, signature, percentage, firstRun)
