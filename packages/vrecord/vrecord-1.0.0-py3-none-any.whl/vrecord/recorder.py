...
class recorder_gui:
    def __init__(self):
        ...
        Label(self.root, text=info, font=self.ft).pack()
        Button(self.root, text='生成代码', command=self.create_code).pack()
    ...
    def create_code(self):
        ...
        self.clear_txt()
        print(record_code.replace('$record_data', record_data).replace('$unrecord_key', unrecord_key))
