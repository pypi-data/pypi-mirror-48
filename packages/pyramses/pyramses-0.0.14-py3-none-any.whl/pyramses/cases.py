    ...
    def writeCmdFile(self, userFile=None):
        ...
        try:
            with open(cmdFileName, 'w') as cmdFile:
                ...
                cmdFile.write('\n')
                if self._init:
                    cmdFile.write(self._init[0] + '\n')
                else:
                    cmdFile.write('\n')
                if self._dstset:
                    cmdFile.write(self._dstset[0] + '\n')
                if self._trj:
                    cmdFile.write(self._trj[0] + '\n')
                    cmdFile.write(self._obs[0] + '\n')
                else:
                    cmdFile.write('\n')
                if self._cont:
                    cmdFile.write(self._cont[0] + '\n')
                else:
                    cmdFile.write('\n')
                if self._disc:
                    cmdFile.write(self._disc[0] + '\n')
                else:
                    cmdFile.write('\n')
