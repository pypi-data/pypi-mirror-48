...
from alv3_service.common.classification import InvalidClassification
from alv3_service.common.context import Context
from alv3_service.common.net import is_valid_ip, is_valid_domain, is_valid_email, is_valid_port
from alv3_service.common.str_utils import StringTable, NamedConstants, safe_str
...
class Result(dict):
    ...
    def report_heuristic(self, heur):
        # type: (Heuristic) -> None
        from alv3_service.common.heuristics import Heuristic
