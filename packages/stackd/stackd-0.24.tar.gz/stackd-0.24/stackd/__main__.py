...
main_api = {
  ...
  'infos': lambda args: api_infos(FILES_COMPOSE, FILES_ENV, ENV_VARS, FILES_COMPOSE_SRC, FILES_VARS, VARS_DATA),
...
def main():
  ...
  load_compose(FILES_COMPOSE, ENV_VARS, FILES_COMPOSE_SRC, VARS_DATA)
