...
ENV_VARS['STACKD_BUILD_COMPOSE_FILE_BASE'] = os.environ.get('STACKD_BUILD_COMPOSE_FILE_BASE') or "docker-compose.yml"
ENV_VARS['STACKD_VARS_FILE_BASE'] = os.environ.get('STACKD_VARS_FILE_BASE') or "vars.yml"
...
ENV_VARS['STACKD_BUILD_PARAMETERS'] = os.environ.get('STACKD_BUILD_PARAMETERS') or ""

STACKD_MACHINE_ID = os.environ.get('STACKD_MACHINE_ID')
...
ENV_VARS['STACKD_DEV_TAG'] = os.environ.get('STACKD_DEV_TAG') or "dev-"+STACKD_MACHINE_ID
