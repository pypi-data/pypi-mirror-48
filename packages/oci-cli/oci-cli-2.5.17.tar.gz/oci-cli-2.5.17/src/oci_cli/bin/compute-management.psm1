...
function GetOciSubcommands_compute_management() {
    $ociSubcommands = @{
        'compute-management' = 'instance-configuration instance-pool'
        'compute-management instance-configuration' = 'change-compartment create delete get launch-compute-instance list update'
        'compute-management instance-pool' = 'attach-lb change-compartment create detach-lb get list list-instances reset softreset start stop terminate update'
    }
