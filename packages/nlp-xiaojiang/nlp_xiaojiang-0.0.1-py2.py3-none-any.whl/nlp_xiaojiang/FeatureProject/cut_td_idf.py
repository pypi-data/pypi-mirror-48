...
from nlp_xiaojiang.conf.path_config import chicken_and_gossip_path, td_idf_cut_path, td_idf_cut_pinyin
from nlp_xiaojiang.utils.text_tools import txtWrite, txtRead, get_syboml, strQ2B
