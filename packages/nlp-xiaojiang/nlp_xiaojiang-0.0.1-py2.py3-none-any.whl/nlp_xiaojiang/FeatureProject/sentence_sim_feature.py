...
from nlp_xiaojiang.FeatureProject.distance_vec_TS_SS import TS_SS
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import chebyshev_distance, minkowski_distance, euclidean_distance_standardized
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import clear_sentence, chinese2pinyin, num_of_common_sub_str
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import cosine_distance, manhattan_distance, euclidean_distance, \
    jaccard_similarity_coefficient_distance
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import hamming_distance, edit_levenshtein, ratio_levenshtein, jaro_levenshtein, \
    set_ratio_fuzzywuzzy, sort_ratio_fuzzywuzzy
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import mahalanobis_distance, bray_curtis_distance, pearson_correlation_distance
from nlp_xiaojiang.FeatureProject.distance_text_or_vec import wmd_distance
from nlp_xiaojiang.conf.path_config import word2_vec_path, td_idf_path, td_idf_path_pinyin
