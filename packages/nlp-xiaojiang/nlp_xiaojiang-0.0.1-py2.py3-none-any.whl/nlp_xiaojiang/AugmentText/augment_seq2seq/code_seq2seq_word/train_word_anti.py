...
from nlp_xiaojiang.conf.path_config import model_ckpt_web_anti_word
from nlp_xiaojiang.conf.path_config import train_data_web_emb_anti
from nlp_xiaojiang.conf.path_config import train_data_web_xyw_anti
