...
m1 = lacdkeras_data()
m1.set_csvdata('Test.csv')
m1.show()
m1.split_train_test_data(0.5)

model = lacdkeras_model()
model.set_train_data(m1.x_train,m1.y_train)
model.set_test_data(m1.x_test,m1.y_test)
model.set_epoch(100)
lis = []
lis.append(3)
lis.append(3)
lis.append(3)
model.set_neuron_level(lis)
model.run_model()
te = []
te.append(lis)
model.predict_data(te)
model.show_history()
print('hi')