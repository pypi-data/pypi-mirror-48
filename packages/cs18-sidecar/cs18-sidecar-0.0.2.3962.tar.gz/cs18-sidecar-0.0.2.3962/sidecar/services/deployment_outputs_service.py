...
from sidecar.services.deployment_outputs_converter import DeploymentOutputsConverter, OutputValueToStringConverterFactory
...
class DeploymentOutputsService:
    ...
    def save_application_outputs(self, app_identifier: AppInstanceIdentifier, outputs: str):
        ...
        with self._lock:
            self._app_instance_service.update_app_instance_outputs(app_identifier,
                                                                   deployment_output)
    ...
    def save_service_outputs(self, service_name: str, output_json: {}):
        ...
        self._filter_redundant_deployment_outputs(deployment_output, declared_outputs)
        with self._lock:
            self._service_updater.update_service_outputs(service_name, deployment_output)
