...
class simpleOneType(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('gyear_minincl_value', ['gyear_minincl_st', 'xs:gYear'], 0, 0, {b'name': b'gyear_minincl_value', b'type': b'xs:gYear'}, None),
        MemberSpec_('gyearmonth_minincl_value', ['gyearmonth_minincl_st', 'xs:gYearMonth'], 0, 0, {b'name': b'gyearmonth_minincl_value', b'type': b'xs:gYearMonth'}, None),
