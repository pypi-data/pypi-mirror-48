...
RequestChangePassword = _reflection.GeneratedProtocolMessageType('RequestChangePassword', (_message.Message,), dict(
...
_AUTHENTICATION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=miscellaneous__pb2._RESPONSEVOID,
    serialized_options=_b('\202\323\344\223\002+\"&/v1/grpc/Authentication/ChangePassword:\001*'),
  ),
])
