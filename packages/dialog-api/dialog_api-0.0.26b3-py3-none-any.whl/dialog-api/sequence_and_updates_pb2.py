...
_UPDATESEQUPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updateThreadCreated', full_name='dialog.UpdateSeqUpdate.updateThreadCreated', index=95,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updateThreadLifted', full_name='dialog.UpdateSeqUpdate.updateThreadLifted', index=96,
