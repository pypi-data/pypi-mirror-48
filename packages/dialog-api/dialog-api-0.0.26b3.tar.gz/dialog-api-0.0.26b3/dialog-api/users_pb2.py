...
RequestLoadUserData = _reflection.GeneratedProtocolMessageType('RequestLoadUserData', (_message.Message,), dict(
...
ResponseLoadUserData = _reflection.GeneratedProtocolMessageType('ResponseLoadUserData', (_message.Message,), dict(
...
_USERDATA.fields_by_name['clock']._options = None
...
_USERS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002 \"\033/v1/grpc/Users/LoadUserData:\001*'),
  ),
])
