...
RequestJoinEventBus = _reflection.GeneratedProtocolMessageType('RequestJoinEventBus', (_message.Message,), dict(
...
ResponseJoinEventBus = _reflection.GeneratedProtocolMessageType('ResponseJoinEventBus', (_message.Message,), dict(
...
RequestKeepAliveEventBus = _reflection.GeneratedProtocolMessageType('RequestKeepAliveEventBus', (_message.Message,), dict(
...
RequestPostToEventBus = _reflection.GeneratedProtocolMessageType('RequestPostToEventBus', (_message.Message,), dict(
...
UpdateEventBusDeviceConnected = _reflection.GeneratedProtocolMessageType('UpdateEventBusDeviceConnected', (_message.Message,), dict(
...
UpdateEventBusDeviceDisconnected = _reflection.GeneratedProtocolMessageType('UpdateEventBusDeviceDisconnected', (_message.Message,), dict(
...
UpdateEventBusMessage = _reflection.GeneratedProtocolMessageType('UpdateEventBusMessage', (_message.Message,), dict(
...
UpdateEventBusDisposed = _reflection.GeneratedProtocolMessageType('UpdateEventBusDisposed', (_message.Message,), dict(
