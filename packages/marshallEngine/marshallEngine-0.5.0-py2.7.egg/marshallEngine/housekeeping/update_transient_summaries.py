...
class update_transient_summaries():
    """
    *The worker class for the update_transient_summaries module*
    ...
    **Usage:**
        ...
        .. todo::
            ...
            - create a blog post about what ``update_transient_summaries`` does
    ...
    def __init__(
        ...
        # Run the MySQL Stored Procedure to update all values that can be
