...
if __name__ == '__main__':
    ...
    parametros_locGui = dict(busqueda_local_sin_minimo_global=[100], rango_perturbacion=[4],
                             busqueda_iterada_sin_mejora=[100])

    lista_bloque_parametros_guiada = genera_lista_ejecuciones_heuristicas(parametros_locGui, repeticiones=1)

    inicia_exploracion_heuristica(localIterada, lista_bloque_parametros_guiada, nucleos_cpu=1)
