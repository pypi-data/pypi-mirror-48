...
if __name__ == '__main__':
    ...
    tabuBus = BusquedaArmonica(problema_kilometros, max_iteraciones=1000)

    parametros_busArm = dict(espacio_memoria=[100, 500], max_busqueda_sin_mejoras=[100, 500],
    ...
    inicia_exploracion_heuristica(tabuBus, lista_bloque_parametros_armonica, nucleos_cpu=4)
