...
class CloudLogger:
    ...
    def _guess_log_level(self, line, step_name, given_level=None):
        ...
        log_level_guess = self._get_log_level_by_step_name(step_name)
        return log_level_guess, line

    @staticmethod
    def _get_log_level_by_step_name(step_name):
        return 'INFO' if step_name.endswith('run') or step_name == 'Setup Credentials' else 'DEBUG'
