...
from .utils import get_profile_model, create_local_profile_from_headers
...
def get_apigw_user(request):
    ...
    apigw_consumer_id = request.META.get(DJANGO_SSO_CONSUMER_USERNAME_HEADER, DJANGO_SSO_ANONYMOUS_CONSUMER_USERNAME)
