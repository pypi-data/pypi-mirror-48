...
class PairDoubleDouble(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.PairDoubleDouble_swiginit(self, _VisusDbPy.new_PairDoubleDouble(*args))
    first = property(_VisusDbPy.PairDoubleDouble_first_get, _VisusDbPy.PairDoubleDouble_first_set)
    second = property(_VisusDbPy.PairDoubleDouble_second_get, _VisusDbPy.PairDoubleDouble_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
...
# Register PairDoubleDouble in _VisusDbPy:
_VisusDbPy.PairDoubleDouble_swigregister(PairDoubleDouble)
...
class PairIntDouble(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.PairIntDouble_swiginit(self, _VisusDbPy.new_PairIntDouble(*args))
    first = property(_VisusDbPy.PairIntDouble_first_get, _VisusDbPy.PairIntDouble_first_set)
    second = property(_VisusDbPy.PairIntDouble_second_get, _VisusDbPy.PairIntDouble_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
...
# Register PairIntDouble in _VisusDbPy:
_VisusDbPy.PairIntDouble_swigregister(PairIntDouble)
...
class VectorString(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.VectorString_swiginit(self, _VisusDbPy.new_VectorString(*args))
...
# Register VectorString in _VisusDbPy:
_VisusDbPy.VectorString_swigregister(VectorString)
...
class VectorInt(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.VectorInt_swiginit(self, _VisusDbPy.new_VectorInt(*args))
...
# Register VectorInt in _VisusDbPy:
_VisusDbPy.VectorInt_swigregister(VectorInt)
...
class VectorDouble(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.VectorDouble_swiginit(self, _VisusDbPy.new_VectorDouble(*args))
...
# Register VectorDouble in _VisusDbPy:
_VisusDbPy.VectorDouble_swigregister(VectorDouble)
...
class VectorFloat(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.VectorFloat_swiginit(self, _VisusDbPy.new_VectorFloat(*args))
...
# Register VectorFloat in _VisusDbPy:
_VisusDbPy.VectorFloat_swigregister(VectorFloat)
...
class MapStringString(object):
    ...
    def __init__(self, *args):
        _VisusDbPy.MapStringString_swiginit(self, _VisusDbPy.new_MapStringString(*args))
...
# Register MapStringString in _VisusDbPy:
_VisusDbPy.MapStringString_swigregister(MapStringString)
...
class LogicBox(VisusKernelPy.NdBox):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    nsamples = property(_VisusDbPy.LogicBox_nsamples_get, _VisusDbPy.LogicBox_nsamples_set)
    delta = property(_VisusDbPy.LogicBox_delta_get, _VisusDbPy.LogicBox_delta_set)
    shift = property(_VisusDbPy.LogicBox_shift_get, _VisusDbPy.LogicBox_shift_set)

    def __init__(self, *args):
        _VisusDbPy.LogicBox_swiginit(self, _VisusDbPy.new_LogicBox(*args))
...
# Register LogicBox in _VisusDbPy:
_VisusDbPy.LogicBox_swigregister(LogicBox)
...
class BlockQuery(object):
    ...
    nsamples = property(_VisusDbPy.BlockQuery_nsamples_get, _VisusDbPy.BlockQuery_nsamples_set)
    logic_box = property(_VisusDbPy.BlockQuery_logic_box_get, _VisusDbPy.BlockQuery_logic_box_set)
    ...
    def __init__(self, field_, time_, start_address_, end_address_, aborted_):
        _VisusDbPy.BlockQuery_swiginit(self, _VisusDbPy.new_BlockQuery(field_, time_, start_address_, end_address_, aborted_))
...
class Query(object):
    ...
    nsamples = property(_VisusDbPy.Query_nsamples_get, _VisusDbPy.Query_nsamples_set)
    logic_box = property(_VisusDbPy.Query_logic_box_get, _VisusDbPy.Query_logic_box_set)
    ...
    merge_mode = property(_VisusDbPy.Query_merge_mode_get, _VisusDbPy.Query_merge_mode_set)
    position = property(_VisusDbPy.Query_position_get, _VisusDbPy.Query_position_set)
    viewdep = property(_VisusDbPy.Query_viewdep_get, _VisusDbPy.Query_viewdep_set)
    clipping = property(_VisusDbPy.Query_clipping_get, _VisusDbPy.Query_clipping_set)
    incrementalPublish = property(_VisusDbPy.Query_incrementalPublish_get, _VisusDbPy.Query_incrementalPublish_set)
    start_resolution = property(_VisusDbPy.Query_start_resolution_get, _VisusDbPy.Query_start_resolution_set)
    cur_resolution = property(_VisusDbPy.Query_cur_resolution_get, _VisusDbPy.Query_cur_resolution_set)
    end_resolutions = property(_VisusDbPy.Query_end_resolutions_get, _VisusDbPy.Query_end_resolutions_set)
    max_resolution = property(_VisusDbPy.Query_max_resolution_get, _VisusDbPy.Query_max_resolution_set)
    query_cursor = property(_VisusDbPy.Query_query_cursor_get, _VisusDbPy.Query_query_cursor_set)
    filter = property(_VisusDbPy.Query_filter_get, _VisusDbPy.Query_filter_set)
    aligned_box = property(_VisusDbPy.Query_aligned_box_get, _VisusDbPy.Query_aligned_box_set)
    filter_query = property(_VisusDbPy.Query_filter_query_get, _VisusDbPy.Query_filter_query_set)
    down_queries = property(_VisusDbPy.Query_down_queries_get, _VisusDbPy.Query_down_queries_set)
    point_coordinates = property(_VisusDbPy.Query_point_coordinates_get, _VisusDbPy.Query_point_coordinates_set)

    def __init__(self, dataset, mode):
        _VisusDbPy.Query_swiginit(self, _VisusDbPy.new_Query(dataset, mode))
...
class Dataset(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    url = property(_VisusDbPy.Dataset_url_get, _VisusDbPy.Dataset_url_set)
    dataset_body = property(_VisusDbPy.Dataset_dataset_body_get, _VisusDbPy.Dataset_dataset_body_set)
    bitmask = property(_VisusDbPy.Dataset_bitmask_get, _VisusDbPy.Dataset_bitmask_set)
    default_bitsperblock = property(_VisusDbPy.Dataset_default_bitsperblock_get, _VisusDbPy.Dataset_default_bitsperblock_set)
    box = property(_VisusDbPy.Dataset_box_get, _VisusDbPy.Dataset_box_set)
    timesteps = property(_VisusDbPy.Dataset_timesteps_get, _VisusDbPy.Dataset_timesteps_set)
    default_scene = property(_VisusDbPy.Dataset_default_scene_get, _VisusDbPy.Dataset_default_scene_set)
    config = property(_VisusDbPy.Dataset_config_get, _VisusDbPy.Dataset_config_set)
    ram_access = property(_VisusDbPy.Dataset_ram_access_get, _VisusDbPy.Dataset_ram_access_set)
    kdquery_mode = property(_VisusDbPy.Dataset_kdquery_mode_get, _VisusDbPy.Dataset_kdquery_mode_set)
    fields = property(_VisusDbPy.Dataset_fields_get, _VisusDbPy.Dataset_fields_set)
    find_field = property(_VisusDbPy.Dataset_find_field_get, _VisusDbPy.Dataset_find_field_set)
    bServerMode = property(_VisusDbPy.Dataset_bServerMode_get, _VisusDbPy.Dataset_bServerMode_set)
