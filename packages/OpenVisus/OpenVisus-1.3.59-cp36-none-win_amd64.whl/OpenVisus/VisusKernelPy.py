...
class PointNf(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _VisusKernelPy.PointNf_swiginit(self, _VisusKernelPy.new_PointNf(*args))
...
# Register PointNf in _VisusKernelPy:
_VisusKernelPy.PointNf_swigregister(PointNf)
...
class NdPoint(object):
    ...
    def __init__(self, *args):
        _VisusKernelPy.NdPoint_swiginit(self, _VisusKernelPy.new_NdPoint(*args))
...
# Register NdPoint in _VisusKernelPy:
_VisusKernelPy.NdPoint_swigregister(NdPoint)
...
class Box3i(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    p1 = property(_VisusKernelPy.Box3i_p1_get, _VisusKernelPy.Box3i_p1_set)
    p2 = property(_VisusKernelPy.Box3i_p2_get, _VisusKernelPy.Box3i_p2_set)

    def __init__(self, *args):
        _VisusKernelPy.Box3i_swiginit(self, _VisusKernelPy.new_Box3i(*args))
...
# Register Box3i in _VisusKernelPy:
_VisusKernelPy.Box3i_swigregister(Box3i)
...
class NdBox(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    p1 = property(_VisusKernelPy.NdBox_p1_get, _VisusKernelPy.NdBox_p1_set)
    p2 = property(_VisusKernelPy.NdBox_p2_get, _VisusKernelPy.NdBox_p2_set)

    def __init__(self, *args):
        _VisusKernelPy.NdBox_swiginit(self, _VisusKernelPy.new_NdBox(*args))
...
# Register NdBox in _VisusKernelPy:
_VisusKernelPy.NdBox_swigregister(NdBox)
...
class Matrix3(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    mat = property(_VisusKernelPy.Matrix3_mat_get, _VisusKernelPy.Matrix3_mat_set)

    def __init__(self, *args):
        _VisusKernelPy.Matrix3_swiginit(self, _VisusKernelPy.new_Matrix3(*args))
    ...
    @staticmethod
    def scaleAroundCenter(center, vs):
        return _VisusKernelPy.Matrix3_scaleAroundCenter(center, vs)

# Register Matrix3 in _VisusKernelPy:
_VisusKernelPy.Matrix3_swigregister(Matrix3)
...
class Matrix4(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    mat = property(_VisusKernelPy.Matrix4_mat_get, _VisusKernelPy.Matrix4_mat_set)

    def __init__(self, *args):
        _VisusKernelPy.Matrix4_swiginit(self, _VisusKernelPy.new_Matrix4(*args))
    ...
    @staticmethod
    def nonZeroScale(vs):
        return _VisusKernelPy.Matrix4_nonZeroScale(vs)

    @staticmethod
    def invNonZeroScale(vs):
        return _VisusKernelPy.Matrix4_invNonZeroScale(vs)
    ...
    @staticmethod
    def scaleAroundCenter(center, axis, k):
    ...
    @staticmethod
    def interpolate(alpha, T1, beta, T2):
...
# Register Matrix4 in _VisusKernelPy:
_VisusKernelPy.Matrix4_swigregister(Matrix4)
...
def Matrix4_nonZeroScale(vs):
    return _VisusKernelPy.Matrix4_nonZeroScale(vs)

def Matrix4_invNonZeroScale(vs):
    return _VisusKernelPy.Matrix4_invNonZeroScale(vs)
...
class ArrayUtils(object):
    ...
    @staticmethod
    def createTransformedAlpha(bounds, T, dims, aborted):
