...
@description:none
"""
from bayeslibs.utils.bridge.ibridge import vision_handpose_recog_bridge
...
class ApolloHandPoseRecognizer:
    ...
    @staticmethod
    def open():
        return open_handpose_recognizer()
...
def open_handpose_recognizer():
    ...
    """
    print('开启机器人年龄性别识别功能')
    result = vision_handpose_recog_bridge(req_type=const.TYPE_START)
    return result
...
def close_handpose_recognizer():
    ...
    """
    print('关闭机器人年龄性别功能')
    result = vision_handpose_recog_bridge(req_type=const.TYPE_STOP)
    return result
...
def get_handposes_recognized():
    ...
    result = vision_handpose_recog_bridge(req_type=const.TYPE_QUERY)
    return result
