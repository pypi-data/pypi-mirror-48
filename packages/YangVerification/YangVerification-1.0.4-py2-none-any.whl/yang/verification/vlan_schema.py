...
class yc_VLAN_vlan_schema__VLAN(PybindBase):
  ...
  def _get_arpProxy(self):
    """
    Getter method for arpProxy, mapped from YANG variable /VLAN/arpProxy (common:enable-status)
    """
    return self.__arpProxy
      
  def _set_arpProxy(self, v, load=False):
    """
    Setter method for arpProxy, mapped from YANG variable /VLAN/arpProxy (common:enable-status)
    If this variable is read-only (config: false) in the
