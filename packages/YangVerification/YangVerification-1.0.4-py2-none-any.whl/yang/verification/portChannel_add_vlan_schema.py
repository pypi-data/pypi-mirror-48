...
class yc_permitVlan_portChannel_add_vlan_schema__PORTCHANNEL_VLAN_permitVlan(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module portChannel_add_vlan_schema - based on the path /PORTCHANNEL_VLAN/permitVlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'PORTCHANNEL_VLAN', u'permitVlan']

  def _get_vlan_name__(self):
    """
    Getter method for vlan_name__, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan/vlan_name__ (leafref)
    """
    return self.__vlan_name__
      
  def _set_vlan_name__(self, v, load=False):
    """
    Setter method for vlan_name__, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan/vlan_name__ (leafref)
  ...
  def _get_taggingMode(self):
    """
    Getter method for taggingMode, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan/taggingMode (common:taggingMode)
    """
    return self.__taggingMode
      
  def _set_taggingMode(self, v, load=False):
    """
    Setter method for taggingMode, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan/taggingMode (common:taggingMode)
    If this variable is read-only (config: false) in the
...
class yc_PORTCHANNEL_VLAN_portChannel_add_vlan_schema__PORTCHANNEL_VLAN(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__name__','__permitVlan',)
  ...
  def _get_permitVlan(self):
    """
    Getter method for permitVlan, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan (list)
    """
    return self.__permitVlan
      
  def _set_permitVlan(self, v, load=False):
    """
    Setter method for permitVlan, mapped from YANG variable /PORTCHANNEL_VLAN/permitVlan (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = OrderedDict([('name__', name__), ('permitVlan', permitVlan), ])
