...
elif args.cmd == 'domain_info':
    print(epp.domain_info(user=args.user, password=args.password, **parsed_parameters))

elif args.cmd == 'contact_create':
    print(epp.contact_create(user=args.user, password=args.password, **parsed_parameters))
