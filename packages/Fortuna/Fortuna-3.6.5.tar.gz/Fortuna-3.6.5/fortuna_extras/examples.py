from Fortuna import CumulativeWeightedChoice, RandomValue

description = """
Example: RandomValue inside a CumulativeWeightedChoice behind a lambda, flick and twist.
