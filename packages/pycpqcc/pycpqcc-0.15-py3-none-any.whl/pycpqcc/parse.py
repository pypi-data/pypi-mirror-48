...
def load_icd(version = 9, type = 'diagnosis', out = 'icd'):
    """
    ...
    Parameters:  
    version (int): This function supports ICD-9 and ICD-10
    
    type (str): 'diagnosis'/'procedure'
    ...
    descr_locat, ccs_locat, line_len, csv_name = options[(version, type)]
