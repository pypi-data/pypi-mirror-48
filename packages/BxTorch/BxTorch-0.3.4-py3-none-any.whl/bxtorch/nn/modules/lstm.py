...
class StackedLSTMCell(nn.Module):
    ...
    Note:
    -----
    Using JIT with this class does not work at the moment since ``weak_module``
    does not allow for ModuleList in constants. Issue can be tracked here:
    https://github.com/pytorch/pytorch/issues/21845.
    """
