class LocalAccount(object):
    ...
    def __init__(self, key, account):
        '''
        :param mc_keys.PrivateKey key: to prefill in private key execution
        :param chain3.account.Account account: the key-unaware management API
        '''
    ...
    def encrypt(self, password):
        '''
        Sign a message, as in :meth:`~mc_account.account.Account.encrypt`
    ...
    def signHash(self, message_hash):
        '''
        Sign the hash of a message, as in :meth:`~mc_account.account.Account.signHash`
        but without specifying the private key.
        '''
    ...
    def signTransaction(self, transaction_dict):
        '''
        Sign a transaction, as in :meth:`~mc_account.account.Account.signTransaction`
        but without specifying the private key.
        '''
