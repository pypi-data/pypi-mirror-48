...
from mc_keys.utils.address import (
    public_key_bytes_to_address,
)
from mc_keys.utils.numeric import (
    int_to_byte,
)
from mc_keys.utils.padding import (
    pad32,
)
...
from mc_keys.validation import (
    validate_gte,
    validate_integer,
    validate_lt_secpk1n,
    validate_lte,
...
MYPY = False
if MYPY:
    from mc_keys.backends.base import BaseECCBackend  # noqa: F401
...
class LazyBackend:
    def __init__(self,
        ...
        from mc_keys.backends.base import (  # noqa: F811
            BaseECCBackend,
        )
        ...
        if backend is None:
            ...
            raise ValueError(
                ...
                "subclass of `mc_keys.backends.BaseECCBackend` or a string of "
    ...
    def get_backend(cls, *args, **kwargs):
        from mc_keys.backends import get_backend
...
class Signature(ByteString, LazyBackend):
    ...
    def __bytes__(self) -> bytes:
        ...
        # FIXME: Enable type checking once we have type annotations in mc_utils
