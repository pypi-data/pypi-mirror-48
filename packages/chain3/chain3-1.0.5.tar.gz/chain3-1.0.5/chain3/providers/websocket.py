...
from chain3.providers.base import (
    JSONBaseProvider,
)
...
def get_default_endpoint():
    return os.environ.get('chain3_WS_PROVIDER_URI', 'ws://127.0.0.1:8546')
...
class WebsocketProvider(JSONBaseProvider):
    logger = logging.getLogger("chain3.providers.WebsocketProvider")
    _loop = None
