...
class RequestManager:
    logger = logging.getLogger("chain3.RequestManager")

    def __init__(self, chain3, providers, middlewares=None):
        self.chain3 = chain3
        self.pending_requests = {}

        if middlewares is None:
            middlewares = self.default_middlewares(chain3)
    ...
    @staticmethod
    def default_middlewares(chain3):
        '''
        ...
        return [
            ...
            (name_to_address_middleware(chain3), 'name_to_address'),
    ...
    def _make_request(self, method, params):
        for provider in self.providers:
            request_func = provider.request_func(self.chain3, tuple(self.middleware_stack))
    ...
    def request_blocking(self, method, params):
        ...
        #print('********************  chain3 response:', response)
