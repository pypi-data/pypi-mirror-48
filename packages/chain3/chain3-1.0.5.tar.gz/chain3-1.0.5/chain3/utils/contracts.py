...
from mc_abi import (
    encode_abi as mc_abi_encode_abi,
)
...
def encode_abi(chain3, abi, arguments, data=None):
    ...
    try:
        ...
        encoded_arguments = mc_abi_encode_abi(
            argument_types,
...
def prepare_transaction(
    ...
    # add for subchain
    prepared_transaction['shardingFlag'] = 0
    prepared_transaction['via'] = '0x0000000000000000000000000000000000000000'
...
def encode_transaction_data(
    ...
    return add_0x_prefix(encode_abi(chain3, fn_abi, fn_arguments, fn_selector))
