...
from mc_abi import (
    is_encodable as mc_abi_is_encodable,
)
from mc_abi.abi import (
    collapse_type,
    process_type,
)
...
def is_encodable(_type, value):
    ...
    if arrlist:
        ...
        # chain3.py will resolve the name to an address before encoding it
        return True
        ...
        if is_hex(value) and len(value) % 2 == 0:
            ...
            return mc_abi_is_encodable(_type, bytes_val)
        else:
            return False
        ...
        try:
            ...
            return mc_abi_is_encodable(_type, string_val)
    else:
        return mc_abi_is_encodable(_type, value)
