...
from chain3.utils.toolz.curried import (
    keymap,
    valmap,
)
...
TRANSACTION_FORMATTERS = {
    ...
    'shardingFlag': to_integer_if_hex,   # add for subchain
    'via': apply_formatter_if(is_address, to_checksum_address),   # add for subchain
}
...
pythonic_middleware = construct_formatting_middleware(
    request_formatters={
        # mc
        'mc_getBalance': apply_formatter_at_index(block_number_formatter, 1),
        'mc_getBlockByNumber': apply_formatter_at_index(block_number_formatter, 0),
        'mc_getBlockTransactionCountByNumber': apply_formatter_at_index(
            block_number_formatter,
            0,
        ),
        'mc_getCode': apply_formatter_at_index(block_number_formatter, 1),
        'mc_getStorageAt': apply_formatter_at_index(block_number_formatter, 2),
        'mc_getTransactionByBlockNumberAndIndex': compose(
            apply_formatter_at_index(block_number_formatter, 0),
            apply_formatter_at_index(integer_to_hex, 1),
        ),
        'mc_getTransactionCount': apply_formatter_at_index(block_number_formatter, 1),
        'mc_getUncleCountByBlockNumber': apply_formatter_at_index(block_number_formatter, 0),
        'mc_getUncleByBlockNumberAndIndex': compose(
            apply_formatter_at_index(block_number_formatter, 0),
            apply_formatter_at_index(integer_to_hex, 1),
        ),
        'mc_getUncleByBlockHashAndIndex': apply_formatter_at_index(integer_to_hex, 1),
        'mc_newFilter': apply_formatter_at_index(filter_params_formatter, 0),
        'mc_getLogs': apply_formatter_at_index(filter_params_formatter, 0),
        'mc_call': combine_argument_formatters(
            transaction_param_formatter,
            block_number_formatter,
        ),
        'mc_estimateGas': apply_formatter_at_index(transaction_param_formatter, 0),
        'mc_sendTransaction': apply_formatter_at_index(transaction_param_formatter, 0),
        # personal
    ...
    result_formatters={
        # mc
        'mc_accounts': apply_formatter_to_array(to_checksum_address),
        'mc_blockNumber': to_integer_if_hex,
        'mc_coinbase': to_checksum_address,
        'mc_estimateGas': to_integer_if_hex,
        'mc_gasPrice': to_integer_if_hex,
        'mc_getBalance': to_integer_if_hex,
        'mc_getBlockByHash': apply_formatter_if(is_not_null, block_formatter),
        'mc_getBlockByNumber': apply_formatter_if(is_not_null, block_formatter),
        'mc_getBlockTransactionCountByHash': to_integer_if_hex,
        'mc_getBlockTransactionCountByNumber': to_integer_if_hex,
        'mc_getCode': HexBytes,
        'mc_getFilterChanges': filter_result_formatter,
        'mc_getFilterLogs': filter_result_formatter,
        'mc_getLogs': filter_result_formatter,
        'mc_getStorageAt': HexBytes,
        'mc_getTransactionByBlockHashAndIndex': apply_formatter_if(
            is_not_null,
            transaction_formatter,
        ),
        'mc_getTransactionByBlockNumberAndIndex': apply_formatter_if(
            is_not_null,
            transaction_formatter,
        ),
        'mc_getTransactionByHash': apply_formatter_if(is_not_null, transaction_formatter),
        'mc_getTransactionCount': to_integer_if_hex,
        'mc_getTransactionReceipt': apply_formatter_if(
            is_not_null,
            receipt_formatter,
        ),
        'mc_getUncleCountByBlockHash': to_integer_if_hex,
        'mc_getUncleCountByBlockNumber': to_integer_if_hex,
        'mc_hashrate': to_integer_if_hex,
        'mc_protocolVersion': compose(
            apply_formatter_if(is_integer, str),
            to_integer_if_hex,
        ),
        'mc_sendRawTransaction': to_hexbytes(32),
        'mc_sendTransaction': to_hexbytes(32),
        'mc_sign': HexBytes,
        'mc_syncing': apply_formatter_if(is_not_false, syncing_formatter),
        # personal
