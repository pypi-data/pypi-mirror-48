...
def construct_formatting_middleware(
    ...
    def ignore_chain3_in_standard_formatters(w3):
        return dict(
    ...
    return construct_chain3_formatting_middleware(ignore_chain3_in_standard_formatters)


def construct_chain3_formatting_middleware(chain3_formatters_builder):
