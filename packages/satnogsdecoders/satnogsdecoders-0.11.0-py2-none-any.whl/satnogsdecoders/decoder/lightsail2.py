...
class Lightsail2(KaitaiStruct):
    ...
    class UdpPayload(KaitaiStruct):
        ...
        def _read(self):
            self.lsb_beacondata = self._root.LsbBeacondataT(self._io, self, self._root)
    ...
    class CamerainfoT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.pics_remaining = self._io.read_bits_int(6)
            self.retry_fails = self._io.read_bits_int(2)
    ...
    class LsbBeacondataT(KaitaiStruct):
        ...
        def _read(self):
            self.sys = self._root.LsbSysmgrdataT(self._io, self, self._root)
            self.comm = self._root.LsbCommdataT(self._io, self, self._root)
            self.bat0 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat1 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat2 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat3 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat4 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat5 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat6 = self._root.LsbBatterydataT(self._io, self, self._root)
            self.bat7 = self._root.LsbBatterydataT(self._io, self, self._root)
            ...
            self.gyro_pxy = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.gyro_piz = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.gyro_ixy = self._root.Packedsigned2x12T(self._io, self, self._root)
            ...
            self.mag_nxxy = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.mag_npxz = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.mag_pxxy = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.mag_npyz = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.mag_pyxy = self._root.Packedsigned2x12T(self._io, self, self._root)
            self.wheel_rpm = self._io.read_s2be()
            self.cam0 = self._root.CamerainfoT(self._io, self, self._root)
            self.cam1 = self._root.CamerainfoT(self._io, self, self._root)
    ...
    class UdpDtgrm(KaitaiStruct):
        ...
        def _read(self):
            ...
            io = KaitaiStream(BytesIO(self._raw_body))
            self.body = self._root.UdpPayload(io, self, self._root)
