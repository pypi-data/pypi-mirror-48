...
def data_generator(
    ...
    while True:
        try:
            ...
            # augmentation
            if dataset.image_info[image_id]['source'] \
                    in no_augmentation_sources:
...
class MaskRCNN:
    ...
    def build(self, mode, config):
        ...
        P4 = KL.Add(name="fpn_p4add")([
            ...
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c4p4')(
                C4)])
