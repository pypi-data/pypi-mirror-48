...
from ....lib.config_lib import DeepblockLogConfig, MaskRCNNConfig
from ....lib.custom_callback import DeepBlockCallback
from ....lib.general_lib import divide_train_val_dataset, get_data_path_type
# Import Mask RCNN
from ....lib.mask_rcnn import model as model_lib, utils, visualize
...
class ImageDataset(utils.Dataset):
    ...
    def load_class(self, dataset, annotation_path):
        ...
        for class_name in class_list:
            self.add_class("source", class_num, class_name)
            class_num += 1
        ...
        for a in sorted(coco_json['annotations'],
            ...
            if image_id == a['imageId']:
                ...
                if file_num != 0:
                    filename = images[file_num - 1]['fileName']
