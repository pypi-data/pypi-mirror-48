...
setup(name='damegender',
      ...
      package_data={'damegender': ['*'],
                    ...
                    'damegender.root': ['*']},
      data_files=[('damegender', ['src/damegender/config.cfg', 'src/damegender/testsbycommands.sh', 'src/damegender/testsbycommandsextra.sh', files_one_level_drop_pwd(cwd+'src/damegender/files/') + files_one_level_drop_pwd(cwd+"/src/damegender/files/images") + files_one_level_drop_pwd(cwd+"/src/damegender/files/datamodels") + files_one_level_drop_pwd(cwd+"/src/damegender/files/mbox") + files_one_level_drop_pwd(cwd+"/src/damegender/files/names") + files_one_level_drop_pwd(cwd+"/src/damegender/files/names_es")])],
      install_requires=[
          'markdown',
          'nltk',
          'requests',
