...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appstream", "0.38.0", __name__, "aws-appstream@0.38.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-appstream.CfnFleetProps", jsii_struct_bases=[], name_mapping={'compute_capacity': 'computeCapacity', 'instance_type': 'instanceType', 'description': 'description', 'disconnect_timeout_in_seconds': 'disconnectTimeoutInSeconds', 'display_name': 'displayName', 'domain_join_info': 'domainJoinInfo', 'enable_default_internet_access': 'enableDefaultInternetAccess', 'fleet_type': 'fleetType', 'image_arn': 'imageArn', 'image_name': 'imageName', 'max_user_duration_in_seconds': 'maxUserDurationInSeconds', 'name': 'name', 'tags': 'tags', 'vpc_config': 'vpcConfig'})
class CfnFleetProps():
