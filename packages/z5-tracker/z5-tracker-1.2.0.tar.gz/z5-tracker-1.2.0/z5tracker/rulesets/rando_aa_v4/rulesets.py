...
class Ruleset(object):
    ...
    def location_available(
        ...
        if name == 'Diving Minigame':
            print('Ocarina: ', self.state.can_play('Zeldas Lullaby'))
            print('Scale: ', self.state.can_dive())
            print('Cheat: ', 'logic_zora_with_hovers' in self.world.__dict__)
            print('Yes: ', available)
        if name == 'Horseback Archery 1500 Points':
            print('Disabled: ', listing[name].disabled, listing[name].locked)
