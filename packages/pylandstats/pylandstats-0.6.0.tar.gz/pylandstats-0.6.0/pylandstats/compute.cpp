...
namespace __pythran_pylandstats_compute
{
  ...
  typename compute_adjacency_arr::type<argument_type0, argument_type1>::result_type compute_adjacency_arr::operator()(argument_type0&& padded_arr, argument_type1&& num_classes) const
  {
    ...
    typename pythonic::lazy<decltype(typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype(1L)>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype(-1L)>::type>::type>::type>::type>>::type({1L, -1L}))>::type horizontal_neighbours = typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype(1L)>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype(-1L)>::type>::type>::type>::type>>::type({1L, -1L});
    typename pythonic::lazy<__type40>::type vertical_neighbours = typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype((-num_cols_pixel))>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype(num_cols_pixel)>::type>::type>::type>::type>>::type({num_cols_pixel, (-num_cols_pixel)});
    ;
...
typename __pythran_pylandstats_compute::compute_adjacency_arr::type<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>, long>::result_type compute_adjacency_arr0(pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>&& padded_arr, long&& num_classes) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran_pylandstats_compute::compute_adjacency_arr()(padded_arr, num_classes);
...
typename __pythran_pylandstats_compute::compute_adjacency_arr::type<pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>, long>::result_type compute_adjacency_arr1(pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>&& padded_arr, long&& num_classes) 
{
...
__pythran_wrap_compute_adjacency_arr0(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>(args_obj[0]) && is_convertible<long>(args_obj[1]))
        return to_python(compute_adjacency_arr0(from_python<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>(args_obj[0]), from_python<long>(args_obj[1])));
    else {
        return nullptr;
    }
}
...
__pythran_wrap_compute_adjacency_arr1(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>>(args_obj[0]) && is_convertible<long>(args_obj[1]))
        return to_python(compute_adjacency_arr1(from_python<pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>>(args_obj[0]), from_python<long>(args_obj[1])));
    else {
        return nullptr;
    }
}
...
#endif
PyMODINIT_FUNC
PYTHRAN_MODULE_INIT(pylandstats_compute)(void)
#ifndef _WIN32
...
PYTHRAN_MODULE_INIT(pylandstats_compute)(void) {
    ...
    #else
    PyObject* theModule = Py_InitModule3("pylandstats_compute",
                                         Methods,
                                         ""
    );
    #endif
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.9.2",
                                      "2019-07-01 23:43:26.634124",
                                      "c73dc7fa8455bc63e2c57626f41c227abe59d7b96a9f2f49526d98916e66c828");
    if(! theDoc)
        PYTHRAN_RETURN;
