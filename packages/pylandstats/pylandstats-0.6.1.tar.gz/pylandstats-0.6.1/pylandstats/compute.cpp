...
typename __pythran_compute::compute_adjacency_arr::type<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>, long>::result_type compute_adjacency_arr0(pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>&& padded_arr, long&& num_classes) 
{
...
typename __pythran_compute::compute_adjacency_arr::type<pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>, long>::result_type compute_adjacency_arr1(pythonic::types::numpy_texpr<pythonic::types::ndarray<uint32_t,pythonic::types::pshape<long,long>>>&& padded_arr, long&& num_classes) 
{
