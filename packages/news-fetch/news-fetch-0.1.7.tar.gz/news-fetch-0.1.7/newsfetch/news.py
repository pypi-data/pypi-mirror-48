    ...
    def __init__(self, url):
        try:
            ...
            try:
                try:
                    try:
                        if cleaning_url(self.url[len('https://'+str(newsplease.source_domain)):]).split(' ')[0] != None:
                            self.section = cleaning_url(self.url[len('https://'+str(newsplease.source_domain)):]).split(' ')[0]
                        elif article.canonical_link.split('/')[3] != None:
