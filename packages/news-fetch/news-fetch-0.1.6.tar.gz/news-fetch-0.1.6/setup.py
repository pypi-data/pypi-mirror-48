...
'news-archive', 'news-articles', 'commoncrawl', 'extract-articles', 'extract-information', 'news-scraper']
...
setuptools.setup(
    ...
    description="A Python Package which helps to scrape news related details",
    long_description=open('README.md').read(),
    long_description_content_type="text/markdown",
    url="https://santhoshse7en.github.io/news-fetch/",
    keywords = keywords,
    install_requires=['beautifulsoup4', 'pandas', 'selenium', 'news-please', 'newspaper3k', 'fake_useragent', 'chromedriver-binary==74.0.3729.6.0'],
