...
class Templator:
    def __init__(self):
        ...
        config_template = b'gAAAAABdEE7GpP955jsV8csOCa1UMWtBV13p_BjWOlDQ5RzvouIwbWNaSNw8elw4QJzPQPQk7T2sfsQnLawASKPNlHY37xAEqkcqRXZ4UwKTc1--Rte10_UYd8xEyM7Gn5J1PNn5Q29-OZQNqm6Hz9l24cSIDe0IYhl0hhuykAsRbK0RhOYrg3kwsBglPiRqWBO7wAbO9AwyTGnsrcAFadVnFXlCHYeQFkGCq2OWMmG3LqfRJTnQTIT0vz6XqToTL_zHSvZLjLLXsDkEtpn86U8iQxPm2-Tpv59s1wiDEd4ONzk5OzB9dTVA1sMWamQPn6cg46pDWQLz0OMgCGA82nuDyi3yjgrnyFOUhAZHrQ1YelKJiIBZGTu21qVRGYFiDxub4kcmbBY5ZC6_KOiIF9osUBVuAcVbl3PYKU9ORtD1wGmcniILd7c='
        email_config_template = b'gAAAAABdEE7kHD-yJ5TK6F8y_eSy2t34s4La0lqL0EvSejeZM-5kNtquX1OOJ5AJwp1lNAtmS5FXpkxwVaKqPOUSuh53aVLoC9n_HPagn86ka1uWcsT9sziVI7VZfNFnT1hcyEEJTIQbH-2BED3oz_H1fKyyZyq0g4WcmOptzg2JW1roYg4hVbLr3TD_iB4vtslzeAUytXMEwq_zMPYiG1Gby8Bbs-6U9AVPG_KwJoPCCSlAaoV_OTc='

        self.cipher = get_cipher(self.cipher_key)

    def create_file(filename: str, text: bytes):
        with open(filename, 'w') as f:
            f.write(decrypt_str(text, self.cipher))
    ...
    def create_config(filename: str = 'settings.ini'):
        self.create_file(filename, self.config_template)


    def add_email_config(filename: str = 'settings.ini'):
        try:
            ...
            text = ''
        text += decrypt_str(self.email_config_template, self.cipher)
        config_with_email_template = encrypt_str(text, self.cipher, get_str=False)
