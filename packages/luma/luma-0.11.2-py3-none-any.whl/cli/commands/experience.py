...
@click.option('--device', prompt=True, type=click.Choice(['mobile', 'tablet', 'web']), default='mobile', help='The preview device the experience is displayed on in the studio.')
...
@click.option('--device', '-d', prompt=True, type=click.Choice(['mobile', 'tablet', 'web']), default='mobile', help='The preview device the experience is displayed on in the studio."')
