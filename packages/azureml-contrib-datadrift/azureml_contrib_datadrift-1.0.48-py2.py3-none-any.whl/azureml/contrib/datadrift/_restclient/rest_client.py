...
class RestClient(object):
    ...
    def get_data_profiles(
            self, subscription_id, resource_group_name, workspace_name, service_name=None, model_name=None, model_version=None, start_date_string=None, end_date_string=None, custom_headers=None, raw=False, **operation_config):
        """GetDataProfiles.
