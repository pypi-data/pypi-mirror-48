# import_roadmaps.py - Reads a comma-separated list of Roadmap and adds them
import csv
import logging
import os
import sys
...
def import_csv():
    opts = get_opts('import_roadmap', 'Adds list of Roadmap to a roadmap_items',
                    {'f': 'filename'})
