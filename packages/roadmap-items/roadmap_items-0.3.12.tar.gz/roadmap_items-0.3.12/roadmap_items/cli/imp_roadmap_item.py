# import_roadmap_items.py - Reads a comma-separated list of RoadmapItem and adds them
import csv
import logging
import os
import sys
...
def import_csv():
    opts = get_opts('import_roadmap_item', 'Adds list of RoadmapItem to a roadmap_items',
                    {'f': 'filename'})
