...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3234214.svg)](https://doi.org/10.5281/zenodo.3234214)
...
```
Samapriya Roy. (2019, May 29). samapriya/porder: porder: Simple CLI for Planet ordersV2 API (Version 0.3.4). Zenodo.
http://doi.org/10.5281/zenodo.3234214
```
