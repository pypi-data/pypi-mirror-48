...
def f3(driver, url):
    ...
    if "无法获取查询数据，请重试。" in driver.page_source:
        return "无法获取查询数据，请重试。"
    locator = (By.XPATH, '//body[@dir="LTR"][string-length()>50]|/html/body/div[@class="container"][string-length()>50]')
...
def main():
    ...
    f3(driver,'http://epp.ctg.com.cn/infoview/?fileId=e98164ee59bd4950ad33a9127a845f73&openFor=ZBJG&typeFor=undefined')
    ...
    # print(1111111)
    # print(f3(driver, 'http://epp.ctg.com.cn/infoview/?fileId=e65828f91e86483080351aebdb186c44&openFor=CQBG'))
    # driver.close()
