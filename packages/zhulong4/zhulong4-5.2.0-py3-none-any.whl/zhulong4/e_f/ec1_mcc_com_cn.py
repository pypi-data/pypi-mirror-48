...
import pandas as pd
from zhulong4.util.etl import est_html, est_meta, est_meta_large
import time

_name_ = 'ec1_mcc_com_cn'
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="中国五矿集团有限公司采购电子商务平台", **args)
...
def main():
    ...
    # driver.get("http://ec1.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showMoreCgxx&xxposition=cgxx")
    # f1(driver, 2)
    # f1(driver, 3)
    # f1(driver, 8)
    # print(f2(driver))
    ...
    # print(f2(driver))
    # driver = webdriver.Chrome()
    # print(f3(driver, 'http://ec1.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showZgysDetail&zgyswjbm=470077CB7E6492C81023AF0D5BC3909F'))
    # print(1111111)
    # print(f3(driver, 'http://ec1.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showCgxjDetail&xjbm=B57060DD39FC4A1FB268D8B6D23E57EB'))
    # print(2222222222222)
    # print(f3(driver, 'http://ec1.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showZhongbggDetail&xxbh=B57060DD39FC4A1FB4160E703A1628A4&inviteid=undefined'))
    # print(1111111)
    # print(f3(driver, 'http://ec1.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showCqggDetail&xxbh=5059760340EF86D5503C827797CBEB8F'))
    # driver.close()
