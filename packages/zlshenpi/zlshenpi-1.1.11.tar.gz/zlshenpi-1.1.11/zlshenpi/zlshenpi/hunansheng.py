...
def f1(driver, num):
    ...
    for content in contents:
        ...
        info = json.dumps({"piwenhao": piwenhao, 'bumen': bumen, "xm_code": xm_code}, ensure_ascii=False)
...
def f2(driver):
    ...
    total_page = int(WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator)).get_attribute('paged'))
    driver.quit()
    return total_page
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlshenpi", "hunansheng"], interval_page=1000,num=30)
    ...
    # print(f3(driver, 'http://www.hntzxm.gov.cn/portal/zcfg/attach.action?id=2c94f1a96b455339016b4579593606fb'))
