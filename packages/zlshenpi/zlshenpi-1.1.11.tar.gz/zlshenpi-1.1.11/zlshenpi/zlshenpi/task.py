...
def task_henansheng(**args):
    ...
    henansheng.work(conp,cdc_total=10,**args)
# 5
...
def task_hubeisheng(**args):
    ...
    hubeisheng.work(conp,cdc_total=10,pageloadtimeout=180,**args)

# 14
def task_hunansheng(**args):
    conp = get_conp(hunansheng._name_)
    hunansheng.work(conp,cdc_total=10,**args)
...
def task_gansusheng(**args):
    ...
    gansusheng.work(conp,cdc_total=10,**args)
#2
def task_ningxiasheng(**args):
    conp=get_conp(ningxiasheng._name_)
    ningxiasheng.work(conp,cdc_total=10,**args)
#3
def task_qinghaisheng(**args):
    conp=get_conp(qinghaisheng._name_)
    qinghaisheng.work(conp,cdc_total=10,**args)
#4
...
def task_xiamenshi(**args):
    ...
    xiamenshi.work(conp,cdc_total=10,**args)
#6
def task_xinjiangsheng(**args):
    conp=get_conp(xinjiangsheng._name_)
    xinjiangsheng.work(conp,cdc_total=10,**args)
#6
...
def create_schemas():
    ...
    arr = ["guangdongsheng",'fujiansheng','jiangxisheng','henansheng','hubeisheng','hunansheng','sichuansheng',
