...
|Requirements| |CircleCI| |Vulnerabilities|
|docker-simonsdave/xenial-dev-env|
...
-  `shell and python
   scripts <https://github.com/simonsdave/dev-env/tree/release-0.5.20/bin>`__
...
-  `here's <https://github.com/simonsdave/dev-env/tree/release-0.5.20/docs/using.md>`__
...
-  if you'd like to help contribute to ``dev-env`` see
   `this <https://github.com/simonsdave/dev-env/tree/release-0.5.20/docs/contributing.md>`__
...
.. |Vulnerabilities| image:: https://snyk.io/test/github/simonsdave/dev-env/badge.svg
   :target: https://snyk.io/test/github/simonsdave/dev-env
