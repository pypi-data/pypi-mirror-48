...
class Selenium_yes24(object):
	...
	def login(self, userid, userpw):
		self.userid = userid
		URL = 'http://ticket.yes24.com/Pages/Login/LoginEnt.aspx?ReturnURL=http://ticket.yes24.com/Home/Perf/PerfDetailInfo.aspx&&ReturnParams=IdPerf={}'.format(self.idperf)
		self.driver.get(URL);
