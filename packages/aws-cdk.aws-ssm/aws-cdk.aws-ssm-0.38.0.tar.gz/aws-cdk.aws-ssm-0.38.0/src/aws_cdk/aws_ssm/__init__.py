...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ssm", "0.38.0", __name__, "aws-ssm@0.38.0.jsii.tgz")
...
class CfnMaintenanceWindowTask(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnMaintenanceWindowTask"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, max_concurrency: str, max_errors: str, priority: jsii.Number, service_role_arn: str, targets: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetProperty"]]], task_arn: str, task_type: str, description: typing.Optional[str]=None, logging_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["LoggingInfoProperty"]]]=None, name: typing.Optional[str]=None, task_invocation_parameters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["TaskInvocationParametersProperty"]]]=None, task_parameters: typing.Any=None, window_id: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnMaintenanceWindowTaskProps(max_concurrency=max_concurrency, max_errors=max_errors, priority=priority, service_role_arn=service_role_arn, targets=targets, task_arn=task_arn, task_type=task_type, description=description, logging_info=logging_info, name=name, task_invocation_parameters=task_invocation_parameters, task_parameters=task_parameters, window_id=window_id)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.CfnMaintenanceWindowTaskProps", jsii_struct_bases=[], name_mapping={'max_concurrency': 'maxConcurrency', 'max_errors': 'maxErrors', 'priority': 'priority', 'service_role_arn': 'serviceRoleArn', 'targets': 'targets', 'task_arn': 'taskArn', 'task_type': 'taskType', 'description': 'description', 'logging_info': 'loggingInfo', 'name': 'name', 'task_invocation_parameters': 'taskInvocationParameters', 'task_parameters': 'taskParameters', 'window_id': 'windowId'})
class CfnMaintenanceWindowTaskProps():
    def __init__(self, *, max_concurrency: str, max_errors: str, priority: jsii.Number, service_role_arn: str, targets: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.TargetProperty"]]], task_arn: str, task_type: str, description: typing.Optional[str]=None, logging_info: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMaintenanceWindowTask.LoggingInfoProperty"]]]=None, name: typing.Optional[str]=None, task_invocation_parameters: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnMaintenanceWindowTask.TaskInvocationParametersProperty"]]]=None, task_parameters: typing.Any=None, window_id: typing.Optional[str]=None):
        ...
        if window_id is not None: self._values["window_id"] = window_id
