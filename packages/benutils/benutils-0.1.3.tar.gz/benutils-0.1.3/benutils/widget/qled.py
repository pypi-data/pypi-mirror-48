...
from PyQt5.QtCore import pyqtSignal, Qt, QSize, QTimer, QByteArray, QRectF, \
    pyqtProperty
...
class QLed(QWidget):
    ...
    def paintEvent(self, event):
        ...
        self.renderer.load(QByteArray(bytes(self.shapes[self.m_shape] % (dark_str,light_str), 'utf-8')))
