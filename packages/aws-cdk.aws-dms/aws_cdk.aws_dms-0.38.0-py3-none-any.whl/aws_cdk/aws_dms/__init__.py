...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dms", "0.38.0", __name__, "aws-dms@0.38.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-dms.CfnReplicationTaskProps", jsii_struct_bases=[], name_mapping={'migration_type': 'migrationType', 'replication_instance_arn': 'replicationInstanceArn', 'source_endpoint_arn': 'sourceEndpointArn', 'table_mappings': 'tableMappings', 'target_endpoint_arn': 'targetEndpointArn', 'cdc_start_time': 'cdcStartTime', 'replication_task_identifier': 'replicationTaskIdentifier', 'replication_task_settings': 'replicationTaskSettings', 'tags': 'tags'})
class CfnReplicationTaskProps():
    def __init__(self, *, migration_type: str, replication_instance_arn: str, source_endpoint_arn: str, table_mappings: str, target_endpoint_arn: str, cdc_start_time: typing.Optional[jsii.Number]=None, replication_task_identifier: typing.Optional[str]=None, replication_task_settings: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
