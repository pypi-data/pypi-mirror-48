...
def read_ori_anno_and_store_filered_result(ori_anno_file, dest_anno_file, filter_labels):
    """
...
def copy_image_to_output_dataset(
    ...
    if filter_labels is None:
        ...
        read_ori_anno_and_store_filered_result(ori_anno_file, dest_anno_file, filter_labels)
