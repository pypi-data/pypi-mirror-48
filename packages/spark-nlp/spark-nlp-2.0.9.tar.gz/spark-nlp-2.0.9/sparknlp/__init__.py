...
def start(include_ocr=False):
    ...
    if include_ocr:
        builder \
            .config("spark.jars.packages", "JohnSnowLabs:spark-nlp:2.0.9,com.johnsnowlabs.nlp:spark-nlp-ocr_2.11:2.0.9,javax.media.jai:com.springsource.javax.media.jai.core:1.1.3") \
            .config("spark.jars.repositories", "http://repo.spring.io/plugins-release")

    else:
        builder.config("spark.jars.packages", "JohnSnowLabs:spark-nlp:2.0.9") \
