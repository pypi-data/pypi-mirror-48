...
def generate(solution):
    ...
    for item in solution.project_list[0].platform.get_expanded():
    ...
    for configuration in solution.project_list[0].configurations:
        if configuration.deploy_folder:
            watcom_projectfile.final_folder = configuration.deploy_folder
        watcom_projectfile.configurations.append(configuration.name)
    watcom_projectfile.projecttype = solution.project_list[0].project_type
