...
from smrt.core.ofresnel import fresnel_reflection_matrix, fresnel_transmission_matrix
...
"""
    ...
    def incoherent_reflection_matrix(self, frequency, eps_1, eps_2, mu_s, mu_i, dphi, npol):
...
"""
        ...
        return lib.diag(np.zeros((len_atleast_1d(dphi), npol*len_atleast_1d(mu_s), npol*len_atleast_1d(mu_i))))
