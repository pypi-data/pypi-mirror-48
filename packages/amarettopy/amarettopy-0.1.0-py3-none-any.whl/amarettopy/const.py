...
QSSR_IDX_POS = 0
"""query_servo_statusの結果の位置情報インデックス"""
QSSR_IDX_VEL = 1
"""query_servo_statusの結果の速度情報インデックス"""
QSSR_IDX_CUR = 2
"""query_servo_statusの結果の電流情報インデックス"""
QSSR_IDX_REF = 3
"""query_servo_statusの結果の指令値情報インデックス"""
QSSR_IDX_TEMP = 4
"""query_servo_statusの結果の温度情報インデックス"""
QSSR_IDX_FAULTS = 5
"""query_servo_statusの結果のフォルト情報インデックス"""
...
def faults2str(s):
    ...
    if s & SERVO_FAULT_DUMMY    :
        ret.append("SERVO_FAULT_DUMMY")
