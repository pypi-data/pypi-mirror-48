...
class InitTab(Tk.Frame):
    ...
    def init(self):
        ...
        def f():
            ...
            self.amaretto.clear_log(amarettoGuiInfo.targetDevId)
    ...
    def setZero(self):
        ...
        def f():
            p = self.amaretto.query_servo_status(amarettoGuiInfo.targetDevId)[QSSR_IDX_POS]
            offset0 = self.amaretto.get_position_sys_offset(amarettoGuiInfo.targetDevId)
            offset1 = self.amaretto.get_position_offset(amarettoGuiInfo.targetDevId)
            self.amaretto.set_position_sys_offset(amarettoGuiInfo.targetDevId, (p + offset0 + offset1) % 65536)
