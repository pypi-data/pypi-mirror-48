...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii~=0.12.1",
        "publication>=0.0.3",
        "aws-cdk.aws-applicationautoscaling~=0.36.0",
        "aws-cdk.aws-autoscaling~=0.36.0",
        "aws-cdk.aws-autoscaling-hooktargets~=0.36.0",
        ...
        "aws-cdk.aws-ecr~=0.36.0",
        "aws-cdk.aws-ecr-assets~=0.36.0",
        "aws-cdk.aws-elasticloadbalancing~=0.36.0",
        ...
        "aws-cdk.aws-servicediscovery~=0.36.0",
