...
tinymce.init({
  language: "pl",
  language_url: "/static/congo/admin/js/tinymce/langs/pl.js",
  // selector: "textarea",
  ...
  plugins: [
    ...
    "table contextmenu paste hr nonbreaking template ace"
  ],
  external_plugins: {
    // https://github.com/christiaan/tinymce-codemirror
    // https://github.com/codemirror/CodeMirror
    // "codemirror": "/static/congo/admin/js/tinymce/plugins/codemirror/plugin.min.js"
    
    // https://libraries.io/bower/ace-builds
    // https://github.com/plasmadancom/tinymce-ace-plugin
    "ace": "/static/congo/admin/js/tinymce/plugins/ace/plugin.min.js"
  },
  ...
  toolbar: "styleselect common_tags | bold | bullist numlist | link unlink image template | preview ace fullscreen",
