...
from congo.utils.moneyed import classes as moneyed
...
_format("pl", group_size = 3, group_separator = " ", decimal_point = ",",
        positive_sign = "", trailing_positive_sign = "",
        negative_sign = "-", trailing_negative_sign = "",
        rounding_method = ROUND_HALF_EVEN)

_format("r", group_size = 3, group_separator = "\xa0", decimal_point = ",",
        positive_sign = "", trailing_positive_sign = "",
        negative_sign = "-", trailing_negative_sign = "",
        rounding_method = ROUND_HALF_EVEN)

_format("en", group_size = 3, group_separator = ",", decimal_point = ".",
        positive_sign = "", trailing_positive_sign = "",
        negative_sign = "-", trailing_negative_sign = "",
        rounding_method = ROUND_HALF_EVEN)
...
# @mm na co te wszystkie waluty skoro i tak uzywamy tylko trzech .. ? :(
...
#_sign(DEFAULT, moneyed.GEL, prefix = '�?�')
...
#_sign(DEFAULT, moneyed.KWD, prefix = 'د.�?')
...
#_sign(DEFAULT, moneyed.RUB, prefix = 'р�?б.')
...
# @mm tak fafa
_sign('pl', moneyed.USD, prefix = 'US $')
_sign('pl', moneyed.PLN, suffix = ' zł')
_sign('pl', moneyed.EUR, prefix = '€ ')

_sign('ru', moneyed.USD, prefix = 'US $')
_sign('ru', moneyed.PLN, suffix = ' zł')
_sign('ru', moneyed.EUR, prefix = '€ ')

_sign('en', moneyed.USD, prefix = 'US $')
_sign('en', moneyed.PLN, suffix = ' zł')
_sign('en', moneyed.EUR, prefix = '€ ')
