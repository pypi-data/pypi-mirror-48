...
class BaseJob(object):
    name = ""# eg. clear_objects
    description = ""# eg. Removing objects of class A and B older than 30 days
    ...
    def run(self, user, *args, **kwargs):
        ...
        try:
            ...
            message = result.pop('message') if 'message' in result else _("Zadanie wykonane")
            ...
            try:
                ...
                err = str(e).decode("WINDOWS-1250")

            message = "[%s] %s" % (e.__class__.__name__, err)
