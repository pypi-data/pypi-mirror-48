...
class SimpleEmailMessage(object):
    ...
    def render_content(self):
        ...
        template_name = 'congo/email/%s.txt' % self.template
        ...
        if self.mimetype == 'html':
            template_name = 'congo/email/%s.html' % self.template
...
# TODO: Skonfigurować backendy dla różnych dostawców
...
class SimpleSMSMessage(object):
    ...
    def __str__(self):
        return _("SMS od %(sender_name)s do %(recipient_mobile_phone)s") % {'sender_name': self.sender_name, 'recipient_mobile_phone': self.recipient_mobile_phone}
