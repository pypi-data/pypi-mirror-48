    ...
    def wrapped_view(request, *args, **kwargs):
        if request.user.is_authenticated:
            if request.user.is_active:
                ...
                message = _("Twoje konto jest nieaktywne. Aby korzystać ze wszystkich funkcji serwisu, kliknij link w wiadomości otrzymanej podczas rejestracji lub skontaktuj się z obsługą klienta.")
