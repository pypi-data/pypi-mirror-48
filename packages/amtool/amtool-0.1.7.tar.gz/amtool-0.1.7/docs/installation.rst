...
To install Artifact Management Tool, run this command in your terminal:
...
The sources for Artifact Management Tool can be downloaded from the `Github repo`_.
