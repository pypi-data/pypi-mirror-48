...
if __name__ == '__main__':
    ...
    parser.add_argument('--drf2', metavar='drf2Dir',
                        help='Digital RF v 2 top level directory to be compared', required=True)
    parser.add_argument('--drf1', metavar='drf1Dir',
                        help='Digital RF v 1 top level directory to be compared', required=True)
    ...
    for channel in reader2.get_channels():
        ...
        cont_blocks_1 = reader1.get_continuous_blocks(
            bounds1[0], bounds1[1], channel)
