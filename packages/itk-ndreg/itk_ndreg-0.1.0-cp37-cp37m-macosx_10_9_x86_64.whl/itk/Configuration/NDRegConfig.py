...
templates = (
  ...
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionISS2D', False, 'itk::Image< signed short,2 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIUC2D', False, 'itk::Image< unsigned char,2 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIUS2D', False, 'itk::Image< unsigned short,2 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIF2D', False, 'itk::Image< float,2 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionISS3D', False, 'itk::Image< signed short,3 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIUC3D', False, 'itk::Image< unsigned char,3 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIUS3D', False, 'itk::Image< unsigned short,3 >,double'),
  ('ExtrapolateImageFunction', 'itk::ExtrapolateImageFunction', 'itkExtrapolateImageFunctionIF3D', False, 'itk::Image< float,3 >,double'),
...
snake_case_functions = ('time_varying_velocity_field_image_registration_methodv4', 'metamorphosis_image_registration_methodv4', 'image_registration_methodv4', )
