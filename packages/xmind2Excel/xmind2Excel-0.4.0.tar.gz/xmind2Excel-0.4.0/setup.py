...
if os.name == u"nt":
    os.system("cd xmind2Excel/file/xmind-sdk-python-master & python setup.py install & cd ../../..")
...
setup(
    ...
    description="xmind2Excel is a tool, change the xmind to excel.",
    long_description=open("README.md",encoding="UTF-8").read(),
    long_description_content_type="text/markdown",
    platforms=["all"],
    license="MIT",
    keywords = ['xlsx', 'excel', 'xmind2Excel'],
