...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iam", "0.35.0", __name__, "aws-iam@0.35.0.jsii.tgz")
class CfnAccessKey(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnAccessKey"):
    ...
    cloudformationResource:
        AWS::IAM::AccessKey
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, user_name: str, serial: typing.Optional[jsii.Number]=None, status: typing.Optional[str]=None) -> None:
...
class CfnGroup(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnGroup"):
    ...
    def policies(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.cdk.IResolvable, "PolicyProperty"]]]]]:
    ...
    @policies.setter
    def policies(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.cdk.IResolvable, "PolicyProperty"]]]]]):
...
class CfnGroupProps(jsii.compat.TypedDict, total=False):
    ...
    policies: typing.Union[aws_cdk.cdk.IResolvable, typing.List[typing.Union[aws_cdk.cdk.IResolvable, "CfnGroup.PolicyProperty"]]]
    """``AWS::IAM::Group.Policies``.
...
class CfnManagedPolicy(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnManagedPolicy"):
    ...
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, policy_document: typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable], description: typing.Optional[str]=None, groups: typing.Optional[typing.List[str]]=None, managed_policy_name: typing.Optional[str]=None, path: typing.Optional[str]=None, roles: typing.Optional[typing.List[str]]=None, users: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnPolicy(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnPolicy"):
    ...
    cloudformationResource:
        AWS::IAM::Policy
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, policy_document: typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable], policy_name: str, groups: typing.Optional[typing.List[str]]=None, roles: typing.Optional[typing.List[str]]=None, users: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnRole(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnRole"):
    ...
    cloudformationResource:
        AWS::IAM::Role
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, assume_role_policy_document: typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable], managed_policy_arns: typing.Optional[typing.List[str]]=None, max_session_duration: typing.Optional[jsii.Number]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional[str]=None, policies: typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.cdk.IResolvable, "PolicyProperty"]]]]]=None, role_name: typing.Optional[str]=None) -> None:
    ...
    def assume_role_policy_document(self) -> typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable]:
    ...
    def assume_role_policy_document(self, value: typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable]):
...
class _CfnRoleProps(jsii.compat.TypedDict, total=False):
    ...
    Stability:
        experimental
    """
    policies: typing.Union[aws_cdk.cdk.IResolvable, typing.List[typing.Union[aws_cdk.cdk.IResolvable, "CfnRole.PolicyProperty"]]]
    """``AWS::IAM::Role.Policies``.
...
class CfnRoleProps(_CfnRoleProps):
    ...
    Stability:
        experimental
    """
    assumeRolePolicyDocument: typing.Union[typing.Mapping[typing.Any, typing.Any], aws_cdk.cdk.IResolvable]
    """``AWS::IAM::Role.AssumeRolePolicyDocument``.
...
class CfnUser(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CfnUser"):
    ...
    cloudformationResource:
        AWS::IAM::User
    """
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, groups: typing.Optional[typing.List[str]]=None, login_profile: typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional["LoginProfileProperty"]]]=None, managed_policy_arns: typing.Optional[typing.List[str]]=None, path: typing.Optional[str]=None, permissions_boundary: typing.Optional[str]=None, policies: typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.cdk.IResolvable, "PolicyProperty"]]]]]=None, user_name: typing.Optional[str]=None) -> None:
    ...
    def login_profile(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional["LoginProfileProperty"]]]:
    ...
    def login_profile(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.cdk.IResolvable], typing.Optional["LoginProfileProperty"]]]):
    ...
    class _LoginProfileProperty(jsii.compat.TypedDict, total=False):
        passwordResetRequired: typing.Union[bool, aws_cdk.cdk.IResolvable]
...
class CfnUserProps(jsii.compat.TypedDict, total=False):
    ...
    loginProfile: typing.Union[aws_cdk.cdk.IResolvable, "CfnUser.LoginProfileProperty"]
    """``AWS::IAM::User.LoginProfile``.
    ...
    policies: typing.Union[aws_cdk.cdk.IResolvable, typing.List[typing.Union[aws_cdk.cdk.IResolvable, "CfnUser.PolicyProperty"]]]
    """``AWS::IAM::User.Policies``.
...
class LazyRole(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.LazyRole"):
    ...
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, assumed_by: "IPrincipal", external_id: typing.Optional[str]=None, inline_policies: typing.Optional[typing.Mapping[str,"PolicyDocument"]]=None, managed_policies: typing.Optional[typing.List["IManagedPolicy"]]=None, max_session_duration_sec: typing.Optional[jsii.Number]=None, path: typing.Optional[str]=None, role_name: typing.Optional[aws_cdk.cdk.PhysicalName]=None) -> None:
        ...
        Arguments:
            ...
            managedPolicies: A list of ARNs for managed policies associated with this role. You can add managed policies later using ``attachManagedPolicy(arn)``. Default: - No managed policies.
...
class PolicyDocument(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyDocument"):
    ...
    def __init__(self, *, assign_sids: typing.Optional[bool]=None, statements: typing.Optional[typing.List["PolicyStatement"]]=None) -> None:
        ...
        Arguments:
            props: -
            assignSids: Automatically assign Statement Ids to all statements. Default: false
    ...
    def resolve(self, context: aws_cdk.cdk.IResolveContext) -> typing.Any:
...
class PolicyStatement(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyStatement"):
    ...
    Stability:
        experimental
    """
    def __init__(self, *, actions: typing.Optional[typing.List[str]]=None, conditions: typing.Optional[typing.Mapping[str,typing.Any]]=None, principals: typing.Optional[typing.List["IPrincipal"]]=None, resources: typing.Optional[typing.List[str]]=None) -> None:
        """
        Arguments:
            props: -
...
class _RoleProps(jsii.compat.TypedDict, total=False):
    ...
    Stability:
        experimental
    """
    roleName: aws_cdk.cdk.PhysicalName
