...
package = 'tapioca_senado'
requirements = [
    'tapioca-wrapper==1.4.2',
]
test_requirements = [
...
setup(
    ...
    description='API do Senado Federal usando Tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://gitlab.com/maribedran/tapioca-senado',
    packages=[
        'tapioca_senado',
    ],
    package_dir={'tapioca_senado': 'tapioca_senado'},
