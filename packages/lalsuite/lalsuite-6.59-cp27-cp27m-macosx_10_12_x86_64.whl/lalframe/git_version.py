...
id = "cd65f38ce43cef3a1dec217c060de25caf99bf14"
date = "2019-06-26 19:45:53 +0000"
branch = "None"
tag = "lalsuite-v6.59"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "cd65f38ce43cef3a1dec217c060de25caf99bf14":
        return
    msg = "Program id (cd65f38ce43cef3a1dec217c060de25caf99bf14) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
