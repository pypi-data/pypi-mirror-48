...
def main():
    ...
    group.add_argument("-c", "--conf", action='store', type=str, required=False, help="Loads a JSON configuration file")
    group.add_argument("-l", "--list", action='store_true', required=False, help="List all task stored in the JSON configuration file")
