...
class MarkerDetector(_object):
    ...
    def detect(self, *args) -> "std::vector< aruco::Marker,std::allocator< aruco::Marker > >":
...
class FractalPoseTracker(_object):
    ...
    def setParams(self, cam_params: 'CameraParameters', msconf: 'FractalMarkerSet const &') -> "void":
        return _aruco.FractalPoseTracker_setParams(self, cam_params, msconf)

    def fractalInnerPose(self, markerDetector: 'cv::Ptr< aruco::MarkerDetector > const', markers: 'MarkerVec', refinement: 'bool'=True) -> "bool":
        return _aruco.FractalPoseTracker_fractalInnerPose(self, markerDetector, markers, refinement)

    def ROI(self, imagePyramid: 'std::vector< cv::Mat,std::allocator< cv::Mat > > const', img: 'cv::Mat &', innerPoints2d: 'Point2fVec', offset: 'cv::Point2f &', ratio: 'float &') -> "void":
        return _aruco.FractalPoseTracker_ROI(self, imagePyramid, img, innerPoints2d, offset, ratio)

    def assignClass(self, im: 'cv::Mat const &', kpoints: 'std::vector< cv::KeyPoint,std::allocator< cv::KeyPoint > > &', norm: 'bool'=False, wsize: 'int'=5) -> "void":
        return _aruco.FractalPoseTracker_assignClass(self, im, kpoints, norm, wsize)

    def fractal_solve_ransac(self, ninners: 'int', inner_kpnt: 'std::vector< std::pair< uint,std::vector< uint,std::allocator< uint > > >,std::allocator< std::pair< uint,std::vector< uint,std::allocator< uint > > > > >', kpnts: 'std::vector< cv::KeyPoint,std::allocator< cv::KeyPoint > >', maxIter: 'uint32_t'=500, _minInliers: 'float'=0.35, _thresInliers: 'float'=0.7) -> "cv::Mat":
