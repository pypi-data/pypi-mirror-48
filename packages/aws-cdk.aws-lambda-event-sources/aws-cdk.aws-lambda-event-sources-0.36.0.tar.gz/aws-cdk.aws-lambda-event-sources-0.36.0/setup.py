...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_lambda_event_sources._jsii": [
            "aws-lambda-event-sources@0.36.0.jsii.tgz"
        ],
        "aws_cdk.aws_lambda_event_sources": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii~=0.12.1",
        "publication>=0.0.3",
        "aws-cdk.aws-apigateway~=0.36.0",
        "aws-cdk.aws-dynamodb~=0.36.0",
        "aws-cdk.aws-events~=0.36.0",
        "aws-cdk.aws-iam~=0.36.0",
        "aws-cdk.aws-kinesis~=0.36.0",
        "aws-cdk.aws-lambda~=0.36.0",
        "aws-cdk.aws-s3~=0.36.0",
        "aws-cdk.aws-s3-notifications~=0.36.0",
