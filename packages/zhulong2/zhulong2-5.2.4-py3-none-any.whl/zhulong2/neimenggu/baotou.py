...
def f3(driver, url):
    ...
    try:
        ...
        locator = (By.XPATH, '//table[@class="table"]|//body')
        WebDriverWait(driver, 20).until(EC.visibility_of_element_located(locator))
        flag = 1
    ...
    if flag == 1:
        ...
        if div == None:
            ...
            div = soup.find('div', class_='noprint')
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "anbang", "neimenggu_baotou"],headless=False,num=2,cdc_total=10)
    ...
    # url = "http://zfcg.baotou.gov.cn/portal/topicView.do?method=view&view=stockBulletin&id=1660&stockModeIdType=666&ver=2"
    # driver.get(url)
    # for i in range(5,40):
    #     print(f1(driver, i))
