...
class ProductSku(object):
    ...
    def __init__(self, sku_number=None, price=None, images=None, barcode=None, color=None, size=None, quantity=None, is_onsale=None, net_weight=None, gross_weight=None):  # noqa: E501
