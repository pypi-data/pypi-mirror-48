...
class ApiResponse(object):
    ...
    def response_time(self):
        ...
        The response time of current NomadOperation request, including sub-NomadOperation's. The time unit is millisecond. This 'responseTime' is different from the one in ApiResponseConnectorResponse, since our NomadOperation supports spawn mode, whose output will be replaced by its children's instead of its own.  # noqa: E501
