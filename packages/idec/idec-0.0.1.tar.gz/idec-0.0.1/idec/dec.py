...
__description__ = '''
References: https://wiki.python.org/moin/PythonDecoratorLibrary
'''
...
class Singleton(type):
    """
    singleton mode by ``__metaclass__``
...
class Tomorrow:
    """
        References: https://github.com/madisonmay/Tomorrow
...
def async_threads(n, timeout=None):
    ...
    - `n` how many threads could run simultaneously
    - ``timeout`` in case threads block others
...
def _async_raise(tid, exctype):
    ...
    References: https://www.oschina.net/question/172446_2159505
    """
