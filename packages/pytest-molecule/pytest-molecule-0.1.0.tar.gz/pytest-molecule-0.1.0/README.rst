...
.. image:: https://travis-ci.org/ssbarnea/pytest-molecule.svg?branch=master
    :target: https://travis-ci.org/ssbarnea/pytest-molecule
    :alt: See Build Status on Travis CI

.. image:: https://ci.appveyor.com/api/projects/status/github/ssbarnea/pytest-molecule?branch=master
    :target: https://ci.appveyor.com/project/ssbarnea/pytest-molecule/branch/master
