...
class PrivateKey():
    ...
    def generate_secret(self, publickey):
        ...
        :return:
        """
        point = functions.scalar_mult(self.d, publickey.Q)
        x, y = point
    ...
    def sign(self, message):
        ...
        :return:
        """
        point = functions.sign_message(self.d, message)
        x, y = point
        return "%s%s" % (hex(x)[2:-1], hex(y)[2:-1])
...
class PublicKey():
    ...
    def verify(self, message, signature):
        ...
        return functions.verify_signature(self.Q, message, point)
...
def make_keypair():
    ...
    private_key = random.randrange(1, functions.curve.n)
    public_key = functions.scalar_mult(private_key, functions.curve.g)
