...
"""
Modified by:    Caleb Ng
Modified date:  November 27, 2017
Changes:        - Add support for a custom modbus command format
                - Add custom SecurityError exception class
"""
...
class Instrument():
    ...
    def custom_command(self, subfunc, value):
        ...
        _checkInt(subfunc, minvalue=0, maxvalue=2, description='Invalid subfunction received ({})'.format(subfunc))
