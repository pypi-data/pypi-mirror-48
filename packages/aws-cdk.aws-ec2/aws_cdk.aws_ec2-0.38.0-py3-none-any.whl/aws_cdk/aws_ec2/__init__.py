...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ec2", "0.38.0", __name__, "aws-ec2@0.38.0.jsii.tgz")
...
class CfnLaunchTemplate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.CfnLaunchTemplate"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-ec2.CfnLaunchTemplate.SpotOptionsProperty", jsii_struct_bases=[], name_mapping={'instance_interruption_behavior': 'instanceInterruptionBehavior', 'max_price': 'maxPrice', 'spot_instance_type': 'spotInstanceType'})
    class SpotOptionsProperty():
        def __init__(self, *, instance_interruption_behavior: typing.Optional[str]=None, max_price: typing.Optional[str]=None, spot_instance_type: typing.Optional[str]=None):
            """
...
class Subnet(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.Subnet"):
    ...
    def from_subnet_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, availability_zone: str, subnet_id: str) -> "ISubnet":
        ...
        """
        attrs = SubnetAttributes(availability_zone=availability_zone, subnet_id=subnet_id)
...
class PrivateSubnet(Subnet, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.PrivateSubnet"):
    ...
    def from_private_subnet_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, availability_zone: str, subnet_id: str) -> "IPrivateSubnet":
        ...
        :param subnet_id: The subnetId for this particular subnet.
        """
        attrs = PrivateSubnetAttributes(availability_zone=availability_zone, subnet_id=subnet_id)
...
class PublicSubnet(Subnet, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.PublicSubnet"):
    ...
    def from_public_subnet_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, availability_zone: str, subnet_id: str) -> "IPublicSubnet":
        ...
        :param subnet_id: The subnetId for this particular subnet.
        """
        attrs = PublicSubnetAttributes(availability_zone=availability_zone, subnet_id=subnet_id)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.SubnetAttributes", jsii_struct_bases=[], name_mapping={'availability_zone': 'availabilityZone', 'subnet_id': 'subnetId'})
class SubnetAttributes():
    def __init__(self, *, availability_zone: str, subnet_id: str):
        """
        :param availability_zone: The Availability Zone the subnet is located in.
        :param subnet_id: The subnetId for this particular subnet.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.PrivateSubnetAttributes", jsii_struct_bases=[SubnetAttributes], name_mapping={'availability_zone': 'availabilityZone', 'subnet_id': 'subnetId'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.PublicSubnetAttributes", jsii_struct_bases=[SubnetAttributes], name_mapping={'availability_zone': 'availabilityZone', 'subnet_id': 'subnetId'})
...
class Vpc(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ec2.Vpc"):
    ...
    def from_vpc_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, availability_zones: typing.List[str], vpc_id: str, isolated_subnet_ids: typing.Optional[typing.List[str]]=None, isolated_subnet_names: typing.Optional[typing.List[str]]=None, private_subnet_ids: typing.Optional[typing.List[str]]=None, private_subnet_names: typing.Optional[typing.List[str]]=None, public_subnet_ids: typing.Optional[typing.List[str]]=None, public_subnet_names: typing.Optional[typing.List[str]]=None, vpn_gateway_id: typing.Optional[str]=None) -> "IVpc":
        ...
        """
        attrs = VpcAttributes(availability_zones=availability_zones, vpc_id=vpc_id, isolated_subnet_ids=isolated_subnet_ids, isolated_subnet_names=isolated_subnet_names, private_subnet_ids=private_subnet_ids, private_subnet_names=private_subnet_names, public_subnet_ids=public_subnet_ids, public_subnet_names=public_subnet_names, vpn_gateway_id=vpn_gateway_id)
