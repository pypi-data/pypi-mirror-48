...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codecommit", "0.38.0", __name__, "aws-codecommit@0.38.0.jsii.tgz")
class CfnRepository(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codecommit.CfnRepository"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, repository_name: str, code: typing.Optional[typing.Union[typing.Optional["CodeProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, repository_description: typing.Optional[str]=None, triggers: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "RepositoryTriggerProperty"]]]]]=None) -> None:
        ...
        """
        props = CfnRepositoryProps(repository_name=repository_name, code=code, repository_description=repository_description, triggers=triggers)
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-codecommit.CfnRepository.RepositoryTriggerProperty", jsii_struct_bases=[], name_mapping={'branches': 'branches', 'custom_data': 'customData', 'destination_arn': 'destinationArn', 'events': 'events', 'name': 'name'})
    class RepositoryTriggerProperty():
        def __init__(self, *, branches: typing.Optional[typing.List[str]]=None, custom_data: typing.Optional[str]=None, destination_arn: typing.Optional[str]=None, events: typing.Optional[typing.List[str]]=None, name: typing.Optional[str]=None):
            """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codecommit.CfnRepositoryProps", jsii_struct_bases=[], name_mapping={'repository_name': 'repositoryName', 'code': 'code', 'repository_description': 'repositoryDescription', 'triggers': 'triggers'})
class CfnRepositoryProps():
    def __init__(self, *, repository_name: str, code: typing.Optional[typing.Union[typing.Optional["CfnRepository.CodeProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, repository_description: typing.Optional[str]=None, triggers: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnRepository.RepositoryTriggerProperty"]]]]]=None):
