...
def itkNormalizedCorrelationTwoImageToOneImageMetricIF2IF2___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIF2IF2_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIF3IF3___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIF3IF3_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricISS2ISS2___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricISS2ISS2_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricISS3ISS3___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricISS3ISS3_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUC2IUC2___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUC2IUC2_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUC3IUC3___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUC3IUC3_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUS2IUS2___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUS2IUS2_cast(obj):
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUS3IUS3___New_orig__():
...
def itkNormalizedCorrelationTwoImageToOneImageMetricIUS3IUS3_cast(obj):
