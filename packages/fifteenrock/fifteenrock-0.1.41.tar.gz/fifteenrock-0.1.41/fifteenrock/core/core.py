...
def deploy(project: str, function: str, url: str = None, main_file: str = None, dependencies: List = None,
    ...
    :framework: Currently supports one of ['nuclio', 'flask']
    : main_module: For Nuclio style functions, the name of the main function. default 'main'. For Flask style
    ...
    optional = util.optional(project=project, name=function, spec=spec, metadata=metadata, framework=framework,
