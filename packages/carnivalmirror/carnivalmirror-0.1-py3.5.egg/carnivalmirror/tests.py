...
from sampling import ParameterSampler, UniformAPPDSampler, ParallelBufferedSampler
...
class TestCalibrationMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_image = cv2.imread(path_here('tests/test_image_before.png'))
    ...
    def test_rectified_standard_with_ground_truth(self):
        ...
        cv2.imwrite("tests/test_rectified_standard_with_ground_truth.png", np.hstack((rect_direct, rect_ours)))
    ...
    def test_rectified_preserving_with_ground_truth(self):
        ...
        cv2.imwrite("tests/test_rectified_preserving_with_ground_truth.png",overlayed)
    ...
    def test_appd(self):
        ...
        cv2.imwrite("tests/test_appd_diff_map.png",dm1)
...
class TestParameterSampler(unittest.TestCase):
    ...
    def test_histogram(self):
        ...
        plt.grid()
        plt.savefig('tests/ParameterSampler_test_histogram.png')
        plt.close()
    ...
    def test_histogram_normalized(self):
        ...
        plt.grid()
        plt.legend()
        plt.savefig('tests/ParameterSampler_test_histogram_normalized.png')
        plt.close()
...
class TestUniformAPPDSampler(unittest.TestCase):
    ...
    def test_histogram_normalized(self):
        ...
        plt.grid()
        plt.legend()
        plt.savefig('tests/UniformAPPDSampler_test_histogram_normalized.png')
        plt.close()
    ...
    def test_ParallelBufferedSampler(self):
        ...
        plt.grid()
        plt.legend()
        plt.savefig('tests/ParallelBufferedSampler_UniformAPPDSampler_test_histogram_normalized_small.png')
        plt.close()
    ...
    def test_hist_from_returned_objects(self):
        ...
        sampler.stop()
        plt.grid()
        plt.savefig('tests/ParallelBufferedSampler_UniformAPPDSampler_test_hist_from_returned_objects.png')
        plt.close()
