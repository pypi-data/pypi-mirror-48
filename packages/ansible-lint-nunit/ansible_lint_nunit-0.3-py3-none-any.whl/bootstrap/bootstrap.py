...
def main():
    ...
    nunit_xsl_file = "https://raw.githubusercontent.com/artberri/junit-to-nunit/master/junit-to-nunit.xsl"
    ...
    parsed_lines_xml = unicode(LET.tostring(newdom, pretty_print=True))

    outfile = open(options.output_file, 'w')
    outfile.write(parsed_lines_xml)
