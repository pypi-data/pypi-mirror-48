...
class GroupElementsApi(object):
    ...
    def group_elements_get_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.group_elements_get_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.group_elements_get_id_with_http_info(id, **kwargs)  # noqa: E501

    def group_elements_get_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """GroupElements: Get by Id  # noqa: E501

        Get by Id: Use this method to retrieve a GroupElements object by its primary key (id)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.group_elements_get_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method group_elements_get_id" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `group_elements_get_id`")  # noqa: E501
