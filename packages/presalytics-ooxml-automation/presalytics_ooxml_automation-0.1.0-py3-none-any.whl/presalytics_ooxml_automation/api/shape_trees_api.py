...
class ShapeTreesApi(object):
    ...
    def shape_trees_get_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.shape_trees_get_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.shape_trees_get_id_with_http_info(id, **kwargs)  # noqa: E501

    def shape_trees_get_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """ShapeTrees: Get by Id  # noqa: E501

        Get by Id: Use this method to retrieve a ShapeTrees object by its primary key (id)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.shape_trees_get_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method shape_trees_get_id" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `shape_trees_get_id`")  # noqa: E501
