...
def count_files(directory, filters, extension, show_files=False, **kwargs):
    ...
    ----------
          directory | the directory to be checked
            filters | text/string filter present in file to be checked
          extension | secondary text/string filter 
         show_files | optional: if set to True, prints file name
         start_time | kwarg: seconds; if set, use as reference; 
