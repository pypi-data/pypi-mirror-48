...
class Pykg2vecIT(unittest.TestCase):
    ...
    def test_ProjE(self):
        test_function('proje_pointwise')

    def test_RESCAL(self):
        test_function('rescal')
    
    def test_RotatE(self):
        test_function('rotate')
    ...
    def test_transE(self):
        test_function('transe')
    
    def test_transH(self):
        test_function('transh')
    
    def test_transR(self):
        test_function('transr')
    
    def test_TransD(self):
        test_function('transd')

    def test_TransM(self):
        test_function('transm')
