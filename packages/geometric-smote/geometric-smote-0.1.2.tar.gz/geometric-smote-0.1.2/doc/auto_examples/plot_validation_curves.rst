.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_validation_curves.py>` to download the full example code
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_001.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_002.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_003.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_004.png
            :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_005.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_006.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_007.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_validation_curves_008.png
            :class: sphx-glr-multi-img
