...
class Application:
    ...
    def process_video(self, video_path, output_dir, file_index, file_count):
        ...
        for index, frame in self.frame_stream(vidcap, skip_frames, config.max_frame or frame_count):
            # print(frame)
            ...
            if report_frequency > 0 and index % report_frequency == 0:
                print("- frame {} of {} ({:.1%})".format(index, frame_count, index / frame_count))
