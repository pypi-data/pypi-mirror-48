...
from crowdwizbase.asset_permissions import (
    asset_permissions,
    force_flag,
    test_permissions,
    todict,
...
class Asset(GrapheneAsset):
    """ Deals with Assets of the network.
        ...
        :param crowdwiz.crowdwiz.CrowdWiz blockchain_instance: CrowdWiz
            instance
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param crowdwiz.account.Account from_account: From this account
            :param crowdwiz.account.Account to_account: To this account
            :param crowdwiz.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param crowdwiz.amount.Amount max_market_fee: Max Fee
