...
class Address(GPHAddress):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``CWD``)

        Example::

           Address("CWDFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")
...
class PublicKey(GPHPublicKey):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("CWD6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
