...
from crowdwizbase.account import PrivateKey, PublicKey
...
class Memo(GrapheneMemo):
    """ Deals with Memos that are attached to a transfer
        ...
        :param crowdwiz.account.Account from_account: Account that has sent
            the memo
        :param crowdwiz.account.Account to_account: Account that has received
            the memo
        ...
        .. code-block:: python
            ...
            from crowdwiz.memo import Memo
            m = Memo("crowdwizeu", "wallet.xeroc")
