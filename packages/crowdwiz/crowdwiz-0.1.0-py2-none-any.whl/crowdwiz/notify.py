...
from crowdwizapi.websocket import CrowdWizWebsocket
...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`crowdwiz.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from crowdwiz.notify import Notify
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Open the websocket
        self.websocket = CrowdWizWebsocket(
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`crowdwiz.price.Order` or
            * :class:`crowdwiz.price.FilledOrder` or
            * :class:`crowdwiz.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:crowdwiz.account.AccountUpdate`
        """
