...
class MVCDesal(SinkComponent):
    ...
    def __init__(
        self, ld_module, st_module, capex=3.42, opex_fix=0.0,
        opex_var=0.05, opex_use=0.0, life=20.0, td=0, ru=0,
        enr_int=12.2, is_sink=False, **kwargs
    ):
