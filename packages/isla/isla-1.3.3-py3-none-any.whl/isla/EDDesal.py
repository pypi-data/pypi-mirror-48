...
class EDDesal(SinkComponent):
    ...
    def __init__(
        self, ld_module, st_module, capex=1.56, opex_fix=0.0,
        opex_var=0.05, opex_use=0.0, life=10.0, td=1, ru=0,
        enr_int=25.3, is_sink=False, **kwargs
    ):
