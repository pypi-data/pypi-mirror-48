...
class MEDDesal(SinkComponent):
    ...
    def __init__(
        self, ld_module, st_module, capex=3.94, opex_fix=0.0,
        opex_var=0.05, opex_use=0.0, life=20.0, td=0.4, ru=0.25,
        enr_int=9.0, is_sink=False, **kwargs
    ):
