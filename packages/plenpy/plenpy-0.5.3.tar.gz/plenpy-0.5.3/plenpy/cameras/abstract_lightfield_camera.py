...
class AbstractLightFieldCamera(AbstractCamera, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self._calDataFilename = os.path.join(
            self.calibrationFolderPath, 'cal_data.npz')
    ...
    def _save_cal_data(self, filename: Optional[str] = None):
        ...
        np.savez_compressed(self._calDataFilename,
    ...
    def _load_cal_data(self, filename: Optional[str] = None):
        ...
        loaded = np.load(self._calDataFilename, allow_pickle=True)
    ...
    @abstractmethod
    def _get_wi_db_entry(self, path: str) -> Optional[ndarray]:
        ...
        Args:
            path: Path to the white image, used as database identification
    ...
    @staticmethod
    def _get_calibration_db_entry(path: str,
