...
CAMERA_FOLDERPATH = os.path.join(BASE_FOLDERPATH, "cameras/")
LYTRO_FOLDERPATH = os.path.join(CAMERA_FOLDERPATH, "LytroIllum/")

FILES_LYTRO = [os.path.join(LYTRO_FOLDERPATH, "Calibration/cal_data.npz"),
               os.path.join(LYTRO_FOLDERPATH, "Calibration/cal_own.npz"),
               os.path.join(LYTRO_FOLDERPATH, "Calibration/cal_dans.npz")]

LYTRO_SMALL_FOLDERPATH = os.path.join(CAMERA_FOLDERPATH, "LytroIllumSmall/")

FILES_LYTRO_SMALL = [os.path.join(LYTRO_SMALL_FOLDERPATH, "Calibration/cal_data.npz"),
                     os.path.join(LYTRO_SMALL_FOLDERPATH, "Calibration/cal_own.npz"),
                     os.path.join(LYTRO_SMALL_FOLDERPATH, "Calibration/cal_dans.npz")]
...
def test_lytro_illum_init():
    ...
    try:
        ...
        assert test_camera._calDataFilename == os.path.join(
            LYTRO_FOLDERPATH, 'Calibration/cal_data.npz')
