...
CAMERA_FOLDERPATH = os.path.join(BASE_FOLDERPATH, "cameras/RayTracerSmall/")

FILES = [os.path.join(CAMERA_FOLDERPATH, "Calibration/cal_data.npz"),
               os.path.join(CAMERA_FOLDERPATH, "Calibration/cal_own.npz"),
               os.path.join(CAMERA_FOLDERPATH, "Calibration/cal_dans.npz")]
...
def test_lf_cam_init():
    ...
    try:
        ...
        assert test_camera._calDataFilename == os.path.join(
            CAMERA_FOLDERPATH, 'Calibration/cal_data.npz')
