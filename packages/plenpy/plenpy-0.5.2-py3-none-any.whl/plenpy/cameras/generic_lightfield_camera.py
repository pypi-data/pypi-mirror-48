...
class GenericLightFieldCamera(AbstractLightFieldCamera):
    ...
    def __init__(self, camera_folder_path, microlens_size, crop_size=10):
        ...
        """
        super().__init__(camera_folder_path=camera_folder_path,
    ...
    def calibrate(self,
        ...
        * Calculate the microlens centers
        ...
        if os.path.isfile(self._calDataFilename) and not force:
            ...
            if not os.path.isfile(self._calDataFilename) or force:
    ...
    def decode_sensor_image(self,
        ...
        # Convert to float
        img = images.dtype_to_norm_float(img, raw_img.dtype)
        del raw_img
    ...
    def _calc_interp_image(img: ndarray) -> ndarray:
        ...
        raw_img = images.get_standard_shape(img)
