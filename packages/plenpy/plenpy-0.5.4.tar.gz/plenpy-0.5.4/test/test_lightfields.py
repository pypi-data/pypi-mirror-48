...
def test_constructor_from_file():
    ...
    try:
        # Save test image
        file = os.path.join(path, "test_lf.png")
        imageio.imsave(uri=file, im=test_lf_data_2D)

        # Read from saved file
        path_lf = LightField.from_file(file,
                                       s_max=s_max,
                                       t_max=t_max)
...
def test_constructor_from_file_mask():
    ...
    try:
        ...
        file = os.path.join(path, "test_lf.png")
        mask_file = os.path.join(path, "test_mask_array.npy")
...
def test_constructor_from_file_collection():
    ...
    try:
        for u in range(0, u_max):
            for v in range(0, v_max):
                ...
                filename = os.path.join(folder, f"lf_image_{u}_{v}.png")
    ...
    try:
        ...
        # Delete one image
        os.remove(os.path.join(folder, "lf_image_1_2.png"))
        ...
        imageio.imsave(uri=os.path.join(folder, "lf_image_1_2.png"),
