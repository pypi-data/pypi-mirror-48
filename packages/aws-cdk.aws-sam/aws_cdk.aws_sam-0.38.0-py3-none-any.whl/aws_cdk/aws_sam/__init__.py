...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sam", "0.38.0", __name__, "aws-sam@0.38.0.jsii.tgz")
...
class CfnApiProps():
    ...
    @property
    def auth(self) -> typing.Optional[typing.Union[typing.Optional["CfnApi.AuthProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::Serverless::Api.Auth``.
