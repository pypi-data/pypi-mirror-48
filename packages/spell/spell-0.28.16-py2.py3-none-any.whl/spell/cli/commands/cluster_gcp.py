...
@click.pass_context
@click.option("-n", "--name", "name", help="Name used by Spell for you to identify the cluster")
def create_gcp(ctx, name):
    ...
    bucket_name = get_bucket_name(ctx, storage, service_account, name)
...
def get_bucket_name(ctx, storage_api, service_account, cluster_name):
