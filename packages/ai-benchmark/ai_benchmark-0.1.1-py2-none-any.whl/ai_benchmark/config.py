...
class Test:
    ...
    def __init__(self, test_id, test_type, model, model_src, tests_training, tests_inference, tests_micro):
...
class TestConstructor:
    ...
    def getTests(self):
        ...
        benchmark_tests = [
            ...
            Test(test_id=4, test_type="classification", model="Inception-ResNet-V2",
            ...
            Test(test_id=5, test_type="classification", model="ResNet-V2-50",
            ...
            Test(test_id=6, test_type="classification", model="ResNet-V2-152",
            ...
            Test(test_id=7, test_type="classification", model="VGG-16",
            ...
            Test(test_id=8, test_type="enhancement", model="SRCNN 9-5-5", model_src="srcnn.meta",
            ...
            Test(test_id=9, test_type="enhancement", model="VGG-19 Super-Res", model_src="vgg19.meta",
            ...
            Test(test_id=10, test_type="enhancement", model="ResNet-SRGAN", model_src="srgan.meta",
            ...
            Test(test_id=11, test_type="enhancement", model="ResNet-DPED", model_src="dped.meta",
            ...
            Test(test_id=12, test_type="segmentation", model="U-Net", model_src="unet.meta",
            ...
            Test(test_id=13, test_type="segmentation", model="Nvidia-SPADE", model_src="spade.meta",
            ...
            Test(test_id=14, test_type="segmentation", model="ICNet", model_src="icnet.meta",
            ...
            Test(test_id=15, test_type="segmentation", model="PSPNet", model_src="pspnet.meta",
            ...
            Test(test_id=16, test_type="segmentation", model="DeepLab", model_src="deeplab.meta",
            ...
            Test(test_id=17, test_type="enhancement", model="Pixel-RNN", model_src="pixel_rnn.meta",
            ...
            Test(test_id=18, test_type="nlp", model="LSTM-Sentiment", model_src="lstm.meta",
            ...
            Test(test_id=19, test_type="nlp-text", model="GNMT-Translation", model_src="gnmt.meta",
                 tests_training=[],
