...
class CircuitExplorer(object):
    ...
    def set_material(self, model_id, material_id, diffuse_color=[1.0, 1.0, 1.0],
                     ...
                     glossiness=1.0, intensity=1.0, shading_mode=SHADING_MODE_NONE, emission=0.0, clipped=0):
        params = dict()
    ...
    def set_materials(self, model_ids, material_ids, diffuse_colors, specular_colors, specular_exponents=list(),
                      opacities=list(), reflection_indices=list(), refraction_indices=list(),
                      simulation_data_casts=list(), glossinesses=list(), shading_modes=list(), emissions=list(),
                      clips=list()):
        params = dict()
