...
from workspace_jam.pipelines.advanced.no_lens_light.power_law.from_initialize import lens_pl_shear_source_sersic

pipeline_initializer = lens_sie_shear_source_sersic.make_pipeline(phase_folders=[data_type + '-sub_8', data_level, data_name],
                                                                  sub_grid_size=8)
pipeline_power_law = lens_pl_shear_source_sersic.make_pipeline(phase_folders=[data_type + '_sub_8', data_level, data_name],
                                                               sub_grid_size=8)
