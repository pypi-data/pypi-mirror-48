...
cosma_data_path = af.path_util.make_and_return_path_from_path_and_folder_names(cosma_path,
                                                                            folder_names=['data', data_type])
cosma_output_path = af.path_util.make_and_return_path_from_path_and_folder_names(cosma_path,
                                                                              folder_names=['output', data_type])
...
data_path = af.path_util.make_and_return_path_from_path_and_folder_names(
    path=workspace_path, folder_names=['data', data_type, data_name, data_values])
...
from workspace_jam.pipelines.advanced.no_lens_light.inversion import lens_sie_shear_source_inversion
from workspace_jam.pipelines.advanced.no_lens_light.power_law.from_inversion import lens_pl_shear_source_inversion
from workspace_jam.pipelines.advanced.no_lens_light.subhalo.from_power_law import lens_pl_shear_subhalo_source_inversion

pipeline_initializer = lens_sie_shear_source_sersic.make_pipeline(phase_folders=[data_name, data_values],
                                                                  positions_threshold=0.2)
pipeline_inversion = lens_sie_shear_source_inversion.make_pipeline(phase_folders=[data_name, data_values],
                                                                   positions_threshold=0.2)
pipeline_power_law = lens_pl_shear_source_inversion.make_pipeline(phase_folders=[data_name, data_values],
                                                                  positions_threshold=0.2)
pipeline_subhalo = lens_pl_shear_subhalo_source_inversion.make_pipeline(phase_folders=[data_name, data_values],
                                                                        positions_threshold=0.2)
