...
data_path = path_util.make_and_return_path_from_path_and_folder_names(path=workspace_path,
                                                                      folder_names=['data', 'f814w', data_type, data_name])
...
from workspace_jam.pipelines.with_lens_light.sersic.inversion import lens_sersic_sie_shear_source_inversion
from workspace_jam.pipelines.with_lens_light.sersic.power_law.from_inversion import \
    lens_sersic_pl_shear_source_inversion
from workspace_jam.pipelines.with_lens_light.sersic.subhalo.from_power_law import \
...
pipeline.run(data=ccd_data, positions=positions, assert_optimizer_pickle_matches=False)