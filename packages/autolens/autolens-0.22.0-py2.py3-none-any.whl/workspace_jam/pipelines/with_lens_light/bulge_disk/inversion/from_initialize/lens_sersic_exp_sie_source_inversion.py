...
def make_pipeline(
    ...
    phase1 = InversionPhase(phase_name='phase_1_initialize_inversion', phase_folders=phase_folders,
                            ...
                            lens_galaxies=dict(lens=gm.GalaxyModel(redshift=redshift_lens,
                                                                   bulge=lp.EllipticalSersic,
                                                                   disk=lp.EllipticalExponential,
                                                                   mass=mp.EllipticalIsothermal)),
                            source_galaxies=dict(source=gm.GalaxyModel(redshift=redshift_source,
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source.pixelization = \
                results.from_phase('phase_1_initialize_inversion').constant.source_galaxies.source.pixelization

            self.source_galaxies.source.regularization = \
                results.from_phase('phase_1_initialize_inversion').variable.source_galaxies.source.regularization

    phase2 = InversionPhase(phase_name='phase_2_lens_sersic_exp_sie_source_inversion', phase_folders=phase_folders,
                            tag_phases=tag_phases,
                            lens_galaxies=dict(lens=gm.GalaxyModel(redshift=redshift_lens,
                                                                   bulge=lp.EllipticalSersic,
                                                                   disk=lp.EllipticalExponential,
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source = \
                results.from_phase('phase_2_lens_sersic_exp_sie_source_inversion').variable.source_galaxies.source

    phase3 = InversionPhase(phase_name='phase_3_lens_sersic_exp_sie_refine_source_inversion',
