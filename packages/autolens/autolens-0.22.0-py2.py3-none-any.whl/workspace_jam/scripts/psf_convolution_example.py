...
tracer = ray_tracing.TracerImagePlane(lens_galaxies=[lens_galaxy], image_plane_grid_stack=image_plane_grid_stack)
...
simulated_ccd = simulated_ccd.SimulatedCCDData.from_image_and_exposure_arrays(array=tracer.profile_image_plane_image_2d_for_simulation, pixel_scale=pixel_scale,
                                                                              exposure_time=300.0, psf=psf, background_sky_level=0.1, add_noise=False)
