...
for data_resolution in ['LSST', 'Euclid', 'HST', 'HST_Up']:#, 'AO']:
    ...
    for i in range(repeats):
        cluster_weight_map = pixelization.cluster_weight_map_from_hyper_image(hyper_image=hyper_image)
    ...
    for i in range(repeats):
        sparse_to_regular_grid = grids.SparseToRegularGrid.from_total_pixels_cluster_grid_and_cluster_weight_map(
            total_pixels=pixelization.pixels, cluster_grid=lens_data.grid_stack.regular, cluster_weight_map=cluster_weight_map)
