...
model_indexes, sample_weights, total_masses, stellar_masses, bulge_masses, disk_masses, dark_masses, stellar_fractions = \
...
bulge_mass, bulge_mass_std = density_plot_tools.weighted_avg_and_std(bulge_masses, sample_weights)
bulge_mass_lower = bulge_mass - bulge_mass_std
bulge_mass_upper = bulge_mass + bulge_mass_std

disk_mass, disk_mass_std = density_plot_tools.weighted_avg_and_std(disk_masses, sample_weights)
disk_mass_lower = disk_mass - disk_mass_std
disk_mass_upper = disk_mass + disk_mass_std

dark_mass, dark_mass_std = density_plot_tools.weighted_avg_and_std(dark_masses, sample_weights)
dark_mass_lower = dark_mass - dark_mass_std
dark_mass_upper = dark_mass + dark_mass_std

print()
print('Total Mass = ', '{0:e}'.format(total_mass), '(', '{0:e}'.format(total_mass_std), '{0:e}'.format(total_mass_upper), ')')
print('stellar Mass = ', '{0:e}'.format(stellar_mass), '(', '{0:e}'.format(stellar_mass_std), '{0:e}'.format(stellar_mass_upper), ')')
print('bulge Mass = ', '{0:e}'.format(bulge_mass), '(', '{0:e}'.format(bulge_mass_std), '{0:e}'.format(bulge_mass_upper), ')')
print('disk Mass = ', '{0:e}'.format(disk_mass), '(', '{0:e}'.format(disk_mass_std), '{0:e}'.format(disk_mass_upper), ')')
print('dark Mass = ', '{0:e}'.format(dark_mass), '(', '{0:e}'.format(dark_mass_std), '{0:e}'.format(dark_mass_upper), ')')
