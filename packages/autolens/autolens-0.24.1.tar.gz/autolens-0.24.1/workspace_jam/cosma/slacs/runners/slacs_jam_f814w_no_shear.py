...
conf.instance = af.conf.Config(config_path=workspace_path + 'config', output_path=cosma_output_path)
...
from workspace_jam.pipelines.advanced.with_lens_light.bulge_disk.initialize import lens_sersic_exp_sie_source_sersic
from workspace_jam.pipelines.advanced.with_lens_light.bulge_disk.inversion.from_initialize import lens_sersic_exp_sie_source_inversion
