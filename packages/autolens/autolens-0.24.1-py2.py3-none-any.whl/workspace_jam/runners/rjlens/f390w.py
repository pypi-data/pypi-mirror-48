...
ccd_data = ccd.load_ccd_data_from_fits(image_path=data_path + 'image.fits',
                                       ...
                                       resized_ccd_shape=(251, 251), resized_psf_shape=(15, 15))

mask = msk.Mask.circular(shape=ccd_data.shape, pixel_scale=ccd_data.pixel_scale, radius_arcsec=3.7)
...
from workspace_jam.pipelines.advanced.with_lens_light import lens_sersic_sie_shear_source_sersic
