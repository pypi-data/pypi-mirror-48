...
cosma_path = af.path_util.make_and_return_path_from_path_and_folder_names(path='/cosma5/data/autolens/', folder_names=[data_folder_name])
...
data_name = []
data_name.append('')
data_name.append('lens_mass_and_x1_source') # Example simulated image with lens light emission and a source galaxy.
...
pixel_scale = 0.1 # Make sure your pixel scale is correct!
...
data_path = af.path_util.make_and_return_path_from_path_and_folder_names(path=cosma_data_path, folder_names=[data_name])
