...
#
#     phase1 = InversionPhase(
#         phase_name='phase_1_initialize_inversion_adaptive_reg', phase_folders=phase_folders, tag_phases=tag_phases,
#         lens_galaxies=dict(lens=gm.GalaxyModel(redshift=redshift_lens, bulge=lp.EllipticalSersic,
#                                                disk=lp.EllipticalExponential, mass=mp.EllipticalIsothermal,
#                                                shear=mp.ExternalShear)),
#         source_galaxies=dict(source=gm.GalaxyModel(redshift=redshift_source, pixelization=pix.VoronoiMagnification,
...
#             ### Source Inversion, Inv -> Inv ###
#
#             self.source_galaxies.source.pixelization = results.from_phase('phase_1_initialize_inversion_adaptive_reg').\
#                 constant.source_galaxies.source.pixelization
#
#             self.source_galaxies.source.regularization = results.from_phase('phase_1_initialize_inversion_adaptive_reg').\
#                 variable.source_galaxies.source.regularization
#
#     phase2 = InversionPhase(
#         phase_name='phase_2_lens_sersic_exp_sie_shear_source_inversion_adaptive_reg',
#         phase_folders=phase_folders, tag_phases=tag_phases,
#         lens_galaxies=dict(lens=gm.GalaxyModel(redshift=redshift_lens, bulge=lp.EllipticalSersic,
#                                                disk=lp.EllipticalExponential, mass=mp.EllipticalIsothermal,
#                                                shear=mp.ExternalShear)),
...
#     phase2.optimizer.n_live_points = 75
#     phase2.optimizer.sampling_efficiency = 0.2
#     phase2.optimizer.evidence_tolerance = 1000000000000
#
#     ### PHASE 3 ###
#
#     # In phase 3, we refine the inversion's resolution and regularization coefficient, where we:
