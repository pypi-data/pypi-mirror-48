...
if cosma_array_id == 1:
    ...
    pixel_scale = 0.05
    data_name = 'large_rein_pl_no_sub'
    resized_ccd_shape = (400, 400)
    ...
    pixel_scale = 0.05
    data_name = 'small_rein_pl_no_sub'
    resized_ccd_shape = (400, 400)
...
pipeline_power_law = lens_pl_shear_source_sersic.make_pipeline(phase_folders=[data_name, data_values],
                                                               positions_threshold=0.2)
pipeline_subhalo = lens_pl_shear_subhalo_source_sersic.make_pipeline(phase_folders=[data_name, data_values],
                                                                     positions_threshold=0.2)
