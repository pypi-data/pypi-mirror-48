...
cosma_data_path = path_util.make_and_return_path_from_path_and_folder_names(
    cosma_path, folder_names=['data'])
cosma_output_path = path_util.make_and_return_path_from_path_and_folder_names(
...
inner_mask_radii.append(0.3) # Index 2, slacs0252+0039
inner_mask_radii.append(0.3) # Index 3, slacs0737+3216
inner_mask_radii.append(0.5) # Index 4, slacs0912+0029
inner_mask_radii.append(0.2) # Index 5, slacs0959+4410
inner_mask_radii.append(0.3) # Index 6, slacs1205+4910
inner_mask_radii.append(0.2) # Index 7, slacs1250+0523
inner_mask_radii.append(0.5) # Index 8, slacs1402+6321
inner_mask_radii.append(0.5) # Index 9, slacs1420+6019
inner_mask_radii.append(0.3) # Index 10, slacs1430+4105
inner_mask_radii.append(0.3) # Index 11, slacs1627+0053
inner_mask_radii.append(0.3) # Index 12, slacs1630+4520
inner_mask_radii.append(0.3) # Index 13, slacs2238-0754
inner_mask_radii.append(0.4) # Index 14, slacs2300+0022
inner_mask_radii.append(0.3) # Index 15, slacs2303+1422
...
from workspace_jam.pipelines.with_lens_light.bulge_disk.initialize import lens_sersic_exp_sie_shear_source_sersic
from workspace_jam.pipelines.with_lens_light.bulge_disk.inversion.from_initialize import lens_sersic_exp_sie_shear_source_inversion
...
pipeline_initializer = lens_sersic_exp_sie_shear_source_sersic.make_pipeline(
    phase_folders=[data_filter, data_name], positions_threshold=1.0, inner_mask_radii=inner_mask_radii,
