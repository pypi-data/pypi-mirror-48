...
data_path = af.path_util.make_and_return_path_from_path_and_folder_names(path=cosma_data_path, folder_names=[data_type, data_name])
...
from workspace_jam.pipelines.advanced.with_lens_light import lens_sersic_sie_source_sersic
from workspace_jam.pipelines.advanced.with_lens_light.sersic.subhalo import sensitivty_and_search_lens_sersic_sie_source_sersic_from_initializer
pipeline_parametric = lens_sersic_sie_source_sersic.make_pipeline(phase_folders=[data_type, data_name])
pipeline_subhalo = sensitivty_and_search_lens_sersic_sie_source_sersic_from_initializer.make_pipeline(phase_folders=[data_type, data_name])
