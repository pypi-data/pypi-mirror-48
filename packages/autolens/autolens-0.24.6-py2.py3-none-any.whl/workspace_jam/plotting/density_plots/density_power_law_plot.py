...
lens_galaxy.mass_profiles[0].einstein_radius_in_units = lens_galaxy.mass_profiles[0].einstein_radius_lower_limit_3_sigma
...
lens_galaxy.mass_profiles[0].einstein_radius_in_units = lens_galaxy.mass_profiles[0].einstein_radius_upper_limit_3_sigma
