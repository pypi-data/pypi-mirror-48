...
def make_pipeline(
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.light = results.from_phase('phase_4_lens_sie_shear_source_inversion'). \
            ...
            if pl_align_light_dark_centre:
                ...
                self.lens_galaxies.lens.dark.centre = results.from_phase('phase_4_lens_sie_shear_source_inversion'). \
                    variable_absolute(a=0.05).lens_galaxies.lens.mass.centre

            ### Lens Shear, Shear -> Shear ###

            self.lens_galaxies.lens.shear = results.from_phase('phase_4_lens_sie_shear_source_inversion'). \
