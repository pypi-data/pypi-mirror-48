...
def make_pipeline(
    ...
    class GridPhase(af.phase.as_grid_search(phase_imaging.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_4_lens_sie_shear_source_inversion').\
            ...
            if pl_hyper_galaxies:
                ...
                self.source_galaxies.source.hyper_galaxy = results.from_phase('phase_4_lens_sie_shear_source_inversion').hyper_galaxy. \
