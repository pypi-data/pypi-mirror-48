...
gs.push( new Dygraph(
document.getElementById("graph_pumptc2"),
"best_dat/pumps_old.csv", // path to CSV file
{
title: 'Pump timecourse',
...
legend: 'onmouseover',
colors: ['#000000', '#55CC55', '#5555FF', '#FF33FF', '#3333FF', '#FF3333'],
labelsDiv: document.getElementById('legend_pumptc2'),
labelsDivWidth: 1400,
