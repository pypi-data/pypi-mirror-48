...
gs.push( new Dygraph(
document.getElementById("graph_bestproduction"),
"best_dat/production_fecundant.csv", // path to CSV file
{
title: 'Production timecourse',
...
labelsDiv: document.getElementById('legend_bestproduction'),
labelsDivWidth: 1400,
