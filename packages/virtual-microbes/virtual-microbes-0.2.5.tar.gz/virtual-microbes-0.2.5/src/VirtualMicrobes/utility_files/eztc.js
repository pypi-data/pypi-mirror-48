...
gs.push( new Dygraph(
document.getElementById("graph_eztc"),
"best_dat/enzymes_fecundant.csv", // path to CSV file
{
title: 'Enzymes timecourse',
...
legend: 'onmouseover',
colors: ['#55CC55', '#5555FF','#3333FF', '#FF3333', '#000000', '#FF33FF'],
labelsDiv: document.getElementById('legend_eztc'),
labelsDivWidth: 1400,
