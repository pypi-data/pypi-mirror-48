...
gs.push( new Dygraph(
document.getElementById("graph_molstc"),
"best_dat/metabolites_fecundant.csv", // path to CSV file
{
title: 'Metabolites timecourse',
...
labelsDiv: document.getElementById('legend_molstc'),
labelsDivWidth: 1400,
