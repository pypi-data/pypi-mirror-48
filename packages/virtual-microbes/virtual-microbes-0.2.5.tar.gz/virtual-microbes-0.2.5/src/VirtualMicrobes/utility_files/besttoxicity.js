...
gs.push( new Dygraph(
document.getElementById("graph_besttoxicity"),
"best_dat/toxicity_fecundant.csv", // path to CSV file
{
title: 'Toxicity timecourse',
...
labelsDiv: document.getElementById('legend_besttoxicity'),
labelsDivWidth: 1400,
