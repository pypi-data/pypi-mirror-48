...
class ETLRunner(object):
    ...
    def __loadlibs(self):
        ...
        self.__spark.sparkContext.addPyFile(cloud_location + "cloudwatch/aws_cloudwatch_utils.py")
        ...
        from aws_cloudwatch_utils import Logger
        from data_quality_v2 import DataQuality

        sts = boto3.client("sts")
        credentials = sts.assume_role(RoleArn=self.__attributes['role'], RoleSessionName=job_name)["Credentials"]
        self.__logger = Logger(credentials, job_name, "us-east-1")
